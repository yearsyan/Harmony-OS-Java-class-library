...
public class AbilityUtils {
    ...
    public static boolean freeInstallWithCallback(Context context, ohos.aafwk.content.Intent intent, IRemoteObject iRemoteObject) {
        return AbilityUtilsProxy.getInstance().freeInstallWithCallback(context, intent, iRemoteObject);
    }
