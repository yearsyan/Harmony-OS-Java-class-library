...
public class BundleAdapter {
                                    ...
                                    try {
                                        ...
                                        while (true) {
                                            ...
                                            if (j > 4294967296L) {
                                                ...
                                                closeAllStreams(zipInputStream, fileOutputStream2);
                                                return null;
                                            }
                                        ...
                                        try {
                                            ...
                                            safeDeleteFile(file2);
                                            closeAllStreams(zipInputStream, fileOutputStream);
                                            return null;
                                        } catch (Throwable th2) {
                                            th = th2;
                                            closeAllStreams(zipInputStream, fileOutputStream);
    ...
    private static void closeAllStreams(ZipInputStream zipInputStream, OutputStream outputStream) {
