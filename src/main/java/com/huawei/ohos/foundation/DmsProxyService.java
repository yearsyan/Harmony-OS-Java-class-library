...
public class DmsProxyService {
    ...
    public void start() {
        ...
        int addSysAbility = SysAbilityManager.addSysAbility(SystemAbilityDefinition.DISTRIBUTED_SCHED_ADAPTER_SA_ID, this.mDmsProxy.asObject());
        HiLog.info(DMS_LABEL, "add dmsproxy result is %{public}d", Integer.valueOf(addSysAbility));
    }
}
