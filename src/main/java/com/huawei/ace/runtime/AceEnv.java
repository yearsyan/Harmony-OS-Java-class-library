...
public final class AceEnv {
    ...
    public static final int ACE_PLATFORM_OHOS = 1;
    ...
    private AceEnv() {
        ...
        if (!this.isLoadSuccess) {
            ...
            AEventReport.sendAppStartException(9);
        }
    }
    ...
    public static AceContainer createContainer(AceEventCallback aceEventCallback, AcePluginMessage acePluginMessage, int i, String[] strArr, int[] iArr, FileDescriptor[] fileDescriptorArr) {
        return createContainer(aceEventCallback, acePluginMessage, i, "", strArr, iArr, fileDescriptorArr);
    }

    public static AceContainer createContainer(AceEventCallback aceEventCallback, AcePluginMessage acePluginMessage, int i, String str, String[] strArr, int[] iArr, FileDescriptor[] fileDescriptorArr) {
        return INSTANCE.createContainerInner(aceEventCallback, acePluginMessage, i, str, strArr, iArr, fileDescriptorArr);
    }

    private AceContainer createContainerInner(AceEventCallback aceEventCallback, AcePluginMessage acePluginMessage, int i, String str, String[] strArr, int[] iArr, FileDescriptor[] fileDescriptorArr) {
        IAceViewCreator iAceViewCreator = this.creator;
        if (iAceViewCreator == null) {
            return null;
        }
        return new AceContainer(i, this.containerType, iAceViewCreator, aceEventCallback, acePluginMessage, str, strArr, iArr, fileDescriptorArr);
    }
