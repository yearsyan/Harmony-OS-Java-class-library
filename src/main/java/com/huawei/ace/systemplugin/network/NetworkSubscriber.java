...
public class NetworkSubscriber extends CommonEventSubscriber {
    ...
    private String networkTypeResult = "none";
    ...
    public String getNetworkType() {
        if (this.networkTypeResult.equals("none") && !this.directCall) {
    ...
    public void onReceiveEvent(CommonEventData commonEventData) {
        ...
        if (this.eventNotifier != null) {
            ...
            jSONObject.put("type", (Object) this.networkTypeResult);
            jSONObject.put("metered", (Object) Boolean.valueOf(this.isMetered));
