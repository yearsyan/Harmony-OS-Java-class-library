...
public class BrightnessPlugin implements ModuleGroup.ModuleGroupHandler, ErrorCode {
    ...
    private void getValue(WindowManager.LayoutConfig layoutConfig) {
        if (layoutConfig.windowBrightness != -1.0f) {
            ...
            jSONObject.put("value", (Object) Integer.valueOf((int) (layoutConfig.windowBrightness * 255.0f)));
        ...
        if (aceContextAdapter.getSystemScreenBrightness() != -1) {
            ...
            jSONObject2.put("value", (Object) Integer.valueOf(aceContextAdapter.getSystemScreenBrightness()));
    ...
    private void setValue(WindowManager.LayoutConfig layoutConfig, int i) {
        ...
        runOnUITaskWithCatch(new RunnableWithCatch(layoutConfig) {
            /* class com.huawei.ace.systemplugin.brightness.$$Lambda$BrightnessPlugin$duXAtrUK9MORyY48mSsvc4zFn7Y */
            ...
            @Override // com.huawei.ace.systemplugin.brightness.BrightnessPlugin.RunnableWithCatch
    ...
    private void getMode(WindowManager.LayoutConfig layoutConfig) {
        ...
        JSONObject jSONObject = new JSONObject();
        if (f == -1.0f) {
            jSONObject.put(Constants.ATTRNAME_MODE, (Object) 1);
            this.moduleResult.success(jSONObject);
            return;
        }
        jSONObject.put(Constants.ATTRNAME_MODE, (Object) 0);
        this.moduleResult.success(jSONObject);
    }
    ...
    private void setMode(WindowManager.LayoutConfig layoutConfig, int i) {
        ...
        runOnUITaskWithCatch(new RunnableWithCatch(layoutConfig) {
            /* class com.huawei.ace.systemplugin.brightness.$$Lambda$BrightnessPlugin$9eemGJVSoAVTX2m7iMHwjN3IZuY */
            private final /* synthetic */ WindowManager.LayoutConfig f$1;
    ...
    private void setKeepScreenOn(Window window, boolean z) {
        if (z) {
            runOnUITaskWithCatch(new RunnableWithCatch() {
                /* class com.huawei.ace.systemplugin.brightness.$$Lambda$BrightnessPlugin$rr_y4Ku_BJcRK0seRKK3NTnkXE */
            ...
            runOnUITaskWithCatch(new RunnableWithCatch() {
                /* class com.huawei.ace.systemplugin.brightness.$$Lambda$BrightnessPlugin$CEdYeqBbSCcxR3Z2IejO63jDFvk */
    ...
    private void runOnUITaskWithCatch(RunnableWithCatch runnableWithCatch) {
        Ability ability2 = this.ability;
        if (ability2 == null) {
            LogUtil.error(TAG, "ability is null");
        } else if (ability2.getUITaskDispatcher() == null) {
            LogUtil.error(TAG, "ui task dispatcher is null");
        } else {
            this.ability.getUITaskDispatcher().asyncDispatch(runnableWithCatch);
        }
    }

    /* access modifiers changed from: private */
    public interface RunnableWithCatch extends Runnable {
        void runInner();
        ...
        default void run() {
            try {
                ...
                LogUtil.info(BrightnessPlugin.TAG, "execute tast RuntimeException on UI Task, exception: " + e.toString());
            } catch (Exception e2) {
                LogUtil.info(BrightnessPlugin.TAG, "execute tast Exception on UI Task, exception: " + e2.toString());
            }
        }
    }
}
