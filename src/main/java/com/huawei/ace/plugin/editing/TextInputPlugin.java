...
public class TextInputPlugin extends TextInputPluginBase {
    ...
    public TextInputPlugin(View view2, int i) {
        super(i);
        this.view = view2;
        ...
        if (systemService instanceof InputMethodManager) {
            ...
            AEventReport.sendPluginException(1);
            this.imm = null;
        }
    ...
    public InputConnection createInputConnection(View view2, EditorInfo editorInfo) {
        ...
        InputConnectionWrapper inputConnectionWrapper = new InputConnectionWrapper(view2, clientId(), new TextInputPluginBase.Delegate(), this.editable, this.hint);
        ...
        this.lastInputConnection = inputConnectionWrapper;
