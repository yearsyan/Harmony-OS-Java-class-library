...
public class ProfileConstants {
    ...
    public static final String MAIN_ABILITY_NAME = "mainAbility";
    public static final String MIN_COMPATIBLE = "minCompatibleVersionCode";
    public static final String MODULE = "module";
    public static final String MULTI_FRAMEWORK = "multiFrameworkBundle";
