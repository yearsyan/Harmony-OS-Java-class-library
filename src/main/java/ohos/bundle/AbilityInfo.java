...
public class AbilityInfo implements Sequenceable {
    ...
    private static final String KEY_MULTI_DEVICE_CONNECTION = "multiDeviceConnection";
    ...
    public boolean unmarshalling(Parcel parcel) {
        ...
        this.subType = AbilitySubType.values()[parcel.readInt()];
    ...
    public AbilityInfo parseAbility(JSONObject jSONObject, String str, String str2, HapModuleInfo hapModuleInfo) {
        ...
        if (jSONObject.containsKey("deviceCapability")) {
            this.deviceCapabilities = JSONObject.parseArray(ProfileConstants.getJsonString(jSONObject, "deviceCapability"), String.class);
        }
    ...
    private void parsePermissions(JSONObject jSONObject) {
        ...
        if (this.type == AbilityType.DATA) {
            ...
            if (jSONObject.containsKey("uriPermission")) {
                ...
                this.uriPermissionPath = ProfileConstants.getJsonString(jSONObject2, DocumentItem.PATH);
            }
        }
    }
    ...
    public String toString() {
        return "[AbilityInfo@" + Integer.toHexString(hashCode()) + ", name ： " + this.name;
    }
}
