...
public abstract class WorkScheduler extends Ability {
    ...
    private static boolean prepareServiceConnect(WorkInfo workInfo) {
        ...
        HiLog.error(LOG_LABEL, "Connect WorkSchedulerService failed!", new Object[0]);
        return false;
    }
    ...
    public static final boolean startWork(WorkInfo workInfo, boolean z) throws RemoteException {
        ...
        HiLog.debug(LOG_LABEL, "Start work now, work id:%{private}d, %{public}b", Integer.valueOf(workInfo.getCurrentWorkID()), Boolean.valueOf(z));
    ...
    public static final boolean stopWork(WorkInfo workInfo) throws RemoteException {
        ...
        HiLog.debug(LOG_LABEL, "Stop work now, work id:%{private}d", Integer.valueOf(workInfo.getCurrentWorkID()));
    ...
    public static final boolean stopAndCancelWork(WorkInfo workInfo) throws RemoteException {
        ...
        HiLog.debug(LOG_LABEL, "Stop and cancel work now, work id:%{private}d", Integer.valueOf(workInfo.getCurrentWorkID()));
    ...
    public static final WorkInfo getWorkStatus(int i) throws RemoteException {
        if (i <= 0) {
            ...
            HiLog.debug(LOG_LABEL, "Get work status, work id:%{private}d", Integer.valueOf(i));
