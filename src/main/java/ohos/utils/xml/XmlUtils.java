...
public class XmlUtils {
    ...
    public static String currentDescription(XMLStreamReader xMLStreamReader) {
        ...
        return String.format(Locale.ENGLISH, "event <%s> at line %d, column %d", toEventName(xMLStreamReader.getEventType()), Integer.valueOf(lineNumber), Integer.valueOf(columnNumber));
    }
}
