...
public class UrlQueryFilter {
        ...
        private boolean isCharLegal(char c) {
            ...
            switch (c) {
                ...
                default:
                    switch (c) {
                        case '%':
                            return (this.filterFlags & 64) != 0;
                        case '&':
                            return (this.filterFlags & 32) != 0;
                        case '\'':
                            return (this.filterFlags & 16) != 0;
                        default:
                            return (c >= ' ' && c <= 127) || (c >= 128 && (this.filterFlags & 8) != 0);
                    }
            }
        }
    }
    ...
    public void parseParamPair(String str, String str2) {
    ...
    /* access modifiers changed from: protected */
    public void addParams(Pair<String, String> pair) {
