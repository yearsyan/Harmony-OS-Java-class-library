...
public class SimInfoManager {
    private static final HiLogLabel TAG = new HiLogLabel(3, 218111744, "SimInfoManager");
    ...
    public String getLine1NumberFromImpu(int i) {
        return this.telephonyProxy.getLine1NumberFromImpu(i);
    }

    @SystemApi
    public int getCardType(int i) {
        return this.telephonyProxy.getCardType(i);
    }
}
