...
public abstract class CellInformation implements Sequenceable {
    private static final HiLogLabel TAG = new HiLogLabel(3, 218111744, "CellInformation");
    ...
    public String toString() {
        return "{ isCamped=" + this.isCamped + ", nanoTimeStamp=" + this.nanoTimeStamp + Constants.ATTRNAME_NS;
    }
