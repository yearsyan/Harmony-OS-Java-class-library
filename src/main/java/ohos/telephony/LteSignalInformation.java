...
public final class LteSignalInformation extends SignalInformation implements Sequenceable {
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(obj) && this.lteRsrp == lteSignalInformation.lteRsrp && this.lteRsrq == lteSignalInformation.lteRsrq && this.lteRssnr == lteSignalInformation.lteRssnr && this.signalLevel == lteSignalInformation.signalLevel && this.timingAdvance == lteSignalInformation.timingAdvance;
    }

    public String toString() {
        return SIGNALTYPENAME + "{ lteRsrp=" + this.lteRsrp + ", lteRsrq=" + this.lteRsrq + ", lteRssnr=" + this.lteRssnr + ", signalLevel=" + this.signalLevel + ", timingAdvance=" + this.timingAdvance + "}";
    }
