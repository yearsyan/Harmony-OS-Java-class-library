...
public final class TelephonyAdapt {
    ...
    public static boolean hasSmsCapability() {
        ...
        if (system != null) {
            return system.getBoolean(17891527);
        }
        return true;
    }
    ...
    private static void sendOneSmsMessage(int i, String str, String str2, String str3, Context context) {
        ...
        try {
            ...
            throw new SecurityException("sendOneSmsMessage fail, does not have ohos.permission.SEND_MESSAGES.");
        }
    }
    ...
    private static void sendMutiSmsMessage(int i, String str, String str2, ArrayList<String> arrayList, Context context) {
        ...
        try {
            ...
            throw new SecurityException("sendMutiSmsMessage fail, does not have ohos.permission.SEND_MESSAGES.");
        }
    }
    ...
    public static void sendDataMessage(int i, String str, String str2, short s, byte[] bArr, ohos.app.Context context, ISendShortMessageCallback iSendShortMessageCallback, IDeliveryShortMessageCallback iDeliveryShortMessageCallback) {
        ...
        try {
            ...
            HiLog.error(TAG, "sendDataMessage fail, does not have ohos.permission.SEND_MESSAGES.", new Object[0]);
            throw new SecurityException("sendDataMessage fail, does not have ohos.permission.SEND_MESSAGES.");
        }
    }
    ...
    public static int getIntlPrefixAndCCLen(String str) {
        CallerInfoHW instance = CallerInfoHW.getInstance();
        if (instance != null) {
            return instance.getIntlPrefixAndCCLen(str);
        }
        return 0;
    }
}
