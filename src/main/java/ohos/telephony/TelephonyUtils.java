...
public final class TelephonyUtils {
    ...
    public static final int MSG_GET_LINE1_NUMBER_FROM_IMPU = 1014;
    ...
    public static final int MSG_GET_PESN = 24;
    ...
    public static final int MSG_GET_SMSC_ADDR = 3007;
    ...
    public static final int MSG_SET_SMSC_ADDR = 3008;
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, 218111744, "TelephonyUtils");
