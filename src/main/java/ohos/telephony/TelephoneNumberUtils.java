...
public class TelephoneNumberUtils {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, 218111744, "TelephoneNumberUtils");
    ...
    @SystemApi
    public static boolean isWaitOrPauseChar(char c) {
        return c == ',' || c == ';';
    }
    ...
    static {
        ...
        L2D_MAP.put('g', '4');
        L2D_MAP.put('h', '4');
        L2D_MAP.put(Character.valueOf(UCharacterProperty.LATIN_SMALL_LETTER_I_), '4');
        L2D_MAP.put('G', '4');
        L2D_MAP.put('H', '4');
        L2D_MAP.put('I', '4');
        L2D_MAP.put('j', '5');
    ...
    private static List<PrefixPosition> initInternationalPrefixList(String str, int i) {
        ...
        String[] strArr = {"+", "00", ExtraParams.DEVICETYPE_SMART_PAD};
    ...
    public static int getIntlPrefixAndCCLen(String str) {
        return TelephonyAdapt.getIntlPrefixAndCCLen(str);
    }

    @SystemApi
    public static String replacePauseAndWaitChar(String str) {
        if (str == null) {
            return "";
        }
        int length = str.length();
