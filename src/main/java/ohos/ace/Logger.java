...
public class Logger implements ILogger {
    ...
    public void d(String str, String str2) {
        HiLog.debug(LOG_LABEL, LOG_FORMAT, str, str2);
    }

    @Override // com.huawei.ace.runtime.ILogger
    public void i(String str, String str2) {
        HiLog.info(LOG_LABEL, LOG_FORMAT, str, str2);
    }

    @Override // com.huawei.ace.runtime.ILogger
    public void w(String str, String str2) {
        HiLog.warn(LOG_LABEL, LOG_FORMAT, str, str2);
    }

    @Override // com.huawei.ace.runtime.ILogger
    public void e(String str, String str2) {
        HiLog.error(LOG_LABEL, LOG_FORMAT, str, str2);
    }
}
