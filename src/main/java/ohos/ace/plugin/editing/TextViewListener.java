...
public class TextViewListener implements IAGPTextViewListener, TextInputPlugin.Listener {
    ...
    private EditorAttribute editorAttr = new EditorAttribute();
    ...
    public void onInited(int i, EditableText editableText, EditorAttribute editorAttribute) {
        this.clientId = i;
        this.editable = editableText;
        this.editorAttr = editorAttribute;
    }
    ...
    public InputParam getEditorInputParam() {
        return convertToInputParam(this.editorAttr);
    }

    private InputParam convertToInputParam(EditorAttribute editorAttribute) {
        InputParam inputParam = new InputParam(0, 0);
        inputParam.setInputType(EditorInfoAdapter.convertToInputType(editorAttribute.getInputPattern(), editorAttribute.getInputOption()));
        inputParam.setImeOption(EditorInfoAdapter.convertToImeOption(editorAttribute.getEnterKeyType(), editorAttribute.getInputOption()));
        return inputParam;
    }
}
