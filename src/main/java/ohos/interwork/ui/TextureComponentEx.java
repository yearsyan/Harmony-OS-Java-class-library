...
public class TextureComponentEx extends Component {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "TextureViewEx");
    ...
    private boolean initAdapter() {
        if (this.mTextureComponentExAdapter == null) {
            ...
            this.mTextureComponentExAdapter.setFrameAvailableListener(new TextureComponentExAdapter.IFrameAvailableListener() {
                ...
                @Override // ohos.agp.components.surfaceview.adapter.TextureComponentExAdapter.IFrameAvailableListener
            ...
            super.setTouchEventListener(new Component.TouchEventListener() {
