...
public final class A2dpSource implements ProfileBase {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogHelper.BT_DOMAIN_ID, "A2dpSource");
    ...
    public boolean disconnect(BluetoothRemoteDevice bluetoothRemoteDevice) {
        ...
        if (bluetoothRemoteDevice == null) {
            ...
            HiLog.info(TAG, "disconnect when host state not on", new Object[0]);
            return false;
        }
    }
    ...
    public boolean setConnectStrategy(BluetoothRemoteDevice bluetoothRemoteDevice, int i) {
        ...
        if (bluetoothRemoteDevice == null) {
            ...
            HiLog.info(TAG, "A2dpSource setConnectStrategy got illegal strategy", new Object[0]);
            return false;
        } else if (this.mBluetoothHost.getBtState() == 2) {
