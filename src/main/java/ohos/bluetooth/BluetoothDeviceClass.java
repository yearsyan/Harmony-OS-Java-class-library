    ...
    public boolean isProfileSupported(int i) {
        ...
        if (i != 18) {
            ...
            switch (getMajorMinorClass()) {
                ...
                case 280:
                case 512:
                case MajorMinorClass.PHONE_CELLULAR /*{ENCODED_INT: 516}*/:
                case MajorMinorClass.PHONE_CORDLESS /*{ENCODED_INT: 520}*/:
                case MajorMinorClass.PHONE_SMARTPHONE /*{ENCODED_INT: 524}*/:
                case MajorMinorClass.PHONE_MODEM_OR_VOICE_GATEWAY /*{ENCODED_INT: 528}*/:
                case MajorMinorClass.PHONE_COMMON_ISDN_ACCESS /*{ENCODED_INT: 532}*/:
                    return true;
                default:
                    return false;
            }
