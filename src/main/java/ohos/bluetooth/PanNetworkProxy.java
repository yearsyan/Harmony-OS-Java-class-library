...
class PanNetworkProxy implements IPanNetwork {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogHelper.BT_DOMAIN_ID, "PanNetworkProxy");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
        ohos.hiviewdfx.HiLog.error(ohos.bluetooth.PanNetworkProxy.TAG, "PanNetworkProxy getDevicesByStates : call error", new java.lang.Object[0]);
     */
    ...
    public java.util.List<ohos.bluetooth.BluetoothRemoteDevice> getDevicesByStates(int[] r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.bluetooth.PanNetworkProxy.getDevicesByStates(int[]):java.util.List");
    }
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
        ohos.hiviewdfx.HiLog.error(ohos.bluetooth.PanNetworkProxy.TAG, "getDeviceState : call error", new java.lang.Object[0]);
     */
    ...
    public int getDeviceState(ohos.bluetooth.BluetoothRemoteDevice r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.bluetooth.PanNetworkProxy.getDeviceState(ohos.bluetooth.BluetoothRemoteDevice):int");
    }
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
        ohos.hiviewdfx.HiLog.error(ohos.bluetooth.PanNetworkProxy.TAG, "disconnect pan device : a remote exception occurred", new java.lang.Object[0]);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0072, code lost:
        return false;
     */
    ...
    public boolean disconnect(ohos.bluetooth.BluetoothRemoteDevice r6) {
        ...
        // Method dump skipped, instructions count: 122
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.bluetooth.PanNetworkProxy.disconnect(ohos.bluetooth.BluetoothRemoteDevice):boolean");
    }
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
        ohos.hiviewdfx.HiLog.error(ohos.bluetooth.PanNetworkProxy.TAG, "connect pan device : a remote exception occurred", new java.lang.Object[0]);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0072, code lost:
        return false;
     */
    ...
    public boolean connect(ohos.bluetooth.BluetoothRemoteDevice r6) {
        ...
        // Method dump skipped, instructions count: 122
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.bluetooth.PanNetworkProxy.connect(ohos.bluetooth.BluetoothRemoteDevice):boolean");
    }
}
