...
public class BleCentralManager {
    private static final HiLogLabel TAG = new HiLogLabel(3, LogHelper.BT_DOMAIN_ID, "BleCentralManager");
    ...
    public void onScannerAddFinish(int i, int i2) {
        HiLog.info(TAG, "onScannerAddFinish, result %{public}d, scanner %{public}d", Integer.valueOf(i), Integer.valueOf(i2));
        if (i == 0 && i2 != -1) {
            this.mScannerId = i2;
