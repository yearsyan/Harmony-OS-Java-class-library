...
public final class BleAdvertiser {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogHelper.BT_DOMAIN_ID, "BleAdvertiser");
    ...
    private int getAdvDataSize(BleAdvertiseData bleAdvertiseData, boolean z) {
        ...
        for (int i3 = 0; i3 < bleAdvertiseData.getManufacturerData().size(); i3++) {
            i2 += getByteArrayLength(bleAdvertiseData.getManufacturerData().valueAt(i3)) + 4;
        }
        return i2;
    }
