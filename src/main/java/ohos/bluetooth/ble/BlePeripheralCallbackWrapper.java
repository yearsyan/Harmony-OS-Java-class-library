...
public class BlePeripheralCallbackWrapper extends BlePeripheralCallbackSkeleton {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogHelper.BT_DOMAIN_ID, "BlePeripheralCallbackWrapper");
    ...
    public void onClientRegistered(int i, int i2) {
        ...
        if (i != 0) {
            ...
            this.mProxy.clientConnect(i2, this.mDevice.getDeviceAddr(), this.mDevice.isAutoConnect());
        }
    }

    @Override // ohos.bluetooth.ble.IBlePeripheralCallback
    public void onClientConnectionState(int i, int i2, boolean z, String str) {
        if (Objects.equals(this.mDevice.getDeviceAddr(), str)) {
    ...
    public void onSearchComplete(String str, List<GattService> list, int i) {
        if (Objects.equals(this.mDevice.getDeviceAddr(), str)) {
            this.mDevice.updateServiceAndFixIncludeRelation(list);
    ...
    public void onCharacteristicRead(String str, int i, int i2, byte[] bArr) {
        if (Objects.equals(str, this.mDevice.getDeviceAddr())) {
            this.mDevice.releaseWriteReadLock();
            if (i == 5 || i == 15) {
                ...
                if (i3 != 2) {
                    ...
                    try {
                        this.mProxy.readCharacteristic(this.mDevice.getClientHandle(), this.mDevice.getDeviceAddr(), i2, i4);
    ...
    public /* synthetic */ void lambda$onCharacteristicWrite$1$BlePeripheralCallbackWrapper(int i, GattCharacteristic gattCharacteristic) {
        if (i == 5 || i == 15) {
            ...
            if (i2 != 2) {
                ...
                try {
                    this.mProxy.writeCharacteristic(this.mDevice.getClientHandle(), this.mDevice.getDeviceAddr(), i3, gattCharacteristic);
                    this.mAuthRetryState++;
                    return;
                } catch (RemoteException unused) {
        ...
        if (Objects.equals(str, this.mDevice.getDeviceAddr())) {
            ...
            if (i == 5 || i == 15) {
                ...
                if (i3 != 2) {
                    ...
                    try {
                        this.mProxy.readDescriptor(this.mDevice.getClientHandle(), this.mDevice.getDeviceAddr(), i2, i4);
                        this.mAuthRetryState++;
                        return;
                    } catch (RemoteException unused) {
    ...
    public /* synthetic */ void lambda$onDescriptorWrite$4$BlePeripheralCallbackWrapper(int i, int i2, GattDescriptor gattDescriptor) {
        ...
        if ((i == 5 || i == 15) && (i3 = this.mAuthRetryState) != 2) {
            try {
                this.mProxy.writeDescriptor(this.mDevice.getClientHandle(), this.mDevice.getDeviceAddr(), i2, i3 == 0 ? 1 : 2, gattDescriptor.getValue());
                this.mAuthRetryState++;
            } catch (RemoteException unused) {
