...
public class GeoAddress implements Sequenceable {
    ...
    private double mLatitude = XPath.MATCH_SCORE_QNAME;
    private Locale mLocale;
    private String mLocality;
    private double mLongitude = XPath.MATCH_SCORE_QNAME;
    ...
    public double getLatitude() {
        return this.mHasLatitude ? this.mLatitude : XPath.MATCH_SCORE_QNAME;
    }
    ...
    public double getLongitude() {
        return this.mHasLongitude ? this.mLongitude : XPath.MATCH_SCORE_QNAME;
    }
