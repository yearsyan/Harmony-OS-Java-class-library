...
public class RequestParam implements Sequenceable {
    ...
    public String toString() {
        return "RequestParam: " + " scenario=" + this.scenario + " priority=" + this.priority + " timeInterval=" + this.timeInterval + " distanceInterval=" + this.distanceInterval + " maxAccuracy=" + this.maxAccuracy;
    }
}
