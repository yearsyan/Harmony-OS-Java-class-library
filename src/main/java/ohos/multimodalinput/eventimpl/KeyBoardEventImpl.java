...
public class KeyBoardEventImpl extends KeyBoardEvent implements HostEventAdapter {
    ...
    static {
        ...
        A2Z_KEYMAP.put(18, 2011);
        A2Z_KEYMAP.put(19, 2012);
        A2Z_KEYMAP.put(20, 2013);
        A2Z_KEYMAP.put(21, 2014);
        A2Z_KEYMAP.put(22, 2015);
        A2Z_KEYMAP.put(23, 2016);
        ...
        A2Z_KEYMAP.put(49, 2037);
        A2Z_KEYMAP.put(50, 2038);
        A2Z_KEYMAP.put(51, 2039);
        ...
        A2Z_KEYMAP.put(117, Integer.valueOf((int) ohos.multimodalinput.event.KeyEvent.KEY_META_LEFT));
    ...
    public boolean isNoncharacterKeyPressed(int i) {
        ...
        switch (i) {
            case 2045:
            case ohos.multimodalinput.event.KeyEvent.KEY_ALT_RIGHT:
            ...
            default:
                switch (i) {
                    case ohos.multimodalinput.event.KeyEvent.KEY_CTRL_LEFT:
                    case ohos.multimodalinput.event.KeyEvent.KEY_CTRL_RIGHT:
                        return this.androidKeyEvent.isCtrlPressed();
                    case ohos.multimodalinput.event.KeyEvent.KEY_CAPS_LOCK:
                        return this.androidKeyEvent.isCapsLockOn();
                    case ohos.multimodalinput.event.KeyEvent.KEY_SCROLL_LOCK:
                        return this.androidKeyEvent.isScrollLockOn();
                    case ohos.multimodalinput.event.KeyEvent.KEY_META_LEFT:
                    case ohos.multimodalinput.event.KeyEvent.KEY_META_RIGHT:
                        return this.androidKeyEvent.isMetaPressed();
                    case ohos.multimodalinput.event.KeyEvent.KEY_FUNCTION:
