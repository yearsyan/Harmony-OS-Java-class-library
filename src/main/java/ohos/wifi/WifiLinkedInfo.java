...
public final class WifiLinkedInfo implements Sequenceable {
    ...
    static {
        CONVERT_MAP.put(SuppState.DISCONNECTED, ConnState.DISCONNECTED);
        CONVERT_MAP.put(SuppState.INTERFACE_DISABLED, ConnState.DISCONNECTED);
        CONVERT_MAP.put(SuppState.INACTIVE, ConnState.DISCONNECTED);
        CONVERT_MAP.put(SuppState.SCANNING, ConnState.SCANNING);
        CONVERT_MAP.put(SuppState.AUTHENTICATING, ConnState.CONNECTING);
        CONVERT_MAP.put(SuppState.ASSOCIATING, ConnState.CONNECTING);
        CONVERT_MAP.put(SuppState.ASSOCIATED, ConnState.CONNECTING);
        CONVERT_MAP.put(SuppState.FOUR_WAY_HANDSHAKE, ConnState.AUTHENTICATING);
        CONVERT_MAP.put(SuppState.GROUP_HANDSHAKE, ConnState.AUTHENTICATING);
        CONVERT_MAP.put(SuppState.COMPLETED, ConnState.OBTAINING_IPADDR);
        CONVERT_MAP.put(SuppState.UNINITIALIZED, ConnState.DISCONNECTED);
        CONVERT_MAP.put(SuppState.INVALID, ConnState.UNKNOWN);
    }
    ...
    public boolean marshalling(ohos.utils.Parcel r4) {
        /*
        // Method dump skipped, instructions count: 210
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.wifi.WifiLinkedInfo.marshalling(ohos.utils.Parcel):boolean");
    }
