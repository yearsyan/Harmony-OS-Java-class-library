...
class WifiP2pMessenger extends RemoteObject implements IRemoteBroker {
        ...
        public void processEvent(InnerEvent innerEvent) {
            ...
            if (innerEvent != null) {
                ...
                switch (innerEvent.eventId) {
                    case WifiP2pMessenger.CMD_CHANNEL_DISCONNECTED /*{ENCODED_INT: 69636}*/:
                        WifiP2pMessenger.this.handleChannelDisconnected(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.DISCOVER_PEERS_FAILED /*{ENCODED_INT: 139266}*/:
                    case WifiP2pMessenger.STOP_DISCOVERY_FAILED /*{ENCODED_INT: 139269}*/:
                    case WifiP2pMessenger.CONNECT_FAILED /*{ENCODED_INT: 139272}*/:
                    case WifiP2pMessenger.CANCEL_CONNECT_FAILED /*{ENCODED_INT: 139275}*/:
                    case WifiP2pMessenger.CREATE_GROUP_FAILED /*{ENCODED_INT: 139278}*/:
                    case WifiP2pMessenger.REMOVE_GROUP_FAILED /*{ENCODED_INT: 139281}*/:
                    case WifiP2pMessenger.SET_DEVICE_NAME_FAILED /*{ENCODED_INT: 139316}*/:
                    case WifiP2pMessenger.DELETE_PERSISTENT_GROUP_FAILED /*{ENCODED_INT: 139319}*/:
                    case WifiP2pMessenger.START_LISTEN_FAILED /*{ENCODED_INT: 139330}*/:
                    case WifiP2pMessenger.STOP_LISTEN_FAILED /*{ENCODED_INT: 139333}*/:
                        WifiP2pMessenger.this.handleEventFailed(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.DISCOVER_PEERS_SUCCEEDED /*{ENCODED_INT: 139267}*/:
                    case WifiP2pMessenger.STOP_DISCOVERY_SUCCEEDED /*{ENCODED_INT: 139270}*/:
                    case WifiP2pMessenger.CONNECT_SUCCEEDED /*{ENCODED_INT: 139273}*/:
                    case WifiP2pMessenger.CANCEL_CONNECT_SUCCEEDED /*{ENCODED_INT: 139276}*/:
                    case WifiP2pMessenger.CREATE_GROUP_SUCCEEDED /*{ENCODED_INT: 139279}*/:
                    case WifiP2pMessenger.REMOVE_GROUP_SUCCEEDED /*{ENCODED_INT: 139282}*/:
                    case WifiP2pMessenger.SET_DEVICE_NAME_SUCCEEDED /*{ENCODED_INT: 139317}*/:
                    case WifiP2pMessenger.DELETE_PERSISTENT_GROUP_SUCCEEDED /*{ENCODED_INT: 139320}*/:
                    case WifiP2pMessenger.START_LISTEN_SUCCEEDED /*{ENCODED_INT: 139331}*/:
                    case WifiP2pMessenger.STOP_LISTEN_SUCCEEDED /*{ENCODED_INT: 139334}*/:
                        if (wifiP2pCallback != null) {
                            wifiP2pCallback.eventExecOk();
                            return;
                        }
                        return;
                    case WifiP2pMessenger.RESPONSE_PEERS /*{ENCODED_INT: 139284}*/:
                        WifiP2pMessenger.this.handleResponsePeers(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.RESPONSE_CONNECTION_INFO /*{ENCODED_INT: 139286}*/:
                        WifiP2pMessenger.this.handleConnectionInfo(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.RESPONSE_GROUP_INFO /*{ENCODED_INT: 139288}*/:
                        WifiP2pMessenger.this.handleGroupInfo(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.RESPONSE_PERSISTENT_GROUP_INFO /*{ENCODED_INT: 139322}*/:
                        WifiP2pMessenger.this.handlePersistentGroupInfo(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.RESPONSE_NETWORK_INFO /*{ENCODED_INT: 139359}*/:
                        WifiP2pMessenger.this.handleNetworkInfo(wifiP2pCallback, obj);
                        return;
                    case WifiP2pMessenger.RESPONSE_DEVICE_INFO /*{ENCODED_INT: 139362}*/:
    ...
    public boolean onRemoteRequest(int i, MessageParcel messageParcel, MessageParcel messageParcel2, MessageOption messageOption) throws RemoteException {
        ...
        if (messageParcel.readInt() == 1) {
            messageParcel.readString();
            switch (readInt) {
                case RESPONSE_PEERS /*{ENCODED_INT: 139284}*/:
                    handlePeersResponse(messageParcel, readInt, readInt2);
                    return true;
                case RESPONSE_CONNECTION_INFO /*{ENCODED_INT: 139286}*/:
                    sequenceable = new WifiP2pLinkedInfo();
                    break;
                case RESPONSE_GROUP_INFO /*{ENCODED_INT: 139288}*/:
                    sequenceable = new WifiP2pGroup();
                    break;
                case RESPONSE_PERSISTENT_GROUP_INFO /*{ENCODED_INT: 139322}*/:
                    handleGroupInfoResponse(messageParcel, readInt, readInt2);
                    return true;
                case RESPONSE_NETWORK_INFO /*{ENCODED_INT: 139359}*/:
                    sequenceable = new WifiP2pNetworkInfo();
                    break;
                case RESPONSE_DEVICE_INFO /*{ENCODED_INT: 139362}*/:
