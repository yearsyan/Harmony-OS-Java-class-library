...
public class ErrorReminder {
    ...
    private static final int FREE_INSTALL_ERROR_CODE_MAXIMUM_DISPLAY_INTERVAL = 2000;
    ...
    private static final String FREE_INSTALL_ERROR_LABEL_FA_DISPATCHER_FAILED = "fa_dispatcher_error";
    ...
    private static volatile long toastLastShowTime;
    ...
    private String getErrorMsg(int i) {
        ...
        if (i == 1) {
            ...
            str = FREE_INSTALL_ERROR_LABEL_FA_DISPATCHER_FAILED;
        }
    ...
    public void showErrorMessage(final int i) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (currentTimeMillis - ErrorReminder.toastLastShowTime > 2000) {
                    long unused = ErrorReminder.toastLastShowTime = currentTimeMillis;
                    Looper.prepare();
                ...
                AppLog.w(ErrorReminder.ERROR_REMINDER, "the toast is showing now, do not display repeatedly", new Object[0]);
            }
        });
