...
public class PackageInstallerAdapter {
    ...
    private static final int MAX_INSTALL_WAIT_TIME_SECOND = 300;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00cd, code lost:
        if (r9 <= 4294967296L) goto L_0x00d6;
     */
    ...
    private boolean extractApkForInstall(android.content.pm.PackageInstaller.Session r21, java.lang.String r22, java.lang.String r23, boolean r24, ohos.bundlemgr.PackageInstalledStatus r25) {
        /*
        // Method dump skipped, instructions count: 370
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.bundlemgr.PackageInstallerAdapter.extractApkForInstall(android.content.pm.PackageInstaller$Session, java.lang.String, java.lang.String, boolean, ohos.bundlemgr.PackageInstalledStatus):boolean");
    }

    /* JADX WARNING: Removed duplicated region for block: B:28:0x008a  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean writeToSessionStream(android.content.pm.PackageInstaller.Session r15, ohos.bundlemgr.InstallShellInfo r16, ohos.bundlemgr.PackageInstalledStatus r17) {
        /*
        // Method dump skipped, instructions count: 175
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.bundlemgr.PackageInstallerAdapter.writeToSessionStream(android.content.pm.PackageInstaller$Session, ohos.bundlemgr.InstallShellInfo, ohos.bundlemgr.PackageInstalledStatus):boolean");
    }
    ...
    private IntentSender uninstallCallback(String str, int i, final PackageInstalledStatus packageInstalledStatus, final CountDownLatch countDownLatch) {
        ...
        }, new IntentFilter(str2), "ohos.permission.INSTALL_BUNDLE", null);
    ...
    private IntentSender sessionCommitCallback(final String str, int i, final PackageInstalledStatus packageInstalledStatus, final CountDownLatch countDownLatch) {
        ...
        this.context.registerReceiver(r0, new IntentFilter(str2), "ohos.permission.INSTALL_BUNDLE", null);
        Intent intent = new Intent(str2);
    ...
    private boolean checkRestrictedPermission(String str) {
        AppLog.d(PI_ADAPTER_LABEL, "checkRestrictedPermission, permission : %{public}s", str);
        ...
        return this.restrictedPermissions.contains(PermissionConversion.getZosPermissionNameIfPossible(str));
    }
    ...
    private void safeDeleteApkFile(File file) {
        ...
        try {
            ...
            AppLog.i(PI_ADAPTER_LABEL, "safeDeleteApkFile, delete: %{public}b", Boolean.valueOf(delete));
        } catch (SecurityException e) {
