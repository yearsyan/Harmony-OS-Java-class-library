...
public class DistributedManager implements IDistributedManager, IRemoteBroker {
    ...
    private static final int FREE_INSTALL_ABILITY_TRANSACTION = 50;
    ...
    public List<AbilityShellData> fetchAbilities(Intent intent) throws RemoteException {
        ...
        RunnableFuture<List<AbilityShellData>> createTask = createTask(obtain, obtain2, messageOption);
        this.cachedThreadPool.execute(createTask);
        try {
            return createTask.get(TIMEOUT_MS_WAIT_SEND_REQUEST, TimeUnit.MILLISECONDS);
        } catch (InterruptedException | ExecutionException | TimeoutException unused) {
    ...
    private RunnableFuture<List<AbilityShellData>> createTask(MessageParcel messageParcel, MessageParcel messageParcel2, MessageOption messageOption) {
        return new FutureTask(new Callable(messageParcel, messageParcel2, messageOption) {
            /* class ohos.abilityshell.$$Lambda$DistributedManager$j0JzLw66Oz2cdA4IWk9qWDYevjA */
            private final /* synthetic */ MessageParcel f$1;
            private final /* synthetic */ MessageParcel f$2;
            private final /* synthetic */ MessageOption f$3;
            ...
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return DistributedManager.this.lambda$createTask$1$DistributedManager(this.f$1, this.f$2, this.f$3);
            }
        });
    }

    public /* synthetic */ List lambda$createTask$1$DistributedManager(MessageParcel messageParcel, MessageParcel messageParcel2, MessageOption messageOption) throws Exception {
        try {
    ...
    @Override // ohos.abilityshell.IDistributedManager
    public int startRemoteFreeInstallAbility(Intent intent, IRemoteObject iRemoteObject) throws RemoteException {
        MessageParcel obtain = MessageParcel.obtain();
        if (!obtain.writeInterfaceToken(DISTRIBUTE_SCHEDULE_TOKEN)) {
            return -1;
        }
        ...
        AppLog.d(SHELL_LABEL, "DistributedManager::startRemoteFreeInstallAbility sendRequest", new Object[0]);
        Integer sendRequest = sendRequest(50, obtain);
        if (sendRequest == null) {
            return -1;
        }
        return sendRequest.intValue();
