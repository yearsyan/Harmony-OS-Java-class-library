...
import ohos.ace.plugin.distribute.DistributeConstants;
...
public class AbilityShellActivityDelegate extends AbilityShellDelegate {
    ...
    public void onCreate(Bundle bundle) {
        ...
        C0000Bytrace.startTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "startAbility_onCreate");
        ...
        C0000Bytrace.finishTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "startAbility_onCreate");
        handleLoadAbility();
    ...
    private void handleCreateAsContinuation(Intent intent) {
        ...
        String stringParam = intent.getStringParam("deviceId");
    ...
    public void onDestroy() {
        ...
        if (this.isLoadAsForm) {
            ...
            instance.removeOrSubRef(this.abilityInfo.getClassName(), this.ability);
        }
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        ...
        MultimodalEvent multimodalEvent = convertKeyEvent.get();
        ...
        return this.ability.onKeyDown(keyEvent2.getKeyCode(), keyEvent2);
    }
    ...
    public boolean onKeyUp(int i, KeyEvent keyEvent) {
        ...
        ohos.multimodalinput.event.KeyEvent keyEvent2 = (ohos.multimodalinput.event.KeyEvent) multimodalEvent;
        return this.ability.onKeyUp(keyEvent2.getKeyCode(), keyEvent2);
    }

    public boolean dispatchKeyLongPress(int i, KeyEvent keyEvent) {
        Optional<MultimodalEvent> convertKeyEvent = AndroidEventProcessor.convertKeyEvent(keyEvent);
        if (!convertKeyEvent.isPresent()) {
            AppLog.e(SHELL_LABEL, "AbilityShellActivityDelegate::dispatchKeyLongPress event invalid", new Object[0]);
            return false;
        }
        MultimodalEvent multimodalEvent = convertKeyEvent.get();
        if (!(multimodalEvent instanceof ohos.multimodalinput.event.KeyEvent)) {
            AppLog.e(SHELL_LABEL, "AbilityShellActivityDelegate::dispatchKeyLongPress not KeyEvent", new Object[0]);
            return false;
        }
        ohos.multimodalinput.event.KeyEvent keyEvent2 = (ohos.multimodalinput.event.KeyEvent) multimodalEvent;
        return this.ability.dispatchKeyLongPress(keyEvent2.getKeyCode(), keyEvent2);
    }
    ...
    public boolean dispatchKeyShortcutEvent(int i, KeyEvent keyEvent) {
        Optional<MultimodalEvent> convertKeyEvent = AndroidEventProcessor.convertKeyEvent(keyEvent);
        if (!convertKeyEvent.isPresent()) {
            AppLog.e(SHELL_LABEL, "AbilityShellActivityDelegate::dispatchKeyShortcutEvent event invalid", new Object[0]);
            return false;
        }
        MultimodalEvent multimodalEvent = convertKeyEvent.get();
        if (multimodalEvent instanceof ohos.multimodalinput.event.KeyEvent) {
            return this.ability.dispatchKeyShortcutEvent(i, (ohos.multimodalinput.event.KeyEvent) multimodalEvent);
        }
        AppLog.e(SHELL_LABEL, "AbilityShellActivityDelegate::dispatchKeyShortcutEvent not KeyBoardEvent", new Object[0]);
        return false;
    }

    public boolean convertTouchEventThenDispatch(MotionEvent motionEvent) {
        if (AndroidEventProcessor.dispatchToStandardEvent(this.ability, motionEvent)) {
            AppLog.d(SHELL_LABEL, "event is consumed by standard processor", new Object[0]);
            return true;
        }
        ...
        MultimodalEvent multimodalEvent = convertTouchEvent.get();
        if (multimodalEvent instanceof TouchEvent) {
            return this.ability.dispatchTouchEvent((TouchEvent) multimodalEvent);
        }
        if (multimodalEvent instanceof MouseEvent) {
            return this.ability.dispatchMouseEvent((MouseEvent) multimodalEvent);
        }
        if (multimodalEvent instanceof RotationEvent) {
            return this.ability.dispatchRotationEvent((RotationEvent) multimodalEvent);
        }
    ...
    public boolean convertKeyEventThenDispatch(KeyEvent keyEvent) {
        if (AndroidEventProcessor.dispatchToStandardEvent(this.ability, keyEvent)) {
            AppLog.d(SHELL_LABEL, "event is consumed by standard processor", new Object[0]);
            return true;
        }
        Optional<MultimodalEvent> convertKeyEvent = AndroidEventProcessor.convertKeyEvent(keyEvent);
        ...
        MultimodalEvent multimodalEvent = convertKeyEvent.get();
        if (multimodalEvent instanceof ohos.multimodalinput.event.KeyEvent) {
            return this.ability.dispatchKeyBoardEvent((ohos.multimodalinput.event.KeyEvent) multimodalEvent);
        }
    ...
    private void handleLoadAbility() {
        ...
        if (this.abilityInfo.getFormEnabled()) {
            ...
            if (formAbility == null || formAbility.getAbility() == null || formAbility.getAbility().isTerminating()) {
                AppLog.d(SHELL_LABEL, "AbilityShellActivityDelegate::onCreate new Form ability", new Object[0]);
    ...
    private boolean checkGrantedResult(String[] strArr, String[] strArr2, int[] iArr) {
        if (strArr == null || strArr.length == 0) {
            ...
            AppLog.w(SHELL_LABEL, "AbilityShellDelegate::checkGrantedResult permissions doesn't match the grantResults", new Object[0]);
            return false;
        }
    }
    ...
    private boolean continueAbilityInner(IRemoteObject iRemoteObject, String str) {
        HiTraceId hiTraceBegin = HiTraceUtil.hiTraceBegin(DistributeConstants.METHOD_CONTINUE_ABILITY);
        Integer num = null;
        try {
    ...
    public void onWindowDisplayModeChanged(boolean z, Configuration configuration) {
        this.ability.dispatchAbilityWindowDisplayModeChanged(z, ResourceUtils.convert(configuration));
    }
}
