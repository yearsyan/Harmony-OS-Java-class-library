...
public class HiEvent {
    ...
    public HiEvent putBoolArray(String str, boolean[] zArr) {
        ...
        int min = Math.min(zArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putByteArray(String str, byte[] bArr) {
        ...
        int min = Math.min(bArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putShortArray(String str, short[] sArr) {
        ...
        int min = Math.min(sArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putIntArray(String str, int[] iArr) {
        ...
        int min = Math.min(iArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putLongArray(String str, long[] jArr) {
        ...
        int min = Math.min(jArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putFloatArray(String str, float[] fArr) {
        ...
        int min = Math.min(fArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putString(String str, String str2) {
        if (checkValid(str, 32)) {
            if (checkValid(str2, 1024)) {
                this.mPayload.put(str, str2);
                return this;
            } else if (str2 != null && str2.length() > 1024) {
                this.mPayload.put(str, str2.substring(0, 1024));
            }
        }
        return this;
    }
    ...
    public HiEvent putStringArray(String str, String[] strArr) {
        ...
        int min = Math.min(strArr.length, this.mPayload.getRemainNum(str, 100));
        for (int i = 0; i < min; i++) {
    ...
    public HiEvent putHiEventArray(String str, HiEvent[] hiEventArr) {
        ...
        int min = Math.min(hiEventArr.length, this.mPayload.getRemainNum(str, 100));
        int i = 0;
