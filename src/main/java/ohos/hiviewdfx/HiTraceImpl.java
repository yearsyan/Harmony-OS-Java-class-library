...
public final class HiTraceImpl {
    ...
    public static void tracePoint(int i, HiTraceId hiTraceId, String str, Object... objArr) {
        tracePoint(0, i, hiTraceId, str, objArr);
    }

    public static void tracePoint(int i, int i2, HiTraceId hiTraceId, String str, Object... objArr) {
        if (i >= 0 && i <= 3 && i2 >= 0 && i2 <= 4 && hiTraceId != null && str != null) {
            String str2 = null;
            try {
            ...
            if (str2 != null) {
                byte[] bytes = hiTraceId.toBytes();
                if (bytes.length == 16) {
                    tracePointNative(i, i2, bytes, str2);
                }
            }
        }
    }
