...
public class AccessibilityAceViewDelegate extends BarrierFreeDelegateHelper {
    ...
    public AccessibilityAceViewDelegate(View view, View view2, String str) {
        super(view, view2, str);
    }

    public AccessibilityAceViewDelegate(View view, int i, String str) {
        super(view, i, str);
    }
    ...
    public void onPopulateAllViewIds(IntArray intArray) {
        AccessibilityViewInfo queryAccessibilityViewInfoById = queryAccessibilityViewInfoById(0, this.mapKey);
    ...
    /* access modifiers changed from: protected */
    @Override // ohos.accessibility.adapter.BarrierFreeDelegateHelper
    public AccessibilityViewInfo queryAccessibilityViewInfoById(int i, String str) {
        if (str == null) {
            return AccessibilityNativeAceMethods.getAccessibilityViewInfoById(i);
        }
        return AccessibilityNativeAceMethods.getAccessibilityViewInfoByIdAndKey(i, str);
    }
    ...
    /* access modifiers changed from: protected */
    @Override // ohos.accessibility.adapter.BarrierFreeDelegateHelper
    public AccessibilityViewInfo queryRootAccessibilityViewInfo(String str) {
        if (str == null) {
            return AccessibilityNativeAceMethods.getAccessibilityViewInfoById(0);
        }
        return AccessibilityNativeAceMethods.getAccessibilityViewInfoByIdAndKey(0, str);
    }
