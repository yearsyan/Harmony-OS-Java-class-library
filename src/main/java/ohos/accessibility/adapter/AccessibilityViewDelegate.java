...
public class AccessibilityViewDelegate extends BarrierFreeDelegateHelper {
    ...
    public AccessibilityViewDelegate(View view, View view2, String str) {
        super(view, view2, str);
    }

    public AccessibilityViewDelegate(View view, int i, String str) {
        super(view, i, str);
    }
    ...
    public void onPopulateAllViewIds(IntArray intArray) {
        AccessibilityViewInfo queryAccessibilityViewInfoById = queryAccessibilityViewInfoById(0, null);
