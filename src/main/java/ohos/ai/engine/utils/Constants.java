...
public class Constants {
    ...
    public static final int MAX_NUM_OF_CLOUD_HEADER = 500;
    public static final int MAX_NUM_OF_MODELS = 1000;
    public static final int MAX_NUM_OF_SPLITS = 500;
    public static final String PERMISSION = "com.huawei.hiai.permission.HIAIENGINE_START_COMPONENT";
    public static final int PLUGIN_REQUEST_MAX_SIZE = 128;
