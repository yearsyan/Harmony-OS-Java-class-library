...
public class ParamKey {
    ...
    public static final String BARCODE_CORRECTION_LEVEL = "barcode_errorlevel";
    public static final String BARCODE_FORMAT = "barcode_format";
    public static final String BARCODE_INPUT = "barcode_input";
    public static final String BARCODE_MARGIN = "barcode_margin";
