...
public class TextParamKey extends ParamKey {
    public static final String CURVE_SUPPORT = "curve_support";
    ...
    public static final String VISION_TRACKER_OCR_FORCE_OCR_FLAG = "vision_tracker_ocr_force_tracking";
    public static final String VISION_TRACKER_OCR_RELEASE = "vision_tracker_ocr_release";
    public static final String VISION_TRACKER_OCR_TRACKING_FLAG = "vision_tracker_ocr_tracking_flag";

    private TextParamKey() {
    }
}
