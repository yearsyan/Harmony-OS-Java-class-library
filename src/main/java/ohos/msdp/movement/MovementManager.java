...
public class MovementManager {
    ...
    private static final HwMSDPOtherParameters PARAM_NO_WAKEUP = new HwMSDPOtherParameters(1.0d, XPath.MATCH_SCORE_QNAME, XPath.MATCH_SCORE_QNAME, XPath.MATCH_SCORE_QNAME, "");
