...
public final class JLog {
    ...
    public static final HiLogLabel JLLOG_LABEL = new HiLogLabel(3, JLOG_DOMAIN, "Jlog");
    ...
    static {
        ...
        try {
            ...
            HiLog.error(JLLOG_LABEL, "%{public}s is not load. %{public}s", LIBRARY_NAME, e.getMessage());
            isLibraryLoaded = false;
        }
    }
