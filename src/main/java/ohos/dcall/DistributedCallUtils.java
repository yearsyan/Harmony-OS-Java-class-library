...
public class DistributedCallUtils {
    ...
    public static final int DEFAULT_OBSERVER_SLOT_ID = Integer.MAX_VALUE;
    ...
    public static final int MAX_CONFERENCE_CALL_NUMBER = 32;
    ...
    public static final int MSG_COMBINE_CONFERENCE = 17;
    ...
    public static final int MSG_GET_CALL_ID_LIST_FOR_CONFERENCE = 21;
    public static final int MSG_GET_CALL_STATE = 2005;
    public static final int MSG_GET_MAIN_CALL_ID = 22;
    public static final int MSG_GET_PREDEFINED_REJECT_MESSAGE = 12;
    public static final int MSG_GET_SUB_CALL_ID_LIST = 20;
    ...
    public static final int MSG_IS_HAC_ENABLE = 2011;
    public static final int MSG_IS_NEW_CALL_ALLOWED = 7;
    public static final int MSG_JOIN_CONFERENCE = 16;
    ...
    public static final int MSG_SEPARATE_CONFERENCE = 18;
    ...
    public static final int MSG_SWITCH_CDEM_CONFERENCE = 19;
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, 218111744, "DistributedCallUtils");
