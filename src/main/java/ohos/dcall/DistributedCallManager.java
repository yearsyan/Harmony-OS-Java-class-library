...
public class DistributedCallManager {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, 218111744, "DistributedCallManager");
    ...
    public void addObserver(CallStateObserver callStateObserver, int i) {
        ...
        if (i == 4) {
            ...
            if (context != null && context.verifySelfPermission("ohos.permission.READ_CALL_LOG") == 0) {
                z = true;
            }
    ...
    public boolean isHacEnabled() {
        return this.mDistributedCallProxy.isHacEnabled();
    }
}
