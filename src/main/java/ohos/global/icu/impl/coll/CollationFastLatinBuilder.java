...
public final class CollationFastLatinBuilder {
    ...
    private boolean getCEsFromCE32(ohos.global.icu.impl.coll.CollationData r12, int r13, int r14) {
        /*
        // Method dump skipped, instructions count: 248
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.coll.CollationFastLatinBuilder.getCEsFromCE32(ohos.global.icu.impl.coll.CollationData, int, int):boolean");
    }
                ...
                if (length2 > 1023) {
                    ...
                    while (true) {
                        ...
                        if (encodeTwoCEs == 1) {
                            ...
                            this.result.append((char) ((int) (elementAti | AVPlaybackState.PLAYBACK_ACTION_PLAY_FROM_MEDIA_ID)));
