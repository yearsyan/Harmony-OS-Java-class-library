...
public final class CollationDataBuilder {
    ...
    public boolean getJamoCE32s(int[] r11) {
        /*
        // Method dump skipped, instructions count: 160
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.coll.CollationDataBuilder.getJamoCE32s(int[]):boolean");
    }
