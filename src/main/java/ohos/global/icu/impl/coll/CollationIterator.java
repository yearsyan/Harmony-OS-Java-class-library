...
public abstract class CollationIterator {
    ...
    private final int nextCE32FromContraction(ohos.global.icu.impl.coll.CollationData r7, int r8, java.lang.CharSequence r9, int r10, int r11, int r12) {
        /*
        // Method dump skipped, instructions count: 140
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.coll.CollationIterator.nextCE32FromContraction(ohos.global.icu.impl.coll.CollationData, int, java.lang.CharSequence, int, int, int):int");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final int nextCE32FromDiscontiguousContraction(ohos.global.icu.impl.coll.CollationData r9, ohos.global.icu.util.CharsTrie r10, int r11, int r12, int r13) {
        /*
        // Method dump skipped, instructions count: 234
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.coll.CollationIterator.nextCE32FromDiscontiguousContraction(ohos.global.icu.impl.coll.CollationData, ohos.global.icu.util.CharsTrie, int, int, int):int");
    }
