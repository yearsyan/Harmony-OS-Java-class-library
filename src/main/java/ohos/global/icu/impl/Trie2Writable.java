...
public class Trie2Writable extends Trie2 {
    ...
    private void init(int i, int i2) {
        ...
        for (int i12 = 0; i12 < 576; i12++) {
            this.index2[i12 + KeyEvent.KEY_BREAK] = -1;
        }
    ...
    public ohos.global.icu.impl.Trie2Writable setRange(int r17, int r18, int r19, boolean r20) {
        /*
        // Method dump skipped, instructions count: 214
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.Trie2Writable.setRange(int, int, int, boolean):ohos.global.icu.impl.Trie2Writable");
    }
    ...
    private void compactIndex2() {
        ...
        int i3 = KeyEvent.KEY_BREAK + ((this.highStart - 65536) >> 11) + 32;
    ...
    private void compactTrie() {
        ...
        if (this.highStart > 65536) {
            ...
            System.out.printf("UTrie2: highStart U+%04x  count of 16-bit index-2 words %d->%d%n", Integer.valueOf(this.highStart), Integer.valueOf(this.index2Length), Integer.valueOf((int) KeyEvent.KEY_NUMPAD_9));
        }
        int[] iArr = this.data;
    ...
    private void freeze(Trie2 trie2, Trie2.ValueWidth valueWidth) {
        ...
        if (this.highStart > 65536) {
            ...
            int i9 = i8 + KeyEvent.KEY_NUMPAD_9;
            int i10 = i6;
            int i11 = 0;
            while (i11 < i8) {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ohos.global.icu.impl.Trie2$ValueWidth[] r0 = ohos.global.icu.impl.Trie2.ValueWidth.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ohos.global.icu.impl.Trie2Writable.AnonymousClass1.$SwitchMap$ohos$global$icu$impl$Trie2$ValueWidth = r0
                int[] r0 = ohos.global.icu.impl.Trie2Writable.AnonymousClass1.$SwitchMap$ohos$global$icu$impl$Trie2$ValueWidth     // Catch:{ NoSuchFieldError -> 0x0014 }
                ohos.global.icu.impl.Trie2$ValueWidth r1 = ohos.global.icu.impl.Trie2.ValueWidth.BITS_16     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = ohos.global.icu.impl.Trie2Writable.AnonymousClass1.$SwitchMap$ohos$global$icu$impl$Trie2$ValueWidth     // Catch:{ NoSuchFieldError -> 0x001f }
                ohos.global.icu.impl.Trie2$ValueWidth r1 = ohos.global.icu.impl.Trie2.ValueWidth.BITS_32     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.Trie2Writable.AnonymousClass1.<clinit>():void");
        }
    }
}
