...
public class CombinedCurrencyMatcher implements NumberParseMatcher {
    ...
    public boolean match(ohos.global.icu.impl.StringSegment r6, ohos.global.icu.impl.number.parse.ParsedNumber r7) {
        /*
        // Method dump skipped, instructions count: 115
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.number.parse.CombinedCurrencyMatcher.match(ohos.global.icu.impl.StringSegment, ohos.global.icu.impl.number.parse.ParsedNumber):boolean");
    }
