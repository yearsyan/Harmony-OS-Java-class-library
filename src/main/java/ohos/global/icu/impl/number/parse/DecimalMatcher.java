...
public class DecimalMatcher implements NumberParseMatcher {
    ...
    public boolean match(ohos.global.icu.impl.StringSegment r21, ohos.global.icu.impl.number.parse.ParsedNumber r22, int r23) {
        /*
        // Method dump skipped, instructions count: 629
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.number.parse.DecimalMatcher.match(ohos.global.icu.impl.StringSegment, ohos.global.icu.impl.number.parse.ParsedNumber, int):boolean");
    }
