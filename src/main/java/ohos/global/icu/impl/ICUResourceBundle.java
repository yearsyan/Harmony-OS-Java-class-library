...
public class ICUResourceBundle extends UResourceBundle {
    ...
    public static final ULocale getFunctionalEquivalent(String str, ClassLoader classLoader, String str2, String str3, ULocale uLocale, boolean[] zArr, boolean z) {
        ...
        do {
            try {
                str6 = ((ICUResourceBundle) iCUResourceBundle.get(str2)).getString("default");
                if (z2) {
                    z2 = false;
                    str4 = str6;
                }
        ...
        do {
            try {
                ...
                if (uLocale4 != null && i5 > i4) {
                    str6 = iCUResourceBundle3.getString("default");
        ...
        if (uLocale4 != null || str6 == null || str6.equals(str4)) {
            ...
            do {
                try {
                    ...
                    if (!uLocale4.getBaseName().equals(((ICUResourceBundle) iCUResourceBundle5.get(str6)).getULocale().getBaseName())) {
                        uLocale4 = null;
                    }
    ...
    public static final String[] getKeywordValues(String str, String str2) {
        ...
        for (int i = 0; i < uLocaleList.length; i++) {
            try {
                Enumeration<String> keys = ((ICUResourceBundle) UResourceBundle.getBundleInstance(str, uLocaleList[i]).getObject(str2)).getKeys();
    ...
    public static final class AvailableLocalesSink extends UResource.Sink {
        ...
        public void put(UResource.Key key, UResource.Value value, boolean z) {
            ...
            for (int i = 0; table.getKeyAndValue(i, key, value); i++) {
                ...
                this.output.put(availableType, uLocaleArr);
            }
        }
    }
    ...
    public static final EnumMap<ULocale.AvailableType, ULocale[]> createULocaleList(String str, ClassLoader classLoader) {
        ...
        ((ICUResourceBundle) UResourceBundle.instantiateBundle(str, ICU_RESOURCE_INDEX, classLoader, true)).getAllItemsWithFallback("", new AvailableLocalesSink(enumMap));
        return enumMap;
    }
    ...
    private static final java.lang.String findStringWithFallback(java.lang.String r13, ohos.global.icu.util.UResourceBundle r14, ohos.global.icu.util.UResourceBundle r15) {
        /*
        // Method dump skipped, instructions count: 202
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.impl.ICUResourceBundle.findStringWithFallback(java.lang.String, ohos.global.icu.util.UResourceBundle, ohos.global.icu.util.UResourceBundle):java.lang.String");
    }
        ...
        if (hashMap2.get(alias) == null) {
            ...
            if (alias.indexOf(47) == 0) {
                ...
                if (str3.equals(ICUDATA)) {
                    ...
                    str3 = "ohos/global/icu/impl/data/icudt67b/" + str3.substring(indexOf + 1, str3.length());
                    classLoader = ICU_DATA_CLASS_LOADER;
                }
            } else {
