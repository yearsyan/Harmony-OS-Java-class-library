...
public final class ICUData {
    public static final String ICU_BASE_NAME = "ohos/global/icu/impl/data/icudt67b";
    public static final String ICU_BRKITR_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/brkitr";
    public static final String ICU_BRKITR_NAME = "brkitr";
    public static final String ICU_BUNDLE = "data/icudt67b";
    public static final String ICU_COLLATION_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/coll";
    public static final String ICU_CURR_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/curr";
    static final String ICU_DATA_PATH = "ohos/global/icu/impl/";
    public static final String ICU_LANG_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/lang";
    public static final String ICU_RBNF_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/rbnf";
    public static final String ICU_REGION_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/region";
    public static final String ICU_TRANSLIT_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/translit";
    public static final String ICU_UNIT_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/unit";
    public static final String ICU_ZONE_BASE_NAME = "ohos/global/icu/impl/data/icudt67b/zone";
    static final String PACKAGE_NAME = "icudt67b";
