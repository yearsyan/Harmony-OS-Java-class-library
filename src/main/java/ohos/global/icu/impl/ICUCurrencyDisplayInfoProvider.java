...
public class ICUCurrencyDisplayInfoProvider implements CurrencyData.CurrencyDisplayInfoProvider {
    ...
    static class ICUCurrencyDisplayInfo extends CurrencyData.CurrencyDisplayInfo {
        ...
        public String getNarrowSymbol(String str) {
            VariantSymbol fetchVariantSymbol = fetchVariantSymbol(str, "narrow");
            if (fetchVariantSymbol.symbol != null || !this.fallback) {
                return fetchVariantSymbol.symbol;
            }
        ...
        public String getVariantSymbol(String str) {
            VariantSymbol fetchVariantSymbol = fetchVariantSymbol(str, "variant");
            if (fetchVariantSymbol.symbol != null || !this.fallback) {
                return fetchVariantSymbol.symbol;
            }
            return getSymbol(str);
        ...
        public VariantSymbol fetchVariantSymbol(String str, String str2) {
            ...
            ICUResourceBundle iCUResourceBundle = this.rb;
            iCUResourceBundle.getAllItemsWithFallbackNoFail("Currencies%" + str2 + "/" + str, currencySink);
        ...
        public static final class CurrencySink extends UResource.Sink {
            ...
            /* access modifiers changed from: package-private */
            public void consumeCurrenciesVariantEntry(UResource.Key key, UResource.Value value) {
