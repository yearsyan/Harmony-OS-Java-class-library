...
public class DataRecord {
    ...
    public interface EPluralization {
        ...
        public static final String[] names = {KeyStoreConstants.DIGEST_ALGORITHM_NONE, "PLURAL", "DUAL", "PAUCAL", "HEBREW", "ARABIC"};
    }
    ...
    public interface ESeparatorVariant {
        ...
        public static final String[] names = {KeyStoreConstants.DIGEST_ALGORITHM_NONE, "SHORT", "FULL"};
    }
    ...
    public static DataRecord read(String str, RecordReader recordReader) {
        if (recordReader.open("DataRecord")) {
            ...
            dataRecord.genders = recordReader.namedIndexArray(ContactItem.GENDER, EGender.names);
    ...
    public void write(RecordWriter recordWriter) {
        ...
        recordWriter.namedIndexArray(ContactItem.GENDER, EGender.names, this.genders);
