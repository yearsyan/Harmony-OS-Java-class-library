...
public class HebrewCalendar extends Calendar {
    ...
    private static final int[][] LEAP_MONTH_START = {new int[]{0, 0, 0}, new int[]{30, 30, 30}, new int[]{59, 59, 60}, new int[]{88, 89, 90}, new int[]{117, 118, 119}, new int[]{147, 148, 149}, new int[]{177, 178, 179}, new int[]{206, 207, 208}, new int[]{236, 237, 238}, new int[]{265, 266, 267}, new int[]{295, 296, 297}, new int[]{JLogConstants.JLID_CAMERAALGO_ALGOEXT4_BEGIN, 325, JLogConstants.JLID_CAMERA3_OIS_FW_DOWNLOAD_BEGIN}, new int[]{JLogConstants.JLID_GAME_START, JLogConstants.JLID_GAME_APPEND_FPS, JLogConstants.JLID_GAME_SCENE_CHANGE}, new int[]{383, 384, JLogConstants.JLID_TOUCH_RECORD_TIME}};
    private static final int[][] LIMITS = {new int[]{0, 0, 0, 0}, new int[]{-5000000, -5000000, 5000000, 5000000}, new int[]{0, 0, 12, 12}, new int[]{1, 1, 51, 56}, new int[0], new int[]{1, 1, 29, 30}, new int[]{1, 1, JLogConstants.JLID_SYSTEM_SERVICE_FROZEN, JLogConstants.JLID_TOUCH_RECORD_TIME}, new int[0], new int[]{-1, -1, 5, 5}, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[0]};
    ...
    private static final int[][] MONTH_START = {new int[]{0, 0, 0}, new int[]{30, 30, 30}, new int[]{59, 59, 60}, new int[]{88, 89, 90}, new int[]{117, 118, 119}, new int[]{147, 148, 149}, new int[]{147, 148, 149}, new int[]{176, 177, 178}, new int[]{206, 207, 208}, new int[]{235, 236, 237}, new int[]{265, 266, 267}, new int[]{294, 295, 296}, new int[]{JLogConstants.JLID_CAMERAALGO_ALGOEXT4_BEGIN, 325, JLogConstants.JLID_CAMERA3_OIS_FW_DOWNLOAD_BEGIN}, new int[]{JLogConstants.JLID_SYSTEM_SERVICE_FROZEN, JLogConstants.JLID_GAME_START, JLogConstants.JLID_GAME_APPEND_FPS}};
    ...
    private final int yearType(int i) {
        ...
        switch (handleGetYearLength) {
            case JLogConstants.JLID_SYSTEM_SERVICE_FROZEN:
                return 0;
            case JLogConstants.JLID_GAME_START:
                return 1;
            case JLogConstants.JLID_GAME_APPEND_FPS:
                return 2;
            default:
