...
abstract class CECalendar extends Calendar {
    private static final int[][] LIMITS = {new int[]{0, 0, 1, 1}, new int[]{1, 1, 5000000, 5000000}, new int[]{0, 0, 12, 12}, new int[]{1, 1, 52, 53}, new int[0], new int[]{1, 1, 5, 30}, new int[]{1, 1, JLogConstants.JLID_APP_FRONZED_BEGIN, JLogConstants.JLID_APP_FRONZED_END}, new int[0], new int[]{-1, -1, 1, 5}, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[0]};
    ...
    public static void jdToCE(int i, int i2, int[] iArr) {
        int[] iArr2 = new int[1];
        int i3 = iArr2[0];
        int i4 = JLogConstants.JLID_APP_FRONZED_BEGIN;
        iArr[0] = (floorDivide(i - i2, 1461, iArr2) * 4) + ((i3 / JLogConstants.JLID_APP_FRONZED_BEGIN) - (iArr2[0] / 1460));
        if (iArr2[0] != 1460) {
            i4 = iArr2[0] % JLogConstants.JLID_APP_FRONZED_BEGIN;
        }
        iArr[1] = i4 / 30;
        iArr[2] = (i4 % 30) + 1;
    }
