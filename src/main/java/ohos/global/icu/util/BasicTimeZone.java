...
public abstract class BasicTimeZone extends TimeZone {
    ...
    public boolean hasEquivalentTransitions(ohos.global.icu.util.TimeZone r8, long r9, long r11, boolean r13) {
        /*
        // Method dump skipped, instructions count: 402
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.util.BasicTimeZone.hasEquivalentTransitions(ohos.global.icu.util.TimeZone, long, long, boolean):boolean");
    }
    ...
    public TimeZoneRule[] getSimpleTimeZoneRulesNear(long j) {
        ...
        if (nextTransition2 != null) {
            ...
            if (((nextTransition2.getFrom().getDSTSavings() != 0 || nextTransition2.getTo().getDSTSavings() == 0) && (nextTransition2.getFrom().getDSTSavings() == 0 || nextTransition2.getTo().getDSTSavings() != 0)) || j + MILLIS_PER_YEAR <= time) {
                ...
                str2 = name;
                int[] timeToFields = Grego.timeToFields(((long) nextTransition2.getFrom().getRawOffset()) + time + ((long) nextTransition2.getFrom().getDSTSavings()), null);
