...
public class IndianCalendar extends Calendar {
    ...
    private static final int[][] LIMITS = {new int[]{0, 0, 0, 0}, new int[]{-5000000, -5000000, 5000000, 5000000}, new int[]{0, 0, 11, 11}, new int[]{1, 1, 52, 53}, new int[0], new int[]{1, 1, 30, 31}, new int[]{1, 1, JLogConstants.JLID_APP_FRONZED_BEGIN, JLogConstants.JLID_APP_FRONZED_END}, new int[0], new int[]{-1, -1, 5, 5}, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[0]};
    ...
    private static double gregorianToJD(int i, int i2, int i3) {
        int i4;
        int i5 = i - 1;
        int i6 = (((i5 * JLogConstants.JLID_APP_FRONZED_BEGIN) + (i5 / 4)) - (i5 / 100)) + (i5 / 400) + (((i2 * JLogConstants.JLID_APP_UNFRONZED_BEGIN) - 362) / 12);
        if (i2 <= 2) {
            i4 = 0;
        } else {
