...
public class GregorianCalendar extends Calendar {
    ...
    private static final int[][] LIMITS = {new int[]{0, 0, 1, 1}, new int[]{1, 1, 5828963, 5838270}, new int[]{0, 0, 11, 11}, new int[]{1, 1, 52, 53}, new int[0], new int[]{1, 1, 28, 31}, new int[]{1, 1, JLogConstants.JLID_APP_FRONZED_BEGIN, JLogConstants.JLID_APP_FRONZED_END}, new int[0], new int[]{-1, -1, 4, 5}, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[]{-5838270, -5838270, 5828964, 5838271}, new int[0], new int[]{-5838269, -5838269, 5828963, 5838270}, new int[0], new int[0], new int[0]};
    ...
    public void handleComputeFields(int i) {
        ...
        if (i >= this.cutoverJulianDay) {
            ...
            int i7 = ((((floorDivide2 >= (z ? 60 : 59) ? z ? 1 : 2 : 0) + floorDivide2) * 12) + 6) / JLogConstants.JLID_APP_UNFRONZED_BEGIN;
    ...
    public int handleComputeMonthStart(int i, int i2, boolean z) {
        ...
        boolean z2 = i % 4 == 0;
        int i3 = i - 1;
        int floorDivide = (i3 * JLogConstants.JLID_APP_FRONZED_BEGIN) + floorDivide(i3, 4) + 1721423;
