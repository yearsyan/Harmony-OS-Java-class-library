...
public abstract class UResourceBundle extends ResourceBundle {
    ...
    /* JADX WARN: Type inference failed for: r3v6, types: [ohos.global.icu.util.UResourceBundle$RootType] */
    /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
        ohos.global.icu.impl.ResourceBundleWrapper.getBundleInstance(r2, r0, (java.lang.ClassLoader) r3, true);
        r3 = ohos.global.icu.util.UResourceBundle.RootType.JAVA;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0026, code lost:
        r3 = ohos.global.icu.util.UResourceBundle.RootType.MISSING;
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing exception handler attribute for start block: B:10:0x0020 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static ohos.global.icu.util.UResourceBundle.RootType getRootType(java.lang.String r2, java.lang.ClassLoader r3) {
        /*
            java.util.Map<java.lang.String, ohos.global.icu.util.UResourceBundle$RootType> r0 = ohos.global.icu.util.UResourceBundle.ROOT_CACHE
            java.lang.Object r0 = r0.get(r2)
            ohos.global.icu.util.UResourceBundle$RootType r0 = (ohos.global.icu.util.UResourceBundle.RootType) r0
        ...
        L_0x0018:
            r1 = 1
            ohos.global.icu.impl.ICUResourceBundle.getBundleInstance(r2, r0, r3, r1)     // Catch:{ MissingResourceException -> 0x0020 }
            ohos.global.icu.util.UResourceBundle$RootType r3 = ohos.global.icu.util.UResourceBundle.RootType.ICU     // Catch:{ MissingResourceException -> 0x0020 }
        L_0x001e:
            r0 = r3
            goto L_0x0029
        L_0x0020:
            ohos.global.icu.impl.ResourceBundleWrapper.getBundleInstance(r2, r0, r3, r1)     // Catch:{ MissingResourceException -> 0x0026 }
            ohos.global.icu.util.UResourceBundle$RootType r3 = ohos.global.icu.util.UResourceBundle.RootType.JAVA     // Catch:{ MissingResourceException -> 0x0026 }
            goto L_0x001e
        L_0x0026:
            ohos.global.icu.util.UResourceBundle$RootType r3 = ohos.global.icu.util.UResourceBundle.RootType.MISSING
            goto L_0x001e
        L_0x0029:
            java.util.Map<java.lang.String, ohos.global.icu.util.UResourceBundle$RootType> r3 = ohos.global.icu.util.UResourceBundle.ROOT_CACHE
            r3.put(r2, r0)
        L_0x002e:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.util.UResourceBundle.getRootType(java.lang.String, java.lang.ClassLoader):ohos.global.icu.util.UResourceBundle$RootType");
    }
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ohos.global.icu.util.UResourceBundle$RootType[] r0 = ohos.global.icu.util.UResourceBundle.RootType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ohos.global.icu.util.UResourceBundle.AnonymousClass1.$SwitchMap$ohos$global$icu$util$UResourceBundle$RootType = r0
                int[] r0 = ohos.global.icu.util.UResourceBundle.AnonymousClass1.$SwitchMap$ohos$global$icu$util$UResourceBundle$RootType     // Catch:{ NoSuchFieldError -> 0x0014 }
                ohos.global.icu.util.UResourceBundle$RootType r1 = ohos.global.icu.util.UResourceBundle.RootType.ICU     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = ohos.global.icu.util.UResourceBundle.AnonymousClass1.$SwitchMap$ohos$global$icu$util$UResourceBundle$RootType     // Catch:{ NoSuchFieldError -> 0x001f }
                ohos.global.icu.util.UResourceBundle$RootType r1 = ohos.global.icu.util.UResourceBundle.RootType.JAVA     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = ohos.global.icu.util.UResourceBundle.AnonymousClass1.$SwitchMap$ohos$global$icu$util$UResourceBundle$RootType     // Catch:{ NoSuchFieldError -> 0x002a }
                ohos.global.icu.util.UResourceBundle$RootType r1 = ohos.global.icu.util.UResourceBundle.RootType.MISSING     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.util.UResourceBundle.AnonymousClass1.<clinit>():void");
        }
    }
