...
public class Currency extends MeasureUnit {
    ...
    private static final int[] POW10 = {1, 10, 100, 1000, JLogConstants.JLID_DISTRIBUTE_FILE_READ, 100000, A2dpCodecInfo.CODEC_PRIORITY_HIGHEST, 10000000, 100000000, 1000000000};
    ...
    static Currency createCurrency(ULocale uLocale) {
        return regionCurrencyCache.getInstance(ULocale.getRegionForSupplementalData(uLocale, false), null);
    }
    ...
    public String getName(ULocale uLocale, int i, boolean[] zArr) {
        ...
        if (i == 4) {
            return instance.getFormalSymbol(this.subType);
        }
        if (i == 5) {
            return instance.getVariantSymbol(this.subType);
        }
