...
public class MeasureUnit implements Serializable {
    ...
    public static final MeasureUnit BYTE = internalGetInstance("digital", SchemaSymbols.ATTVAL_BYTE);
    ...
    public static final TimeUnit HOUR = ((TimeUnit) internalGetInstance("duration", TimePickerAttrsConstants.HOUR));
    ...
    public static final TimeUnit MINUTE = ((TimeUnit) internalGetInstance("duration", TimePickerAttrsConstants.MINUTE));
    ...
    public static final MeasureUnit PERCENT = internalGetInstance("concentr", Constants.ATTRNAME_PERCENT);
    ...
    public static final TimeUnit SECOND = ((TimeUnit) internalGetInstance("duration", TimePickerAttrsConstants.SECOND));
    ...
    @Deprecated
    public static MeasureUnit[] parseCoreUnitIdentifier(String str) {
        MeasureUnit findBySubType = findBySubType(str);
        if (findBySubType != null) {
            return new MeasureUnit[]{findBySubType};
        }
        ...
        MeasureUnit findBySubType2 = findBySubType(substring);
        MeasureUnit findBySubType3 = findBySubType(substring2);
        if (findBySubType2 == null || findBySubType3 == null) {
            return null;
        }
        return new MeasureUnit[]{findBySubType2, findBySubType3};
    }
