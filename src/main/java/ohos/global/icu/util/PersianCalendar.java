...
public class PersianCalendar extends Calendar {
    private static final int[][] LIMITS = {new int[]{0, 0, 0, 0}, new int[]{-5000000, -5000000, 5000000, 5000000}, new int[]{0, 0, 11, 11}, new int[]{1, 1, 52, 53}, new int[0], new int[]{1, 1, 29, 31}, new int[]{1, 1, JLogConstants.JLID_APP_FRONZED_BEGIN, JLogConstants.JLID_APP_FRONZED_END}, new int[0], new int[]{-1, -1, 5, 5}, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[0]};
    private static final int[][] MONTH_COUNT = {new int[]{31, 31, 0}, new int[]{31, 31, 31}, new int[]{31, 31, 62}, new int[]{31, 31, 93}, new int[]{31, 31, 124}, new int[]{31, 31, 155}, new int[]{30, 30, 186}, new int[]{30, 30, 216}, new int[]{30, 30, 246}, new int[]{30, 30, 276}, new int[]{30, 30, 306}, new int[]{29, 30, JLogConstants.JLID_ACTIVITY_LAUNCHING_HANDLE}};
    ...
    public int handleGetYearLength(int i) {
        return isLeapYear(i) ? JLogConstants.JLID_APP_FRONZED_END : JLogConstants.JLID_APP_FRONZED_BEGIN;
    }
    ...
    public int handleComputeMonthStart(int i, int i2, boolean z) {
        ...
        int floorDivide = ((i - 1) * JLogConstants.JLID_APP_FRONZED_BEGIN) + 1948319 + floorDivide((i * 8) + 21, 33);
