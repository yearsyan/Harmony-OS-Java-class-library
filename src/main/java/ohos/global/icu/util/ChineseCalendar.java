...
public class ChineseCalendar extends Calendar {
    ...
    private static final int[][] LIMITS = {new int[]{1, 1, 83333, 83333}, new int[]{1, 1, 60, 60}, new int[]{0, 0, 11, 11}, new int[]{1, 1, 50, 55}, new int[0], new int[]{1, 1, 29, 30}, new int[]{1, 1, JLogConstants.JLID_SYSTEM_SERVICE_FROZEN, JLogConstants.JLID_TOUCH_RECORD_TIME}, new int[0], new int[]{-1, -1, 5, 5}, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[]{-5000000, -5000000, 5000000, 5000000}, new int[0], new int[0], new int[]{0, 0, 1, 1}};
    ...
    private final int millisToDays(long j) {
        return (int) floorDivide(j + ((long) this.zoneAstro.getOffset(j)), 86400000);
    }
