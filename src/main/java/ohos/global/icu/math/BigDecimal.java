...
public class BigDecimal extends Number implements Serializable, Comparable<BigDecimal> {
    ...
    public BigDecimal(char[] r17, int r18, int r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.math.BigDecimal.<init>(char[], int, int):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private ohos.global.icu.math.BigDecimal round(int r12, int r13) {
        /*
        // Method dump skipped, instructions count: 260
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.math.BigDecimal.round(int, int):ohos.global.icu.math.BigDecimal");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private ohos.global.icu.math.BigDecimal finish(ohos.global.icu.math.MathContext r8, boolean r9) {
        /*
        // Method dump skipped, instructions count: 233
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.math.BigDecimal.finish(ohos.global.icu.math.MathContext, boolean):ohos.global.icu.math.BigDecimal");
    }
}
