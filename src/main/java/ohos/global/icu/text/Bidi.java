...
public class Bidi {
    ...
    private void bracketProcessChar(ohos.global.icu.text.Bidi.BracketData r9, int r10) {
        /*
        // Method dump skipped, instructions count: 315
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.Bidi.bracketProcessChar(ohos.global.icu.text.Bidi$BracketData, int):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void processPropertySeq(ohos.global.icu.text.Bidi.LevState r12, short r13, int r14, int r15) {
        /*
        // Method dump skipped, instructions count: 476
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.Bidi.processPropertySeq(ohos.global.icu.text.Bidi$LevState, short, int, int):void");
    }
