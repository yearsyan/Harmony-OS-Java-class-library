...
public class UnicodeSet extends UnicodeFilter implements Iterable<String>, Comparable<UnicodeSet>, Freezable<UnicodeSet> {
    ...
    public String getRegexEquivalent() {
        ...
        for (String str : this.strings) {
            sb.append('|');
            _appendToPat((Appendable) sb, str, true);
        }
        sb.append(")");
        return sb.toString();
    }
    ...
    private void applyPattern(ohos.global.icu.impl.RuleCharacterIterator r27, ohos.global.icu.text.SymbolTable r28, java.lang.Appendable r29, int r30, int r31) {
        /*
        // Method dump skipped, instructions count: 960
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.UnicodeSet.applyPattern(ohos.global.icu.impl.RuleCharacterIterator, ohos.global.icu.text.SymbolTable, java.lang.Appendable, int, int):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private ohos.global.icu.text.UnicodeSet xor(int[] r7, int r8, int r9) {
        /*
        // Method dump skipped, instructions count: 102
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.UnicodeSet.xor(int[], int, int):ohos.global.icu.text.UnicodeSet");
    }
    ...
    public static class EntryRange {
        ...
        public String toString() {
            ...
            if (i == this.codepointEnd) {
                sb = (StringBuilder) UnicodeSet._appendToPat((Appendable) sb2, i, false);
            } else {
                StringBuilder sb3 = (StringBuilder) UnicodeSet._appendToPat((Appendable) sb2, i, false);
                sb3.append(LocaleUtility.IETF_SEPARATOR);
                sb = (StringBuilder) UnicodeSet._appendToPat((Appendable) sb3, this.codepointEnd, false);
            }
            return sb.toString();
        }
    }
