...
class RBBINode {
    ...
    static final String[] nodeTypeNames = {"setRef", "uset", "varRef", "leafChar", "lookAhead", PhotoItem.TAG, "endMark", "opStart", "opCat", "opOr", "opStar", "opPlus", "opQuestion", "opBreak", "opReverse", "opLParen"};
