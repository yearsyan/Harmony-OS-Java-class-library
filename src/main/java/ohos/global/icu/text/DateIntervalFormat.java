...
public class DateIntervalFormat extends UFormat {
    ...
    private synchronized java.lang.StringBuffer formatImpl(ohos.global.icu.util.Calendar r18, ohos.global.icu.util.Calendar r19, java.lang.StringBuffer r20, java.text.FieldPosition r21, ohos.global.icu.text.DateIntervalFormat.FormatOutput r22, java.util.List<java.text.FieldPosition> r23) {
        /*
        // Method dump skipped, instructions count: 343
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.DateIntervalFormat.formatImpl(ohos.global.icu.util.Calendar, ohos.global.icu.util.Calendar, java.lang.StringBuffer, java.text.FieldPosition, ohos.global.icu.text.DateIntervalFormat$FormatOutput, java.util.List):java.lang.StringBuffer");
    }
    ...
    private final StringBuffer fallbackFormat(Calendar calendar, Calendar calendar2, boolean z, StringBuffer stringBuffer, FieldPosition fieldPosition, FormatOutput formatOutput, List<FieldPosition> list) {
        ...
        if ((!z || this.fDatePattern == null || this.fTimePattern == null) ? false : true) {
            ...
            while (true) {
                long step = SimpleFormatterImpl.IterInternal.step(j, compileToStringMinMaxArguments, stringBuffer);
                if (step == -1) {
                    break;
                }
                if (SimpleFormatterImpl.IterInternal.getArgIndex(step) == 0) {
