...
public abstract class Collator implements Comparator<Object>, Freezable<Collator>, Cloneable {
    private static final String BASE = "ohos/global/icu/impl/data/icudt67b/coll";
    ...
    public static Locale[] getAvailableLocales() {
        ServiceShim serviceShim = shim;
        if (serviceShim == null) {
            return ICUResourceBundle.getAvailableLocales("ohos/global/icu/impl/data/icudt67b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
        }
    ...
    public static final ULocale[] getAvailableULocales() {
        ServiceShim serviceShim = shim;
        if (serviceShim == null) {
            return ICUResourceBundle.getAvailableULocales("ohos/global/icu/impl/data/icudt67b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
        }
    ...
    public static final String[] getKeywordValues(String str) {
        if (str.equals(KEYWORDS[0])) {
            return ICUResourceBundle.getKeywordValues("ohos/global/icu/impl/data/icudt67b/coll", RESOURCE);
        }
    ...
    public static final String[] getKeywordValuesForLocale(String str, ULocale uLocale, boolean z) {
        ...
        ((ICUResourceBundle) UResourceBundle.getBundleInstance("ohos/global/icu/impl/data/icudt67b/coll", uLocale)).getAllItemsWithFallback(RESOURCE, keywordsSink);
    ...
    public static final ULocale getFunctionalEquivalent(String str, ULocale uLocale, boolean[] zArr) {
        return ICUResourceBundle.getFunctionalEquivalent("ohos/global/icu/impl/data/icudt67b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER, RESOURCE, str, uLocale, zArr, true);
    }
