...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    private static final String[] DEF_DIGIT_STRINGS_ARRAY = {"0", "1", "2", "3", "4", "5", FetchResult.MEDIA_TYPE_ALBUM_LIST, FetchResult.MEDIA_TYPE_ALBUM_LIST_INFO, "8", "9"};
    ...
    private static final String[] SYMBOL_DEFAULTS = {String.valueOf((char) DEF_DECIMAL_SEPARATOR), String.valueOf(','), String.valueOf((char) DEF_PERCENT), String.valueOf('-'), String.valueOf((char) DEF_PLUS_SIGN), DateFormat.ABBR_WEEKDAY, String.valueOf((char) DEF_PERMILL), "∞", "NaN", null, null, "×"};
    ...
    public void setCurrency(Currency currency2) {
        ...
        } else if (!currency2.equals(this.currency)) {
            setCurrencyOrNull(currency2, CurrencyData.provider.getInstance(this.ulocale, true));
        }
    }

    private void setCurrencyOrNull(Currency currency2, CurrencyData.CurrencyDisplayInfo currencyDisplayInfo) {
        ...
        this.currencySymbol = currency2.getSymbol(this.ulocale);
        CurrencyData.CurrencyFormatInfo formatInfo = currencyDisplayInfo.getFormatInfo(currency2.getCurrencyCode());
        if (formatInfo != null) {
    ...
    private void initialize(ULocale uLocale, NumberingSystem numberingSystem) {
        ...
        this.padEscape = '*';
        this.sigDigit = '@';
        CurrencyData.CurrencyDisplayInfo instance2 = CurrencyData.provider.getInstance(this.ulocale, true);
        initSpacingInfo(instance2.getSpacingInfo());
        setCurrencyOrNull(Currency.getInstance(this.ulocale), instance2);
    }
