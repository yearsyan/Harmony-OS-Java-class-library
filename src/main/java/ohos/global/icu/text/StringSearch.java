...
public final class StringSearch extends SearchIterator {
    ...
    private boolean search(int r27, ohos.global.icu.text.StringSearch.Match r28) {
        /*
        // Method dump skipped, instructions count: 487
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.StringSearch.search(int, ohos.global.icu.text.StringSearch$Match):boolean");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean searchBackwards(int r20, ohos.global.icu.text.StringSearch.Match r21) {
        /*
        // Method dump skipped, instructions count: 448
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.StringSearch.searchBackwards(int, ohos.global.icu.text.StringSearch$Match):boolean");
    }
