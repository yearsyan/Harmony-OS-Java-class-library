...
public final class MessagePattern implements Cloneable, Freezable<MessagePattern> {
    ...
    private int parsePluralOrSelectStyle(ohos.global.icu.text.MessagePattern.ArgType r13, int r14, int r15) {
        /*
        // Method dump skipped, instructions count: 543
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.global.icu.text.MessagePattern.parsePluralOrSelectStyle(ohos.global.icu.text.MessagePattern$ArgType, int, int):int");
    }
