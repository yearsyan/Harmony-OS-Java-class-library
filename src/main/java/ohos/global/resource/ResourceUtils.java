...
public class ResourceUtils {
    ...
    public static Configuration convert(android.content.res.Configuration configuration) {
        ...
        if (i2 == 16) {
            configuration2.realColorMode = 1;
        } else if (i2 == 32) {
            configuration2.realColorMode = 0;
        } else {
            configuration2.realColorMode = -1;
        }
        Configuration.sysColorMode = configuration2.realColorMode;
    ...
    private static int getDeviceType() {
        char c;
        String lowerCase = Parameters.get("ro.build.characteristics", ContactItem.PHONE).toLowerCase();
        switch (lowerCase.hashCode()) {
            ...
            case 98260:
                ...
                break;
            case 106642798:
                if (lowerCase.equals(ContactItem.PHONE)) {
                    c = 3;
                    break;
                }
                c = 65535;
    ...
    public static int getDensity() {
        try {
            return Integer.parseInt(Parameters.get("hw.lcd.density", "160")) / 160;
