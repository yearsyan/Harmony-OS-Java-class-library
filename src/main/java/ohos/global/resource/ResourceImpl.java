...
public class ResourceImpl extends Resource {
    ...
    public ResourceImpl(Package r4, long j, OnlineTheme onlineTheme2, boolean z) {
        HiLog.debug(LABEL, "ResourceImpl Constructor", new Object[0]);
        this.handle = j;
        this.resPackage = r4;
        this.isSysResource = z;
        this.onlineTheme = onlineTheme2;
        getFileHandle();
    }
    ...
    private void getFileHandle() {
        ...
        try {
            ...
            if (this.onlineTheme != null) {
                Optional<InputStream> openFileStream = this.onlineTheme.openFileStream(substring, this.isSysResource);
                this.in = openFileStream.isPresent() ? openFileStream.get() : null;
            }
            if (this.in == null) {
    ...
    @Override // java.io.Closeable, java.lang.AutoCloseable, ohos.global.resource.Resource, java.io.InputStream
