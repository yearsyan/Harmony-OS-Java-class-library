    ...
    public Object[] validRestrictionOf(String str, XSAttributeGroupDecl xSAttributeGroupDecl) {
        for (int i = 0; i < this.fAttrUseNum; i++) {
            ...
            if (xSAttributeUseImpl2 == null) {
                ...
                } else if (!xSWildcardDecl.allowNamespace(xSAttributeDecl.fTargetNamespace)) {
        ...
        } else if (!xSWildcardDecl2.isSubsetOf(xSWildcardDecl3)) {
            return new Object[]{str, "derivation-ok-restriction.4.2"};
        } else if (!this.fAttributeWC.weakerProcessContents(xSAttributeGroupDecl.fAttributeWC)) {
            return null;
        } else {
