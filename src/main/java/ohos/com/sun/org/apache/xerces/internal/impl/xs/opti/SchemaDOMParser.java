...
public class SchemaDOMParser extends DefaultXMLDocumentHandler {
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.xni.XMLDocumentHandler, ohos.com.sun.org.apache.xerces.internal.impl.xs.opti.DefaultXMLDocumentHandler
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.xni.XMLDocumentHandler, ohos.com.sun.org.apache.xerces.internal.impl.xs.opti.DefaultXMLDocumentHandler, ohos.com.sun.org.apache.xerces.internal.xni.XMLDTDHandler
        ...
        if (this.fInnerAnnotationDepth == -1) {
            for (int i = xMLString.offset; i < xMLString.offset + xMLString.length; i++) {
                if (!XMLChar.isSpace(xMLString.ch[i])) {
                    String str = new String(xMLString.ch, i, (xMLString.length + xMLString.offset) - i);
                    this.fErrorReporter.reportError(this.fLocator, XSMessageFormatter.SCHEMA_DOMAIN, "s4s-elt-character", new Object[]{str}, (short) 1);
                    return;
                }
            }
            return;
