...
public final class XPointerHandler extends XIncludeHandler implements XPointerProcessor {
    ...
    private class Scanner {
                ...
                switch (b) {
                    ...
                    case 14:
                        if (i4 == 0) {
                            ...
                            if (scanNCName != i2) {
                                addToken(tokens, 3);
                                tokens.addToken((Tokens) addSymbol);
                                tokens.addToken((Tokens) str2);
                            ...
                            addToken(tokens, 4);
                            tokens.addToken((Tokens) addSymbol2);
        ...
        /* access modifiers changed from: protected */
        public void addToken(Tokens tokens, int i) throws XNIException {
            tokens.addToken((Tokens) i);
        }
    }

    @Override // ohos.com.sun.org.apache.xerces.internal.xinclude.XIncludeHandler, ohos.com.sun.org.apache.xerces.internal.xni.XMLDocumentHandler, ohos.com.sun.org.apache.xerces.internal.xni.XMLDTDHandler
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.xni.parser.XMLComponent, ohos.com.sun.org.apache.xerces.internal.xinclude.XIncludeHandler
