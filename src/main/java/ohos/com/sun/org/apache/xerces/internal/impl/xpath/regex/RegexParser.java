...
public class RegexParser {
    ...
    public final void next() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser.next():void");
    }
    ...
    public Token processModifiers() throws ParseException {
        ...
        if (i42 < this.regexlen) {
            if (c == '-') {
                ...
                int i62 = this.offset;
                if (i62 >= this.regexlen) {
                    throw ex("parser.factor.2", i62 - 1);
                }
            }
            if (c == ':') {
                this.offset++;
            ...
            throw ex("parser.factor.2", i42 - 1);
        }
    }
    ...
    public Token processBackreference() throws ParseException {
        ...
        if (this.parennumber > i2) {
            ...
            Token.StringToken createBackReference2 = Token.createBackReference(i2);
            this.hasBackReferences = true;
            if (this.references == null) {
                this.references = new Vector();
            }
    ...
    public ohos.com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken parseCharacterClass(boolean r17) throws ohos.com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser.parseCharacterClass(boolean):ohos.com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken");
    }
