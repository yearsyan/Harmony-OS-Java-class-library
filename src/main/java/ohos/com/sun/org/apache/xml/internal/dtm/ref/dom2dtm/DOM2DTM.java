    ...
    public boolean nextNode() {
        ...
        do {
            if (node.hasChildNodes()) {
                element2 = node.getFirstChild();
                if (element2 != null && 10 == element2.getNodeType()) {
        ...
        if (3 == nodeType || 4 == nodeType) {
            ...
            while (element4 != null) {
                if (3 == element4.getNodeType()) {
                    nodeType = 3;
                }
                z &= XMLCharacterRecognizer.isWhiteSpace(element4.getNodeValue());
                element3 = element4;
                element4 = logicalNextDOMTextNode(element4);
            }
            element = element3;
        } else {
        ...
        if (!z) {
            int addNode = addNode(element2, this.m_last_parent, this.m_last_kid, nodeType);
            ...
            if (1 == nodeType) {
                ...
                if (!this.m_processedFirstElement) {
                    i2 = addNode(new DOM2DTMdefaultNamespaceDeclarationNode(element2, "xml", "http://www.w3.org/XML/1998/namespace", makeNodeHandle((i2 == -1 ? addNode : i2) + 1)), addNode, i2, -1);
                    this.m_firstch.setElementAt(-1, i2);
                    this.m_processedFirstElement = true;
                }
                if (i2 != -1) {
