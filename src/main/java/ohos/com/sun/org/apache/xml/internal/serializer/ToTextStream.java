        ...
        while (i < i3) {
            ...
            if ('\n' == c && z) {
                ...
                if (writeUTF16Surrogate >= 0) {
                    ...
                    if (writeUTF16Surrogate > 0) {
                        String num = Integer.toString(writeUTF16Surrogate);
                        System.err.println(Utils.messages.createMessage("ER_ILLEGAL_CHARACTER", new Object[]{num, encoding}));
                    }
                }
                ...
                System.err.println(Utils.messages.createMessage("ER_ILLEGAL_CHARACTER", new Object[]{num2, encoding}));
            } else {
                writer.write(c);
            }
            i++;
