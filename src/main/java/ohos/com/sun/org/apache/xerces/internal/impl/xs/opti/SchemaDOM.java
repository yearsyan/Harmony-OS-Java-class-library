...
public class SchemaDOM extends DefaultDocument {
    ...
    public static void traverse(Node node, int i) {
        ...
        if (node.hasAttributes()) {
            ...
            for (int i2 = 0; i2 < attributes.getLength(); i2++) {
                ...
                printStream2.print("  " + ((Attr) attributes.item(i2)).getName() + "=\"" + ((Attr) attributes.item(i2)).getValue() + "\"");
            }
        }
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.impl.xs.opti.DefaultDocument, ohos.org.w3c.dom.Document
