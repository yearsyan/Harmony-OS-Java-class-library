...
public class DurationDV extends AbstractDateTimeDV {
    private static final AbstractDateTimeDV.DateTimeData[] DATETIMES = {new AbstractDateTimeDV.DateTimeData(1696, 9, 1, 0, 0, XPath.MATCH_SCORE_QNAME, 90, null, true, null), new AbstractDateTimeDV.DateTimeData(1697, 2, 1, 0, 0, XPath.MATCH_SCORE_QNAME, 90, null, true, null), new AbstractDateTimeDV.DateTimeData(SystemAbilityDefinition.BACKGROUND_TASK_MANAGER_SERVICE_ID, 3, 1, 0, 0, XPath.MATCH_SCORE_QNAME, 90, null, true, null), new AbstractDateTimeDV.DateTimeData(SystemAbilityDefinition.BACKGROUND_TASK_MANAGER_SERVICE_ID, 7, 1, 0, 0, XPath.MATCH_SCORE_QNAME, 90, null, true, null)};
