...
public class XML11Char {
    ...
    static {
        ...
        bArr3[32] = 35;
        Arrays.fill(bArr3, 33, 38, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        byte[] bArr4 = XML11CHARS;
        bArr4[38] = 1;
        Arrays.fill(bArr4, 39, 45, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 45, 47, (byte) -87);
        byte[] bArr5 = XML11CHARS;
        bArr5[47] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        Arrays.fill(bArr5, 48, 58, (byte) -87);
        byte[] bArr6 = XML11CHARS;
        bArr6[58] = 45;
        bArr6[59] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        bArr6[60] = 1;
        Arrays.fill(bArr6, 61, 65, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 65, 91, (byte) -19);
        Arrays.fill(XML11CHARS, 91, 93, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        byte[] bArr7 = XML11CHARS;
        bArr7[93] = 1;
        bArr7[94] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        bArr7[95] = -19;
        bArr7[96] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        Arrays.fill(bArr7, 97, 123, (byte) -19);
        Arrays.fill(XML11CHARS, 123, 127, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 127, 133, (byte) 17);
        byte[] bArr8 = XML11CHARS;
        bArr8[133] = 35;
        Arrays.fill(bArr8, 134, 160, (byte) 17);
        Arrays.fill(XML11CHARS, 160, 183, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        byte[] bArr9 = XML11CHARS;
        bArr9[183] = -87;
        Arrays.fill(bArr9, 184, 192, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 192, 215, (byte) -19);
        byte[] bArr10 = XML11CHARS;
        bArr10[215] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        Arrays.fill(bArr10, 216, 247, (byte) -19);
        byte[] bArr11 = XML11CHARS;
        bArr11[247] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        ...
        bArr12[894] = CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART;
        Arrays.fill(bArr12, 895, 8192, (byte) -19);
        Arrays.fill(XML11CHARS, 8192, 8204, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 8204, 8206, (byte) -19);
        Arrays.fill(XML11CHARS, 8206, 8232, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        byte[] bArr13 = XML11CHARS;
        bArr13[8232] = 35;
        Arrays.fill(bArr13, 8233, 8255, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 8255, 8257, (byte) -87);
        Arrays.fill(XML11CHARS, 8257, 8304, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 8304, 8592, (byte) -19);
        Arrays.fill(XML11CHARS, 8592, 11264, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 11264, 12272, (byte) -19);
        Arrays.fill(XML11CHARS, 12272, (int) UProperty.DOUBLE_LIMIT, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, (int) UProperty.DOUBLE_LIMIT, 55296, (byte) -19);
        Arrays.fill(XML11CHARS, 57344, 63744, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
        Arrays.fill(XML11CHARS, 63744, 64976, (byte) -19);
        Arrays.fill(XML11CHARS, 64976, 65008, (byte) CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
    ...
    public static boolean isXML11Content(int i) {
        return (i < 65536 && (XML11CHARS[i] & CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_BASE) != 0) || (65536 <= i && i <= 1114111);
    }
