...
public class DocumentImpl extends CoreDocumentImpl implements DocumentTraversal, DocumentEvent, DocumentRange {
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl, ohos.com.sun.org.apache.xerces.internal.dom.NodeImpl, ohos.com.sun.org.apache.xerces.internal.dom.ParentNode, ohos.com.sun.org.apache.xerces.internal.dom.ChildNode, ohos.org.w3c.dom.Node
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl, ohos.org.w3c.dom.Document
    ...
    @Override // ohos.org.w3c.dom.traversal.DocumentTraversal
    ...
    @Override // ohos.org.w3c.dom.ranges.DocumentRange
    ...
    @Override // ohos.org.w3c.dom.events.DocumentEvent
    ...
    public void dispatchAggregateEvents(NodeImpl nodeImpl, AttrImpl attrImpl, String str, short s) {
        ...
        if (LCount.lookup(MutationEventImpl.DOM_SUBTREE_MODIFIED).total > 0) {
            ...
            mutationEventImpl2.initMutationEvent(MutationEventImpl.DOM_SUBTREE_MODIFIED, true, false, null, null, null, null, 0);
            if (attrImpl != null) {
    ...
    public void modifiedCharacterData(NodeImpl nodeImpl, String str, String str2, boolean z) {
        if (this.mutationEvents && !z) {
            if (LCount.lookup(MutationEventImpl.DOM_CHARACTER_DATA_MODIFIED).total > 0) {
                MutationEventImpl mutationEventImpl = new MutationEventImpl();
                mutationEventImpl.initMutationEvent(MutationEventImpl.DOM_CHARACTER_DATA_MODIFIED, true, false, null, str, str2, null, 0);
