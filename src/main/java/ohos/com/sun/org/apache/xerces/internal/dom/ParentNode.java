...
public abstract class ParentNode extends ChildNode {
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.dom.NodeImpl, ohos.org.w3c.dom.Node, ohos.com.sun.org.apache.xerces.internal.dom.ChildNode
    ...
    public String getTextContent() throws DOMException {
        ...
        if (firstChild2.getNextSibling() != null) {
            ...
            return ((NodeImpl) firstChild2).getTextContent();
        } else {
            return "";
        }
    }
    ...
    public void getTextContent(StringBuffer stringBuffer) throws DOMException {
        for (Node firstChild2 = getFirstChild(); firstChild2 != null; firstChild2 = firstChild2.getNextSibling()) {
            if (hasTextContent(firstChild2)) {
                ((NodeImpl) firstChild2).getTextContent(stringBuffer);
            }
        }
    }
    ...
    @Override // ohos.com.sun.org.apache.xerces.internal.dom.NodeImpl, ohos.org.w3c.dom.NodeList
