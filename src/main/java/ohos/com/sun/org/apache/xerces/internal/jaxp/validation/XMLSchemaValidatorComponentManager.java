...
public final class XMLSchemaValidatorComponentManager extends ParserConfigurationSettings implements XMLComponentManager {
    ...
    public XMLSchemaValidatorComponentManager(XSGrammarPoolContainer xSGrammarPoolContainer) {
        ...
        boolean booleanValue = xSGrammarPoolContainer.getFeature("http://ohos.javax.xml.XMLConstants/feature/secure-processing").booleanValue();
    ...
    public FeatureState getFeatureState(String str) throws XMLConfigurationException {
        ...
        if ("http://ohos.javax.xml.XMLConstants/feature/secure-processing".equals(str)) {
    ...
    public void setFeature(String str, boolean z) throws XMLConfigurationException {
        if ("http://apache.org/xml/features/internal/parser-settings".equals(str)) {
            ...
            throw new XMLConfigurationException(Status.NOT_SUPPORTED, str);
        } else if (!"http://ohos.javax.xml.XMLConstants/feature/secure-processing".equals(str)) {
            this.fConfigUpdated = true;
            ...
            throw new XMLConfigurationException(Status.NOT_ALLOWED, "http://ohos.javax.xml.XMLConstants/feature/secure-processing");
        }
    }
