...
public final class XMLSecurityManager {
    ...
    public enum Limit {
        ...
        ELEMENT_ATTRIBUTE_LIMIT("ElementAttributeLimit", "http://www.oracle.com/xml/jaxp/properties/elementAttributeLimit", "jdk.xml.elementAttributeLimit", 0, JLogConstants.JLID_DISTRIBUTE_FILE_READ),
    ...
    public XMLSecurityManager(boolean z) {
        this.indexEntityCountInfo = JLogConstants.JLID_DISTRIBUTE_FILE_READ;
    ...
    public void setLimit(int i, State state, int i2) {
        ...
        } else if (state.compareTo((Enum) this.states[i]) >= 0) {
            this.values[i] = i2;
            this.states[i] = state;
            this.isSet[i] = true;
        }
    ...
    public int getIndex(String str) {
        ...
        if (str.equals("http://www.oracle.com/xml/jaxp/properties/getEntityCountInfo")) {
            return JLogConstants.JLID_DISTRIBUTE_FILE_READ;
        }
        return -1;
    }
