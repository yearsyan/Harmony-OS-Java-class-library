...
public class XPathParser {
    ...
    public boolean FunctionCall() throws TransformerException {
        ...
        while (!tokenIs(')') && this.m_token != null) {
            if (tokenIs(TelephoneNumberUtils.PAUSE)) {
                error("ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG", null);
            }
            Argument();
            if (!tokenIs(')')) {
                consumeExpected(TelephoneNumberUtils.PAUSE);
                if (tokenIs(')')) {
    ...
    public void LocationPathPattern() throws ohos.javax.xml.transform.TransformerException {
        /*
        // Method dump skipped, instructions count: 209
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xpath.internal.compiler.XPathParser.LocationPathPattern():void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean AbbreviatedNodeTestStep(boolean r11) throws ohos.javax.xml.transform.TransformerException {
        /*
        // Method dump skipped, instructions count: 199
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xpath.internal.compiler.XPathParser.AbbreviatedNodeTestStep(boolean):boolean");
    }
}
