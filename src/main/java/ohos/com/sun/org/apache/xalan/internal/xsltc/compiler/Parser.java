    ...
    private SyntaxTreeNode getStylesheet(SyntaxTreeNode syntaxTreeNode) throws CompilerException {
        ...
        if (str == null) {
            ...
            try {
                ...
                String checkAccess = SecuritySupport.checkAccess(SystemIDResolver.getAbsoluteURI(str2), (String) this._xsltc.getProperty(XMLConstants.ACCESS_EXTERNAL_STYLESHEET), "all");
                if (checkAccess == null) {
