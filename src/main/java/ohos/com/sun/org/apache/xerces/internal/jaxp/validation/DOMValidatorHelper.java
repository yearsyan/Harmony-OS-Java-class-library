...
public final class DOMValidatorHelper implements ValidatorHelper, EntityState {
    ...
    public boolean isEntityUnparsed(String str) {
        ...
        if (namedNodeMap == null || (entity = (Entity) namedNodeMap.getNamedItem(str)) == null || entity.getNotationName() == null) {
            return false;
        }
        return true;
    }
    ...
    private void validate(ohos.org.w3c.dom.Node r3) {
        /*
            r2 = this;
            r0 = r3
        L_0x0001:
        ...
        L_0x0029:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xerces.internal.jaxp.validation.DOMValidatorHelper.validate(ohos.org.w3c.dom.Node):void");
    }
    ...
    private void setupDOMResultHandler(DOMSource dOMSource, DOMResult dOMResult) throws SAXException {
        ...
        if (dOMResult.getNode() == null) {
            try {
                dOMResult.setNode(JdkXmlUtils.getDOMFactory(this.fComponentManager.getFeature(JdkXmlUtils.OVERRIDE_PARSER)).newDocumentBuilder().newDocument());
