...
public class XSDComplexTypeTraverser extends XSDAbstractParticleTraverser {
    ...
    private void traverseSimpleContent(Element element, XSDocumentInfo xSDocumentInfo, SchemaGrammar schemaGrammar) throws ComplexTypeRecoverableError {
        ...
        if (element2 != null) {
            ...
            if (nextSiblingElement == null) {
                Object[] checkAttributes2 = this.fAttrChecker.checkAttributes(element2, false, xSDocumentInfo);
                    ...
                    if (xSTypeDefinition != null) {
                        ...
                        if (xSTypeDefinition.getTypeCategory() == 15) {
                            ...
                            if (this.fDerivedBy != 2) {
                                ...
                                this.fAttrChecker.returnAttrArray(checkAttributes, xSDocumentInfo);
                                this.fAttrChecker.returnAttrArray(checkAttributes2, xSDocumentInfo);
                                throw new ComplexTypeRecoverableError("src-ct.2.1", new Object[]{this.fName, xSSimpleType4.getName()}, element2);
                            }
                        }
                        ...
                        if (firstChildElement2 != null) {
                            ...
                            if (element6 == null || !DOMUtil.getLocalName(element6).equals(SchemaSymbols.ELT_ANNOTATION)) {
                                element3 = element6;
                            } else {
                                this.fAttrChecker.returnAttrArray(checkAttributes, xSDocumentInfo);
                                this.fAttrChecker.returnAttrArray(checkAttributes2, xSDocumentInfo);
                                throw new ComplexTypeRecoverableError("s4s-elt-invalid-content.1", new Object[]{this.fName, SchemaSymbols.ELT_ANNOTATION}, element6);
                            }
                        } else {
                            xSSimpleType2 = xSSimpleType;
                        ...
                        if (this.fDerivedBy == 2) {
                            if (element3 == null || !DOMUtil.getLocalName(element3).equals(SchemaSymbols.ELT_SIMPLETYPE)) {
                                ...
                                xSSimpleType3 = this.fSchemaHandler.fSimpleTypeTraverser.traverseLocal(element3, xSDocumentInfo, schemaGrammar);
                                if (xSSimpleType3 == null) {
                                    ...
                                    this.fAttrChecker.returnAttrArray(checkAttributes, xSDocumentInfo);
                                    this.fAttrChecker.returnAttrArray(checkAttributes2, xSDocumentInfo);
                                    throw new ComplexTypeRecoverableError("derivation-ok-restriction.5.2.2.1", new Object[]{this.fName, xSSimpleType3.getName(), xSSimpleType2.getName()}, element3);
                                }
                            }
                            if (xSSimpleType3 != null) {
                                if (element3 != null) {
                                    XSDAbstractTraverser.FacetInfo traverseFacets = traverseFacets(element3, xSSimpleType3, xSDocumentInfo);
                                    element4 = traverseFacets.nodeAfterFacets;
                                ...
                                try {
                                    ...
                                    reportSchemaError(e.getKey(), e.getArgs(), element3);
                                    this.fXSSimpleType = this.fSchemaHandler.fDVFactory.createTypeRestriction(genAnonTypeName, xSDocumentInfo.fTargetNamespace, 0, xSSimpleType3, null);
                                }
                                ...
                                if (element4 == null) {
                                    element5 = element4;
                                } else if (isAttrOrAttrGroup(element4)) {
                                    element5 = element4;
                                    Element traverseAttrsAndAttrGrps = traverseAttrsAndAttrGrps(element4, this.fAttrGrp, xSDocumentInfo, schemaGrammar, this.fComplexTypeDecl);
                                ...
                                try {
                                    ...
                                    if (validRestrictionOf != null) {
                                        this.fAttrChecker.returnAttrArray(checkAttributes, xSDocumentInfo);
                                        this.fAttrChecker.returnAttrArray(checkAttributes2, xSDocumentInfo);
                                        throw new ComplexTypeRecoverableError((String) validRestrictionOf[validRestrictionOf.length - 1], validRestrictionOf, element5);
                                    }
                                ...
                                this.fAttrChecker.returnAttrArray(checkAttributes, xSDocumentInfo);
                                this.fAttrChecker.returnAttrArray(checkAttributes2, xSDocumentInfo);
                                throw new ComplexTypeRecoverableError("src-ct.2.2", new Object[]{this.fName}, element3);
                            }
                        } else {
    ...
    private void processComplexContent(ohos.org.w3c.dom.Element r14, boolean r15, boolean r16, ohos.com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDocumentInfo r17, ohos.com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar r18) throws ohos.com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDComplexTypeTraverser.ComplexTypeRecoverableError {
        /*
        // Method dump skipped, instructions count: 301
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDComplexTypeTraverser.processComplexContent(ohos.org.w3c.dom.Element, boolean, boolean, ohos.com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDocumentInfo, ohos.com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar):void");
    }
