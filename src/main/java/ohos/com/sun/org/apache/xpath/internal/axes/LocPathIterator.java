...
public abstract class LocPathIterator extends PredicatedNodeTest implements Cloneable, DTMIterator, Serializable, PathComponent {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x0017 A[LOOP:1: B:9:0x0017->B:12:0x0021, LOOP_START] */
    @Override // ohos.com.sun.org.apache.xml.internal.dtm.DTMIterator
    ...
    public void runTo(int r3) {
        ...
        L_0x0023:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xpath.internal.axes.LocPathIterator.runTo(int):void");
    }
