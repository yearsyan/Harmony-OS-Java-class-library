...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
    ...
    @Override // ohos.javax.xml.transform.sax.TransformerHandler
        ...
        if (this._result != null) {
            if (!this._isIdentity) {
                ...
                try {
                    ...
                    this._lexHandler = (LexicalHandler) contentHandler;
                    this._dtdHandler = (DTDHandler) contentHandler;
                    this._declHandler = (DeclHandler) contentHandler;
