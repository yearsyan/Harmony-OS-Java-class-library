...
public class XMLChar {
    ...
    static {
        ...
        int[] iArr11 = {48, 57, 1632, 1641, 1776, 1785, 2406, 2415, 2534, 2543, 2662, 2671, 2790, 2799, GLES1X.GL_FOG_COLOR, 2927, 3047, 3055, 3174, 3183, SystemAbilityDefinition.POWER_MANAGER_BATT_SERVICE_ID, 3311, 3430, 3439, 3664, 3673, 3792, 3801, 3872, 3881};
        ...
        while (i < iArr.length) {
            ...
            while (i2 <= iArr[i + 1]) {
                byte[] bArr = CHARS;
                bArr[i2] = (byte) (bArr[i2] | CameraMetadataEx.HUAWEI_EXT_SCENE_MODE_SMART);
                i2++;
                iArr6 = iArr6;
                iArr = iArr;
            }
