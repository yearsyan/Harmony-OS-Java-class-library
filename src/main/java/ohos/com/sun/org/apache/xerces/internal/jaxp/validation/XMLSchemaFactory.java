...
public final class XMLSchemaFactory extends SchemaFactory {
    ...
    @Override // ohos.javax.xml.validation.SchemaFactory
    ...
    private void propagateFeatures(AbstractXMLSchema abstractXMLSchema) {
        XMLSecurityManager xMLSecurityManager = this.fSecurityManager;
        abstractXMLSchema.setFeature("http://ohos.javax.xml.XMLConstants/feature/secure-processing", xMLSecurityManager != null && xMLSecurityManager.isSecureProcessing());
        abstractXMLSchema.setFeature(JdkXmlUtils.OVERRIDE_PARSER, this.fOverrideDefaultParser);
