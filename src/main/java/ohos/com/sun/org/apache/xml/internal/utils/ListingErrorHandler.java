...
public class ListingErrorHandler implements ErrorHandler, ErrorListener {
    ...
    public static void logExceptionLocation(PrintWriter printWriter, Throwable th) {
        ...
        if (sourceLocator != null) {
            if (sourceLocator.getPublicId() != sourceLocator.getPublicId()) {
                str = sourceLocator.getPublicId();
            } else {
                str = sourceLocator.getSystemId() != null ? sourceLocator.getSystemId() : "SystemId-Unknown";
            }
            printWriter.print(str + ":Line=" + sourceLocator.getLineNumber() + ";Column=" + sourceLocator.getColumnNumber() + ": ");
