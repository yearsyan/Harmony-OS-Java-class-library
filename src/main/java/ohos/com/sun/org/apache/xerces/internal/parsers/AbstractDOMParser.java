...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
        ...
        if (this.fDeferNodeExpansion) {
            ...
            if (this.fDocumentImpl != null) {
                ...
                if (documentType != null) {
                    this.fCurrentEntityDecl = (EntityImpl) documentType.getEntities().getNamedItem(str);
    ...
    public void startElement(QName qName, XMLAttributes xMLAttributes, Augmentations augmentations) throws XNIException {
        ...
        if (this.fDeferNodeExpansion) {
            ...
            if (!(augmentations == null || (elementPSVI = (ElementPSVI) augmentations.getItem(Constants.ELEMENT_PSVI)) == null || !this.fNamespaceAware)) {
                ...
                ((ElementNSImpl) createElementNode).setType(memberTypeDefinition3);
            }
            LSParserFilter lSParserFilter = this.fDOMFilter;
        ...
        if (!this.fDeferNodeExpansion) {
            if (!this.fFilterReject) {
                if (this.fInCDATASection && this.fCreateCDATANodes) {
                    ...
                    if (this.fFirstChunk) {
                        if (this.fDocumentImpl != null) {
                            this.fStringBuilder.append(((TextImpl) lastChild).removeData());
                        } else {
    ...
    public void endGeneralEntity(java.lang.String r8, ohos.com.sun.org.apache.xerces.internal.xni.Augmentations r9) throws ohos.com.sun.org.apache.xerces.internal.xni.XNIException {
        /*
        // Method dump skipped, instructions count: 427
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xerces.internal.parsers.AbstractDOMParser.endGeneralEntity(java.lang.String, ohos.com.sun.org.apache.xerces.internal.xni.Augmentations):void");
    }
    ...
    public final void handleBaseURI(Node node) {
        ...
        if (this.fDocumentImpl != null) {
            ...
            } else if (nodeType == 7 && (baseURI = ((EntityReferenceImpl) this.fCurrentNode).getBaseURI()) != null && this.fErrorHandler != null) {
    ...
    public void endDTD(Augmentations augmentations) throws XNIException {
        ...
        if (this.fDeferNodeExpansion) {
            ...
            ((DocumentTypeImpl) this.fDocumentType).setInternalSubset(sb2);
        }
    }
