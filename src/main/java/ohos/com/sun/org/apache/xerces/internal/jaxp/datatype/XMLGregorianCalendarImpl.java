...
public class XMLGregorianCalendarImpl extends XMLGregorianCalendar implements Serializable, Cloneable {
    ...
    @Override // ohos.javax.xml.datatype.XMLGregorianCalendar
    public void reset() {
    }
    ...
    public int compare(XMLGregorianCalendar xMLGregorianCalendar) {
        ...
        if (xMLGregorianCalendarImpl.getTimezone() != Integer.MIN_VALUE) {
            ...
            int internalCompare = internalCompare(xMLGregorianCalendarImpl, xMLGregorianCalendarImpl2.normalizeToTimezone(DatatypeConstants.MIN_TIMEZONE_OFFSET));
            if (internalCompare == -1) {
                return internalCompare;
            }
            int internalCompare2 = internalCompare(xMLGregorianCalendarImpl, xMLGregorianCalendarImpl2.normalizeToTimezone(DatatypeConstants.MAX_TIMEZONE_OFFSET));
        ...
        if (xMLGregorianCalendarImpl2.getTimezone() != 0) {
            xMLGregorianCalendarImpl2 = (XMLGregorianCalendarImpl) xMLGregorianCalendarImpl2.normalizeToTimezone(xMLGregorianCalendarImpl2.getTimezone());
        }
        int internalCompare3 = internalCompare(xMLGregorianCalendarImpl.normalizeToTimezone(DatatypeConstants.MAX_TIMEZONE_OFFSET), xMLGregorianCalendarImpl2);
        if (internalCompare3 == -1) {
            return internalCompare3;
        }
        int internalCompare4 = internalCompare(xMLGregorianCalendarImpl.normalizeToTimezone(DatatypeConstants.MIN_TIMEZONE_OFFSET), xMLGregorianCalendarImpl2);
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [ohos.com.sun.org.apache.xerces.internal.jaxp.datatype.XMLGregorianCalendarImpl] */
    /* JADX WARN: Type inference failed for: r2v1, types: [ohos.javax.xml.datatype.XMLGregorianCalendar] */
    /* JADX WARN: Type inference failed for: r2v3, types: [ohos.javax.xml.datatype.XMLGregorianCalendar] */
    @Override // ohos.javax.xml.datatype.XMLGregorianCalendar
    public int hashCode() {
        ...
        while (true) {
            if (add5.compareTo(BigInteger.ONE) >= 0) {
                ...
                if (this.month >= 2) {
                    ...
                    bigInteger2 = BigInteger.valueOf((long) maximumDayInMonthFor(getEonAndYear().subtract(BigInteger.valueOf(1)), 12));
                }
    ...
    @Override // ohos.javax.xml.datatype.XMLGregorianCalendar, java.lang.Object
    public Object clone() {
