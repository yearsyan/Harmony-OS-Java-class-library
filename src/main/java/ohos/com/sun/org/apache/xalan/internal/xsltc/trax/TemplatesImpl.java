...
public final class TemplatesImpl implements Templates, Serializable {
    ...
    private synchronized java.lang.Class[] getTransletClasses() {
        /*
            r1 = this;
            monitor-enter(r1)
            java.lang.Class[] r0 = r1._class     // Catch:{ TransformerConfigurationException -> 0x000b }
            if (r0 != 0) goto L_0x000b
            r1.defineTransletClasses()     // Catch:{ TransformerConfigurationException -> 0x000b }
            goto L_0x000b
        L_0x0009:
            r0 = move-exception
            goto L_0x000f
        L_0x000b:
            java.lang.Class[] r0 = r1._class     // Catch:{ all -> 0x0009 }
            monitor-exit(r1)
            return r0
        L_0x000f:
            monitor-exit(r1)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl.getTransletClasses():java.lang.Class[]");
    }
    ...
    public synchronized int getTransletIndex() {
        ...
        L_0x0009:
            ...
            goto L_0x000f
        L_0x000b:
            int r0 = r1._transletIndex     // Catch:{ all -> 0x0009 }
            monitor-exit(r1)
            return r0
        L_0x000f:
            monitor-exit(r1)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl.getTransletIndex():int");
    }
    ...
    @Override // ohos.javax.xml.transform.Templates
    public synchronized Transformer newTransformer() throws TransformerConfigurationException {
        ...
        if (this._tfactory.getFeature("http://ohos.javax.xml.XMLConstants/feature/secure-processing")) {
    ...
    public synchronized java.util.Properties getOutputProperties() {
        /*
            r1 = this;
            monitor-enter(r1)
            ohos.javax.xml.transform.Transformer r0 = r1.newTransformer()     // Catch:{ TransformerConfigurationException -> 0x000e, all -> 0x000b }
            java.util.Properties r0 = r0.getOutputProperties()     // Catch:{ TransformerConfigurationException -> 0x000e, all -> 0x000b }
            monitor-exit(r1)
            return r0
        L_0x000b:
            r0 = move-exception
        ...
        L_0x000e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl.getOutputProperties():java.util.Properties");
    }
