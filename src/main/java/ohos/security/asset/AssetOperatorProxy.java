...
public class AssetOperatorProxy implements IAssetOper {
    ...
    public AssetResult assetInsert(Ability ability, IntentParams intentParams) {
        ...
        Optional<Context> convertAbilityToContext = convertAbilityToContext(ability);
        Optional<Bundle> convertIntentParamsToBundle = convertIntentParamsToBundle(intentParams.getParams());
        if (!convertAbilityToContext.isPresent() || !convertIntentParamsToBundle.isPresent()) {
            return new AssetResult(-1);
        }
        HwAssetManager.AssetResult assetInsert = HwAssetManager.getInstance().assetInsert(convertAbilityToContext.get(), convertIntentParamsToBundle.get());
    ...
    public AssetResult assetDelete(Ability ability, IntentParams intentParams) {
        ...
        HwAssetManager.AssetResult assetDelete = HwAssetManager.getInstance().assetDelete(convertAbilityToContext.get(), convertIntentParamsToBundle.get());
    ...
    public AssetResult assetUpdate(Ability ability, IntentParams intentParams) {
        ...
        HwAssetManager.AssetResult assetUpdate = HwAssetManager.getInstance().assetUpdate(convertAbilityToContext.get(), convertIntentParamsToBundle.get());
    ...
    public AssetResult assetSelect(Ability ability, IntentParams intentParams) {
        ...
        HwAssetManager.AssetResult assetSelect = HwAssetManager.getInstance().assetSelect(convertAbilityToContext.get(), convertIntentParamsToBundle.get());
        return new AssetResult(assetSelect.resultCode, assetSelect.resultInfo, assetSelect.resultNumber);
    }

    @Override // ohos.security.asset.IAssetOper
    public AssetResult assetInsert(IntentParams intentParams) {
        ...
        HwAssetManager.AssetResult assetInsert = HwAssetManager.getInstance().assetInsert((Context) null, convertIntentParamsToBundle.get());
        return new AssetResult(assetInsert.resultCode, assetInsert.resultInfo, assetInsert.resultNumber);
    }

    @Override // ohos.security.asset.IAssetOper
    public AssetResult assetDelete(IntentParams intentParams) {
        if (intentParams == null) {
            return new AssetResult(-1);
        }
        Optional<Bundle> convertIntentParamsToBundle = convertIntentParamsToBundle(intentParams.getParams());
        ...
        HwAssetManager.AssetResult assetDelete = HwAssetManager.getInstance().assetDelete((Context) null, convertIntentParamsToBundle.get());
        return new AssetResult(assetDelete.resultCode, assetDelete.resultInfo, assetDelete.resultNumber);
    }

    @Override // ohos.security.asset.IAssetOper
    public AssetResult assetUpdate(IntentParams intentParams) {
        if (intentParams == null) {
            return new AssetResult(-1);
        }
        Optional<Bundle> convertIntentParamsToBundle = convertIntentParamsToBundle(intentParams.getParams());
        ...
        HwAssetManager.AssetResult assetUpdate = HwAssetManager.getInstance().assetUpdate((Context) null, convertIntentParamsToBundle.get());
        return new AssetResult(assetUpdate.resultCode, assetUpdate.resultInfo, assetUpdate.resultNumber);
    }

    @Override // ohos.security.asset.IAssetOper
    public AssetResult assetSelect(IntentParams intentParams) {
        if (intentParams == null) {
            return new AssetResult(-1);
        }
        Optional<Bundle> convertIntentParamsToBundle = convertIntentParamsToBundle(intentParams.getParams());
        ...
        HwAssetManager.AssetResult assetSelect = HwAssetManager.getInstance().assetSelect((Context) null, convertIntentParamsToBundle.get());
        return new AssetResult(assetSelect.resultCode, assetSelect.resultInfo, assetSelect.resultNumber);
    }
}
