...
public class AssetOperator {
    ...
    private static class AssetOperatorSingleton extends AssetOperatorAbs {
        ...
        public AssetResult assetInsert(IntentParams intentParams) {
            return this.proxy.assetInsert(intentParams);
        }

        @Override // ohos.security.asset.AssetOperatorAbs
        public AssetResult assetDelete(IntentParams intentParams) {
            return this.proxy.assetDelete(intentParams);
        }

        @Override // ohos.security.asset.AssetOperatorAbs
        public AssetResult assetUpdate(IntentParams intentParams) {
            return this.proxy.assetUpdate(intentParams);
        }

        @Override // ohos.security.asset.AssetOperatorAbs
        public AssetResult assetSelect(IntentParams intentParams) {
            return this.proxy.assetSelect(intentParams);
        }
    }
}
