...
public final class PermissionKitInner {
    ...
    private static final String TAG = "PermissionKitInner";
    ...
    public boolean canRequestPermission(String str, String str2, int i) {
        try {
            return this.mPermissionKitInnerProxy.canRequestPermission(PermissionConversion.getAosPermissionNameIfPossible(str), str2, i);
