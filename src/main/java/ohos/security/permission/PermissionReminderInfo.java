...
public class PermissionReminderInfo implements Sequenceable {
    ...
    public String toString() {
        return "PermissionReminderInfo{', deviceLabel='" + this.deviceLabel + PatternTokenizer.SINGLE_QUOTE + ", bundleName='" + this.bundleName + PatternTokenizer.SINGLE_QUOTE + ", bundleLabel='" + this.bundleLabel + PatternTokenizer.SINGLE_QUOTE + ", permName='" + this.permName + PatternTokenizer.SINGLE_QUOTE + '}';
    }
}
