...
public class AVBrowserServiceAdapter implements IAVBrowserService {
    ...
    static class Wrapper extends MediaBrowserService {
        ...
        public MediaBrowserService.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            AVBrowserRoot onGetRoot = this.browserDelegate.onGetRoot(str, i, AVUtils.convert2PacMap(bundle));
            if (onGetRoot != null) {
                return AVConverter.convertBrowserRoot(onGetRoot);
            }
            AVBrowserServiceAdapter.LOGGER.error("AVBrowserRoot is null", new Object[0]);
            return null;
        }
