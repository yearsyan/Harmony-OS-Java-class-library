...
public class AVSessionAdapter {
    public static final String ACTION_MEDIA_BUTTON = "ohos.intent.action.MEDIA_BUTTON";
    ...
    public static final String PARAM_KEY_EVENT = "ohos.intent.param.KEY_EVENT";
    ...
    public static GeneralReceiver convert2GeneralReceiver(final ResultReceiver resultReceiver) {
        if (resultReceiver != null) {
            return new GeneralReceiver() {
                ...
                @Override // ohos.app.GeneralReceiver
    ...
    private class MediaSessionCallback extends MediaSession.Callback {
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            if (this.avCallback == null) {
                ...
                intent2.setAction("ohos.intent.action.MEDIA_BUTTON");
                ...
                intent2.setParam("ohos.intent.param.KEY_EVENT", keyEvent2);
