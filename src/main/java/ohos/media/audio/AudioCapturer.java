...
public class AudioCapturer {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ohos.media.audio.AudioStreamInfo$EncodingFormat[] r0 = ohos.media.audio.AudioStreamInfo.EncodingFormat.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ohos.media.audio.AudioCapturer.AnonymousClass1.$SwitchMap$ohos$media$audio$AudioStreamInfo$EncodingFormat = r0
                int[] r0 = ohos.media.audio.AudioCapturer.AnonymousClass1.$SwitchMap$ohos$media$audio$AudioStreamInfo$EncodingFormat     // Catch:{ NoSuchFieldError -> 0x0014 }
                ohos.media.audio.AudioStreamInfo$EncodingFormat r1 = ohos.media.audio.AudioStreamInfo.EncodingFormat.ENCODING_PCM_16BIT     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = ohos.media.audio.AudioCapturer.AnonymousClass1.$SwitchMap$ohos$media$audio$AudioStreamInfo$EncodingFormat     // Catch:{ NoSuchFieldError -> 0x001f }
                ohos.media.audio.AudioStreamInfo$EncodingFormat r1 = ohos.media.audio.AudioStreamInfo.EncodingFormat.ENCODING_PCM_8BIT     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = ohos.media.audio.AudioCapturer.AnonymousClass1.$SwitchMap$ohos$media$audio$AudioStreamInfo$EncodingFormat     // Catch:{ NoSuchFieldError -> 0x002a }
                ohos.media.audio.AudioStreamInfo$EncodingFormat r1 = ohos.media.audio.AudioStreamInfo.EncodingFormat.ENCODING_PCM_FLOAT     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ohos.media.audio.AudioCapturer.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    private boolean setInputDevice(AudioDeviceDescriptor audioDeviceDescriptor) {
        ...
        if (nativeSetInputDevice) {
            ...
            LOGGER.info("setInputDevice success.", new Object[0]);
        }
    ...
    public AudioDeviceDescriptor getCurrentDevice() {
        ...
        LOGGER.error("No device found.", new Object[0]);
        return null;
    }
