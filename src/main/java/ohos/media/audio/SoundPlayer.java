...
public class SoundPlayer {
    ...
    public final boolean createSound(ToneDescriptor.ToneType toneType, int i) {
        ...
        if (toneDescriptor.getHighFrequency() == XPath.MATCH_SCORE_QNAME) {
    ...
    public final int createSound(ohos.app.Context r5, int r6) {
        /*
        // Method dump skipped, instructions count: 151
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.media.audio.SoundPlayer.createSound(ohos.app.Context, int):int");
    }
