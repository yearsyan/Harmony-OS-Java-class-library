            ...
            if (codecDescription.isEncoder() == z) {
                if (z2) {
                    try {
                        ...
                        LOGGER.error("getCodecDescriptionByFormat IllegalArgumentException!", new Object[0]);
                    }
                }
        ...
        for (CodecDescriptionInternal codecDescriptionInternal : this.mCodecDescriptionInternalList) {
            if (codecDescriptionInternal.isEncoder() == z) {
                try {
                    ...
                    LOGGER.error("getCodecByFormat IllegalArgumentException!", new Object[0]);
                }
            }
        }
        return null;
        ...
        for (CodecDescriptionInternal codecDescriptionInternal : normalList) {
            if (codecDescriptionInternal.isEncoder() == z) {
                try {
                    ...
                    LOGGER.error("isCodecSupportedByFormat IllegalArgumentException!", new Object[0]);
                }
            }
        }
        return false;
