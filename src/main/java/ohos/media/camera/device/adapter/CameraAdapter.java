...
public class CameraAdapter implements ICamera, IBinder.DeathRecipient {
    ...
    public ohos.media.camera.zidl.CaptureTriggerInfo captureFrames(java.util.List<ohos.media.camera.zidl.FrameConfigNative> r13, boolean r14) throws ohos.media.camera.exception.AccessException {
        /*
        // Method dump skipped, instructions count: 301
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.media.camera.device.adapter.CameraAdapter.captureFrames(java.util.List, boolean):ohos.media.camera.zidl.CaptureTriggerInfo");
    }
