...
public class CameraInfoImpl implements CameraInfo {
    ...
    public String toString() {
        return "CameraInfoImpl{" + String.format("cameraId='%s', ", this.cameraId) + String.format("facingType=%d, ", Integer.valueOf(this.facingType)) + String.format("physicalIds=%s, ", this.physicalCameraIdAvailabilityMap.keySet()) + String.format("linkTypes=%s", this.physicalCameraLinkTypeMap.values()) + "}";
    }
}
