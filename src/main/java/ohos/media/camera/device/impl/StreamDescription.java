...
public class StreamDescription {
    ...
    public boolean equals(Object obj) {
        ...
        return this.surface.equals(streamDescription.surface) && this.size.equals(streamDescription.size) && this.isDeferred == streamDescription.isDeferred && this.surfaceType == streamDescription.surfaceType;
    }

    public int hashCode() {
        return Objects.hash(this.surface, this.size, Boolean.valueOf(this.isDeferred), Integer.valueOf(this.surfaceType));
    }
}
