...
public final class StreamAction {
    ...
    public void stopLoopingCapture() throws AccessException {
        ...
        long cancelCaptureFrames = this.cameraDevice.cancelCaptureFrames(this.currentLoopingCaptureTriggerId);
        LOGGER.debug("stopLoppingCapture lastFrameNumber: %{public}d", Long.valueOf(cancelCaptureFrames));
    ...
    public void flushCaptures() throws AccessException {
        long flush = this.cameraDevice.flush();
        LOGGER.debug("flushCaptures success, currentLoopingCaptureTriggerId: %{public}d, lastFrameNumber: %{public}d", Integer.valueOf(this.currentLoopingCaptureTriggerId), Long.valueOf(flush));
        this.currentLoopingCaptureTriggerId = -1;
    }
    ...
    public void handleFrameCompleted(FrameResultImpl frameResultImpl) {
        ...
        tracer.finishAsyncTrace(100000, "first-frame-of-trigger-" + this.currentLoopingCaptureTriggerId);
    }
