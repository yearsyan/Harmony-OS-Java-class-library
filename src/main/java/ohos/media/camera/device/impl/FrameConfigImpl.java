...
public class FrameConfigImpl implements FrameConfig {
    ...
    public FrameConfigImpl(FrameConfigImpl frameConfigImpl) {
        ...
        this.aeRect = rect3 == null ? null : new Rect(rect3.left, frameConfigImpl.aeRect.top, frameConfigImpl.aeRect.right, frameConfigImpl.aeRect.bottom);
        this.awbMode = frameConfigImpl.awbMode;
        Rect rect4 = frameConfigImpl.awbRect;
        this.awbRect = rect4 != null ? new Rect(rect4.left, frameConfigImpl.awbRect.top, frameConfigImpl.awbRect.right, frameConfigImpl.awbRect.bottom) : rect2;
    ...
    public void setAwbMode(@Metadata.AwbMode int i, Rect rect) {
        this.awbMode = i;
        this.awbRect = rect;
        this.configParameters.put(InnerParameterKey.AWB_MODE, Integer.valueOf(this.awbMode));
        this.configParameters.put(InnerParameterKey.AWB_REGION, this.awbRect);
    }
    ...
    public boolean equals(Object obj) {
        ...
        FrameConfigImpl frameConfigImpl = (FrameConfigImpl) obj;
        return this.configParameters.equals(frameConfigImpl.configParameters) && this.frameConfigType == frameConfigImpl.frameConfigType && this.surfaceList.equals(frameConfigImpl.surfaceList) && Objects.equals(this.coordinateSurface, frameConfigImpl.coordinateSurface) && this.flashMode == frameConfigImpl.flashMode && this.faceDetectionType == frameConfigImpl.faceDetectionType && this.afMode == frameConfigImpl.afMode && this.afTrigger == frameConfigImpl.afTrigger && Objects.equals(this.afRect, frameConfigImpl.afRect) && this.zoomValue == frameConfigImpl.zoomValue && Objects.equals(this.location, frameConfigImpl.location) && this.imageRotation == frameConfigImpl.imageRotation && this.aeMode == frameConfigImpl.aeMode && this.aeTrigger == frameConfigImpl.aeTrigger && Objects.equals(this.aeRect, frameConfigImpl.aeRect) && this.awbMode == frameConfigImpl.awbMode && Objects.equals(this.awbRect, frameConfigImpl.awbRect) && Objects.equals(this.mark, frameConfigImpl.mark);
    }

    public int hashCode() {
        return Objects.hash(this.configParameters, Integer.valueOf(this.frameConfigType), this.surfaceList, this.coordinateSurface, Integer.valueOf(this.flashMode), Integer.valueOf(this.faceDetectionType), Integer.valueOf(this.afMode), Integer.valueOf(this.afTrigger), this.afRect, Float.valueOf(this.zoomValue), this.location, Integer.valueOf(this.imageRotation), Integer.valueOf(this.aeMode), Integer.valueOf(this.aeTrigger), this.aeRect, Integer.valueOf(this.awbMode), this.awbRect, this.mark);
    }
    ...
    static final class Builder implements FrameConfig.Builder {
        ...
        @Override // ohos.media.camera.device.FrameConfig.Builder
        public FrameConfig.Builder setAwbMode(@Metadata.AwbMode int i, Rect rect) {
            this.config.setAwbMode(i, rect);
            return this;
        }
