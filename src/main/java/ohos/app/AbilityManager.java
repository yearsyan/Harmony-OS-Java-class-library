...
public class AbilityManager implements IAbilityManager {
    ...
    public void setThreadToRtg(String str) {
        IAbilityManager iAbilityManager = this.abilityManagerImpl;
        if (iAbilityManager != null) {
            iAbilityManager.setThreadToRtg(str);
        }
    }
    ...
    public void registerTaskSyncAnimator(TaskSyncAnimator taskSyncAnimator) {
        IAbilityManager iAbilityManager = this.abilityManagerImpl;
        if (iAbilityManager != null) {
            iAbilityManager.registerTaskSyncAnimator(taskSyncAnimator);
        }
    }

    @Override // ohos.app.IAbilityManager
    @SystemApi
    public boolean checkWindowDisplayMode(Context context) {
        IAbilityManager iAbilityManager = this.abilityManagerImpl;
        if (iAbilityManager != null) {
            return iAbilityManager.checkWindowDisplayMode(context);
        }
        return false;
    }
    ...
    @Override // ohos.app.IAbilityManager
    @SystemApi
    public int getAbilityMissionId(Context context) {
        IAbilityManager iAbilityManager = this.abilityManagerImpl;
        if (iAbilityManager != null) {
            return iAbilityManager.getAbilityMissionId(context);
        }
        return -1;
    }
    ...
    @Override // ohos.app.IAbilityManager
    @SystemApi
    public int getAbilityWindowMode(Context context) {
        IAbilityManager iAbilityManager = this.abilityManagerImpl;
        if (iAbilityManager != null) {
            return iAbilityManager.getAbilityWindowMode(context);
        }
        return -1;
    }
}
