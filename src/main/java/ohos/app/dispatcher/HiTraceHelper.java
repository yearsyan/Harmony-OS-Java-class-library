...
public class HiTraceHelper {
    ...
    public static void tracePointBeforePost(HiTraceId hiTraceId, Task task, boolean z, String str) {
        ...
        if (task == null) {
            ...
            HiTrace.tracePoint(0, hiTraceId, "%s before post %s task %d", str, str2, Long.valueOf(task.getSequence()));
        }
    }
    ...
    public static void tracePointAfterPost(HiTraceId hiTraceId, Task task, boolean z, String str) {
        ...
        if (task == null) {
            ...
            HiTrace.tracePoint(1, hiTraceId, "%s after post %s task %d", str, str2, Long.valueOf(task.getSequence()));
        }
    }
    ...
    public static void tracePointBeforeRunning(HiTraceId hiTraceId, Task task) {
        ...
        HiTrace.tracePoint(3, hiTraceId, "before running task %d", Long.valueOf(task.getSequence()));
    }
    ...
    public static void tracePointAfterRunning(HiTraceId hiTraceId, Task task) {
        ...
        HiTrace.tracePoint(2, hiTraceId, "after running task %d", Long.valueOf(task.getSequence()));
    }
}
