...
public interface Context {
    ...
    @SystemApi
    void downloadAndInstall(Intent intent, InstallerCallback installerCallback) throws IllegalArgumentException;
    ...
    Object getContextLayoutScatter(Context context);
