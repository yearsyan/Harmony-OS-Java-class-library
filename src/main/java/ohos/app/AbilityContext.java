...
public abstract class AbilityContext implements Context, IAbilityLoader {
    ...
    @Override // ohos.app.Context
    public Object getContextLayoutScatter(Context context2) {
        return this.context.getContextLayoutScatter(context2);
    }
    ...
    public int getColor(int i) {
        ...
        AppLog.e("AbilityContext::getColor context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public String getString(int i) {
        ...
        AppLog.e("AbilityContext::getString context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public String[] getStringArray(int i) {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.getStringArray(i);
        }
        AppLog.e("AbilityContext::getStringArray context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public int[] getIntArray(int i) {
        Context context2 = this.context;
        if (context2 != null) {
            return context2.getIntArray(i);
        }
        AppLog.e("AbilityContext::getIntArray context is null", new Object[0]);
        throw new IllegalArgumentException("Ability is not initialized.");
    }
    ...
    public void downloadAndInstall(Intent intent, InstallerCallback installerCallback) throws IllegalArgumentException {
        Context context2 = this.context;
        if (context2 != null) {
            context2.downloadAndInstall(intent, installerCallback);
        } else {
            AppLog.e("AbilityContext::context is null", new Object[0]);
            throw new IllegalArgumentException("Ability is not initialized.");
        }
    ...
    public void registerTaskSyncAnimator(TaskSyncAnimator taskSyncAnimator) {
        if (getAbilityManager() != null) {
            getAbilityManager().registerTaskSyncAnimator(taskSyncAnimator);
        }
    }
}
