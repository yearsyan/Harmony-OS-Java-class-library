...
public interface IAbilityManager {
    ...
    @SystemApi
    boolean checkWindowDisplayMode(Context context);
    ...
    @SystemApi
    int getAbilityMissionId(Context context);

    @SystemApi
    int getAbilityWindowMode(Context context);
    ...
    @SystemApi
    void registerTaskSyncAnimator(TaskSyncAnimator taskSyncAnimator);
    ...
    void setThreadToRtg(String str);
