...
public final class NetCapabilities implements Sequenceable {
    ...
    public boolean marshalling(Parcel parcel) {
        ...
        if (this.uids == null) {
            ...
            parcel.writeInt(1);
            parcel.writeInt(4);
            parcel.writeString("android.net.UidRange");
            parcel.writeInt(this.uids.start);
            parcel.writeInt(this.uids.stop);
        }
    ...
    public boolean unmarshalling(Parcel parcel) {
        ...
        if (readInt > 0 && readInt < 1024) {
            for (int i = 0; i < readInt; i++) {
                ...
                this.uids = new UidRange(readInt3, readInt4);
                HiLog.debug(LABEL, "uid:%{public}d, %{public}s, %{public}d, %{public}d", Integer.valueOf(readInt2), readString2, Integer.valueOf(readInt3), Integer.valueOf(readInt4));
            }
        }
