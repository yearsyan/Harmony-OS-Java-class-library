...
public class NetManagerProxy implements INetManager {
    ...
    private static final int TRANSACT_ENABLE_DISTRIBUTED_CELLULAR_DATA = 27;
    ...
    public NetHandle[] getAllNets() throws RemoteException {
        ...
        if (asObject != null) {
            ...
            try {
                ...
                if (create2.readInt() == 1 && (readInt = create2.readInt()) >= 0 && readInt <= 1024) {
    ...
    public ohos.rpc.ReliableFileDescriptor setUpVpn(ohos.net.VpnConfig r9) throws ohos.rpc.RemoteException {
        /*
        // Method dump skipped, instructions count: 159
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.net.NetManagerProxy.setUpVpn(ohos.net.VpnConfig):ohos.rpc.ReliableFileDescriptor");
    }

    @Override // ohos.net.INetManager
    public boolean enableDistributedCellularData(boolean z) throws RemoteException {
        IRemoteObject asObject = asObject();
        if (asObject != null) {
            MessageParcel create = MessageParcel.create();
            MessageParcel create2 = MessageParcel.create();
            ...
            try {
                writeInterfaceToken(REMOTE_DESCRIPTOR, create);
                create.writeBoolean(z);
                asObject.sendRequest(27, create, create2, messageOption);
                boolean z2 = true;
                if (create2.readInt() != 1) {
                    z2 = false;
                }
                ...
                HiLog.error(LABEL, "Failed to enableDistributedCellularData", new Object[0]);
                throw e;
            } catch (Throwable th) {
                create.reclaim();
                create2.reclaim();
            ...
            HiLog.error(LABEL, "Failed to get remote object for enableDistributedCellularData", new Object[0]);
            throw new RemoteException();
        }
    }
}
