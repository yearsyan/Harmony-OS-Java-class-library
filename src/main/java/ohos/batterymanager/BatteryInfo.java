...
public class BatteryInfo {
    ...
    private static native boolean nativeGetPresent();
    ...
    static {
        try {
            HiLog.info(DEBUG, "load libbatterymgr_jni.z.so", new Object[0]);
            System.loadLibrary("batterymgr_jni.z");
        } catch (UnsatisfiedLinkError unused) {
            HiLog.error(DEBUG, "Could not load libbatterymgr_jni.z.so", new Object[0]);
        }
    }
