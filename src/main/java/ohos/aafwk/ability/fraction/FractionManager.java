...
public class FractionManager {
    ...
    public boolean popStack() {
        ...
        boolean popStackState = popStackState(this.mEvents, this.mIsEventPop, null, 0);
    ...
    private synchronized boolean generateOpsForPendingOperations(List<FractionStack> list, List<Boolean> list2) {
        ...
        if (this.mPendingOperations != null) {
            if (this.mPendingOperations.size() != 0) {
                for (OpBuilder opBuilder : this.mPendingOperations) {
                    z |= opBuilder.makeOps(list, list2);
                }
    ...
    private void executeOps(List<FractionStack> list, List<Boolean> list2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (booleanValue) {
                ...
                fractionStack2.executePopOps(z);
            } else {
                fractionStack2.bumpBackStackNesting(1);
    ...
    public void moveToCurState(int i, boolean z) {
        if (z || i != this.mCurState) {
            this.mCurState = i;
            for (Fraction fraction : this.mAdded) {
                moveFractionToExpectedState(fraction);
            }
            for (Map.Entry<Integer, Fraction> entry : this.mActive.entrySet()) {
                Fraction value = entry.getValue();
    ...
    private void upgradeState(ohos.aafwk.ability.fraction.Fraction r7, int r8) {
        /*
            r6 = this;
            int r0 = r7.mState
            r1 = 2
        ...
        L_0x000c:
            ...
            ohos.aafwk.utils.log.LogLabel r0 = ohos.aafwk.ability.fraction.FractionManager.LABEL
            java.lang.Object[] r4 = new java.lang.Object[r3]
            r4[r2] = r7
            java.lang.String r5 = "move to ATTACH_COMPONENT: %{public}s"
            ohos.aafwk.utils.log.Log.debug(r0, r5, r4)
            r6.moveStateToAttachComponent(r7)
        L_0x001c:
            if (r8 <= r3) goto L_0x0038
            ohos.aafwk.utils.log.LogLabel r6 = ohos.aafwk.ability.fraction.FractionManager.LABEL
            java.lang.Object[] r0 = new java.lang.Object[r3]
            r0[r2] = r7
            java.lang.String r4 = "move to STARTED: %{public}s"
            ohos.aafwk.utils.log.Log.debug(r6, r4, r0)
            boolean r6 = r7.mUpgrade
            if (r6 == 0) goto L_0x0033
            ohos.aafwk.content.Intent r6 = r7.mIntent
            r7.executeStart(r6)
            goto L_0x0038
        L_0x0033:
            ohos.aafwk.content.Intent r6 = r7.mIntent
            r7.executeForeground(r6)
        L_0x0038:
            if (r8 <= r1) goto L_0x004a
            ohos.aafwk.utils.log.LogLabel r6 = ohos.aafwk.ability.fraction.FractionManager.LABEL
            java.lang.Object[] r8 = new java.lang.Object[r3]
            r8[r2] = r7
            java.lang.String r0 = "move to ACTIVE: %{public}s"
            ohos.aafwk.utils.log.Log.debug(r6, r0, r8)
            ohos.aafwk.content.Intent r6 = r7.mIntent
            r7.executeActive(r6)
        L_0x004a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.aafwk.ability.fraction.FractionManager.upgradeState(ohos.aafwk.ability.fraction.Fraction, int):void");
    }
    ...
    private void saveFractionComponentState(Fraction fraction) {
        if (fraction.mRealComponent != null) {
            ...
            if (this.mStateArray.size() > 0) {
                fraction.mSavedComponentState = (Sequenceable[]) this.mStateArray.toArray(new Sequenceable[0]);
    ...
    public HashMap<String, Object> saveAllData() {
        ...
        if (this.mActive.size() <= 0 || (saveActiveData = saveActiveData()) == null) {
            return null;
        }
    ...
    public void restoreAllState(HashMap<?, ?> hashMap) {
        if (!(hashMap == null || hashMap.get("mActive") == null)) {
            ...
            this.mAdded.clear();
            if (hashMap.get("mAdded") instanceof int[]) {
                int[] iArr = (int[]) hashMap.get("mAdded");
                for (int i : iArr) {
                    Fraction fraction = this.mActive.get(Integer.valueOf(i));
                    if (fraction != null) {
                        fraction.mAdded = true;
                        if (!this.mAdded.contains(fraction)) {
                            synchronized (this.mAdded) {
                        ...
                        throw new IllegalStateException("No fraction for index #" + i);
                    }
                }
            }
            if (hashMap.get("stackState") instanceof ArrayList) {
                restoreStackState((ArrayList) hashMap.get("stackState"));
            } else {
                this.mFractionStack = null;
            }
            if (hashMap.get("mNextFractionIndex") instanceof Integer) {
    ...
    private PacMap getArguments(Map<?, ?> map, String str) {
        ...
        for (Map.Entry entry : map2.entrySet()) {
            if (entry.getValue() instanceof PacMap) {
                pacMap.putAll((PacMap) entry.getValue());
            }
        }
        return pacMap;
    }
    ...
    private FractionState executeActiveMap(ArrayList<?> arrayList, int i) {
        ...
        String str2 = map.get("mClassName") instanceof String ? (String) map.get("mClassName") : null;
        ...
        if (map.get("mTag") instanceof String) {
            str = (String) map.get("mTag");
        }
        return new FractionState(str2, intValue, intValue2, booleanValue, intValue3, str, getArguments(map, "mArguments"), map.get("mHidden") instanceof Boolean ? ((Boolean) map.get("mHidden")).booleanValue() : false, getArguments(map, "mSavedFractionData"));
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean popStackState(List<FractionStack> list, List<Boolean> list2, String str, int i) {
        int i2;
        ...
        if (str == null && (i & 1) == 0) {
            ...
            if (str != null) {
                i2 = this.mFractionStack.size() - 1;
                while (i2 >= 0 && !str.equals(this.mFractionStack.get(i2).getName())) {
                    i2--;
                }
                if (i2 < 0) {
                    return false;
                ...
                if ((i & 1) != 0) {
                    ...
                    } while (str.equals(this.mFractionStack.get(i2).getName()));
                }
            } else {
                i2 = -1;
            }
            if (i2 == this.mFractionStack.size() - 1) {
                return false;
            }
            for (int size2 = this.mFractionStack.size() - 1; size2 > i2; size2--) {
    ...
    private class PopStackState implements OpBuilder {
        ...
        public boolean makeOps(List<FractionStack> list, List<Boolean> list2) {
            return FractionManager.this.popStackState(list, list2, this.mName, this.mFlags);
        }
    }
}
