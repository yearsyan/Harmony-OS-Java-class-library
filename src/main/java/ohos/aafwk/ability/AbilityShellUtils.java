...
public class AbilityShellUtils {
    ...
    static boolean continueAbility(Ability ability, boolean z, String str) {
        return ((Boolean) reflectInvoke(ability, DistributeConstants.METHOD_CONTINUE_ABILITY, new Class[]{Boolean.TYPE, String.class}, Boolean.valueOf(z), str)).booleanValue();
    }
