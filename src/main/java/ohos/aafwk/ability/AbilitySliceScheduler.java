...
public final class AbilitySliceScheduler {
    ...
    private OnSliceStackChangedListener sliceStackChangedListener = null;
    private final Object syncLock = new Object();
    private TaskDispatcher taskDispatcher = null;
    private AbilitySlice topAbilitySlice;

    /* access modifiers changed from: package-private */
    public interface OnSliceStackChangedListener {
    ...
    public void addAbilitySlice(final AbilitySlice abilitySlice, final AbilitySlice abilitySlice2, final Intent intent, boolean z) {
        if (abilitySlice == null || abilitySlice2 == null || intent == null) {
            ...
            C0000Bytrace.startAsyncTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "present", hashCode);
            if (z) {
    ...
    private void doAddAbilitySlice(int i, AbilitySlice abilitySlice, AbilitySlice abilitySlice2, Intent intent) {
        C0000Bytrace.finishAsyncTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "present", i);
    ...
    public void addAbilitySliceForResult(final AbilitySlice abilitySlice, final AbilitySlice abilitySlice2, final Intent intent, final int i) {
        if (abilitySlice == null || abilitySlice2 == null || intent == null) {
            ...
            final int hashCode = String.valueOf(abilitySlice.hashCode() + abilitySlice2.hashCode()).hashCode();
            C0000Bytrace.startAsyncTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "presentForResult", hashCode);
            this.taskDispatcher.asyncDispatch(new Runnable() {
                /* class ohos.aafwk.ability.AbilitySliceScheduler.AnonymousClass3 */

                public void run() {
                    synchronized (AbilitySliceScheduler.this.syncLock) {
                        C0000Bytrace.finishAsyncTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "presentForResult", hashCode);
    ...
    public class RemoveAbilitySliceTask implements Runnable {
        ...
        private void scheduleSliceWhenAbilityActive() {
            ...
            AbilitySliceScheduler.this.notifySliceStackChanged();
            if (pop == null) {
        ...
        public void run() {
            synchronized (AbilitySliceScheduler.this.syncLock) {
                C0000Bytrace.startAsyncTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, Constants.ATTRNAME_TERMINATE, String.valueOf(this.abilitySlice.hashCode()).hashCode());
    ...
    public void removeAbilitySlice(AbilitySlice abilitySlice, Intent intent, boolean z) {
        if (abilitySlice == null) {
            ...
            C0000Bytrace.startAsyncTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, Constants.ATTRNAME_TERMINATE, String.valueOf(abilitySlice.hashCode()).hashCode());
            if (z) {
    ...
    private AbilitySlice loadAbilitySlice(String str) {
        C0000Bytrace.startTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "loadSliceInner");
        ...
        try {
            ...
            if (classLoader != null) {
                ...
                C0000Bytrace.finishTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "loadSliceInner");
                return abilitySlice;
            }
            ...
            Log.error(LABEL, "Can not instance %{public}s.InvocationTargetException: %{public}s", str, e.toString());
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public void setOnSliceStackChangedListener(OnSliceStackChangedListener onSliceStackChangedListener) {
        this.sliceStackChangedListener = onSliceStackChangedListener;
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void notifySliceStackChanged() {
        if (this.sliceStackChangedListener != null) {
            Log.debug(LABEL, "ability slice stack size changed, now size is: %{public}d, then call onSizeChanged.", Integer.valueOf(this.abilitySliceStack.size()));
            this.sliceStackChangedListener.onSizeChanged(this.abilitySliceStack.size());
        }
    }
}
