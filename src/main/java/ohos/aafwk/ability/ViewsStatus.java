...
public class ViewsStatus implements Sequenceable {
        ...
        if (componentProvider == null) {
            ...
            for (Integer num : set) {
                ...
                if (findComponentById == null) {
                    HiLog.error(LABEL, "unavailable component id when build views status. component id: %{public}d", Integer.valueOf(intValue));
                } else {
    ...
    private static Intent getViewStatus(Component component) {
        ...
        if (component instanceof Button) {
            ...
            HiLog.error(LABEL, "do not support component. component: %{public}s", component.getClass());
        }
        return intent;
    }
