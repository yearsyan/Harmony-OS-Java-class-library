...
public class AbilityWindow {
    ...
    public void setUIContent(ComponentContainer componentContainer) {
        ...
        C0000Bytrace.startTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "setUIContent");
        this.window.setContentLayout(componentContainer);
        C0000Bytrace.finishTrace(C0000Bytrace.BYTRACE_TAG_ABILITY_MANAGER, "setUIContent");
    }
    ...
    public boolean setSwipeToDismiss(boolean z) {
        ...
        if (z) {
            this.window.setWindowOnSwipe();
            this.ability.getAbilitySliceManager().setOnSliceStackChangedListener(new AbilitySliceScheduler.OnSliceStackChangedListener() {
                /* class ohos.aafwk.ability.AbilityWindow.AnonymousClass1 */

                @Override // ohos.aafwk.ability.AbilitySliceScheduler.OnSliceStackChangedListener
                public void onSizeChanged(int i) {
                    if (i == 0) {
                        AbilityWindow.this.window.setWindowOnSwipe();
                    } else {
                        AbilityWindow.this.window.setOnSwipeChangedListener(null);
                    }
                }
            });
    ...
    public /* synthetic */ void lambda$setSwipeToDismiss$8$AbilityWindow() {
        ...
        if (mainTaskDispatcher != null) {
            mainTaskDispatcher.delayDispatch(new Runnable() {
                /* class ohos.aafwk.ability.AbilityWindow.AnonymousClass2 */
