...
public final class AbilitySliceManager implements IAbilityLifecycleCallback {
    ...
    private boolean checkIsDrivingSafety(Context context) {
        ...
        if (DrivingSafetyClient.isDrivingSafety(context, null, layoutParams != null ? new Position(layoutParams.x, layoutParams.y, layoutParams.height, layoutParams.width) : null)) {
            return true;
        }
    ...
    public void dumpServiceList(String str, PrintWriter printWriter, AbilityContext abilityContext) {
        ...
        if (connectionScheduler2 == null) {
            ...
            printWriter.println(str + USBCore.USB_FUNC_NONE);
            return;
        }
    ...
    public IContinuationRegisterManager getContinuationRegisterManager() {
        Ability ability2 = this.ability;
        if (ability2 != null) {
            return ability2.getContinuationRegisterManager();
        }
        throw new IllegalStateException(NULL_ABILITY_LOG);
    }
    ...
    /* access modifiers changed from: package-private */
    public void setOnSliceStackChangedListener(AbilitySliceScheduler.OnSliceStackChangedListener onSliceStackChangedListener) {
        this.abilitySliceScheduler.setOnSliceStackChangedListener(onSliceStackChangedListener);
    }
}
