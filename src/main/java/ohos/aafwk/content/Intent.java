...
public class Intent implements Sequenceable, Cloneable {
    ...
    public static final String BORDERS_RECT = "BORDERS_RECT";
    ...
    public static class ImplicitOperation extends BaseOperation {
        ...
        @Override // ohos.aafwk.content.Operation, ohos.aafwk.content.Intent.BaseOperation
        public void setAction(String str) {
            this.action = str;
        }
    ...
    public static Intent makeMainAbility(ElementName elementName) {
        Intent intent = new Intent();
        intent.getOperation().setAction("action.system.home");
        intent.getOperation().addEntity("entity.system.home");
    ...
    public static Intent makeMainAbilityPicker(String str, String str2) {
        ...
        intent2.getOperation().setAction(str);
        intent2.getOperation().addEntity(str2);
    ...
    public boolean unmarshalling(Parcel parcel) {
        ...
        setElement(null);
        if (parcel.readInt() == 1) {
            ElementName elementName = new ElementName(null, null, null);
            if (!parcel.readSequenceable(elementName)) {
                setElement(null);
                return false;
            }
    ...
    private static boolean parseUriInternal(String str, Intent intent) {
        ...
        if (!substring.isEmpty()) {
            ...
            switch (trim.hashCode()) {
                ...
                case -1377881982:
                    ...
                    break;
                case -1335157162:
                    if (trim.equals(USBCore.EXTRA_DEVICE)) {
                        c = 4;
                        break;
                    }
                    break;
                case -1298275357:
                    if (trim.equals("entity")) {
                        c = 2;
                        break;
                    }
                    break;
                case -1200507606:
                    if (trim.equals("ability")) {
                        c = 6;
                        break;
                    }
                    break;
                case -807062458:
                    ...
                    break;
                case 116076:
                    if (trim.equals(Constants.ELEMNAME_URL_STRING)) {
                        c = 1;
                        break;
                    }
                    break;
            ...
            switch (c) {
                case 0:
                    intent.getOperation().setAction(decode(substring));
                    break;
                case 1:
                    intent.getOperation().setUri(Uri.parse(decode(substring)));
                    break;
                case 2:
                    intent.getOperation().addEntity(decode(substring));
                    break;
                case 3:
                    try {
                        intent.getOperation().setFlags(Integer.decode(substring).intValue());
                        break;
                    } catch (NumberFormatException unused) {
                        return false;
                    }
        ...
        if (trim.startsWith(PARAM_LABEL)) {
            return parseParam(str, intent);
        }
        return true;
    }
    ...
    public Intent setElementName(String str, Class<?> cls) {
        if (str != null && cls != null) {
            return setElement(new ElementName(null, str, cls.getName()));
        }
        throw new IllegalArgumentException("The bundleName and Class can't be empty.");
    }
    ...
    public Intent setElementName(String str, String str2, Class<?> cls) {
        if (str != null && str2 != null && cls != null) {
            return setElement(new ElementName(str, str2, cls.getName()));
        }
        throw new IllegalArgumentException("The parameters can't be empty.");
    }
    ...
    public Rect getBordersRect() {
        ...
        Object param = intentParams.getParam(BORDERS_RECT);
    ...
    public void setBordersRect(Rect rect) {
        ...
        this.parameters.setParam(BORDERS_RECT, rect);
    }
    ...
    public Intent formatUri(Uri uri) {
        if (uri != null) {
            this.operation.setUri(uri.getLowerCaseScheme());
            return this;
        }
    ...
    public int cloneByIntent(Intent intent, int i) {
        Map<String, Object> params;
        int i2 = 0;
        if (intent == null) {
            return 0;
        }
        if (intent.getAction() != null && (getAction() == null || (i & 1) != 0)) {
            this.operation.setAction(intent.getAction());
            i2 = 1;
        }
        if (!(intent.getUri() == null && intent.getType() == null) && ((getUri() == null && getType() == null) || (i & 2) != 0)) {
            this.operation.setUri(intent.getUri());
            setType(intent.getType());
            i2 |= 2;
        }
        if (intent.getEntities() != null && (getEntities() == null || (i & 4) != 0)) {
            getOperation().setEntities(new HashSet(intent.getEntities()));
            i2 |= 4;
        }
        if (intent.getBundle() != null && ((getBundle() == null || (i & 8) != 0) && getPicker() == null)) {
            setBundle(intent.getBundle());
            i2 |= 8;
        }
        if (!(intent.getPicker() == null || (i & 16) == 0 || getBundle() != null)) {
            setPicker(new Intent(intent.getPicker()));
            i2 |= 16;
        }
        if (!(intent.getElement() == null || (i & 32) == 0)) {
            setElement(intent.getElement());
            i2 |= 32;
        }
        addFlags(intent.getFlags());
        if (intent.getBordersRect() != null && (getBordersRect() == null || (i & 64) != 0)) {
            setBordersRect(new Rect(intent.getBordersRect()));
            i2 |= 64;
        }
        Rect bordersRect = getBordersRect();
        String type = getType();
        if (getParams() == null) {
            if (intent.getParams() != null) {
                setParams(new IntentParams(intent.getParams()));
            }
        } else if (!(intent.getParams() == null || (params = intent.getParams().getParams()) == null)) {
            for (Map.Entry<String, Object> entry : params.entrySet()) {
                getParams().setParam(entry.getKey(), entry.getValue());
            }
        }
        setBordersRect(bordersRect);
        setType(type);
        return i2;
    }
