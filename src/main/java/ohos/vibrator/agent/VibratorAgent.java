...
public class VibratorAgent {
    ...
    public boolean startOnce(int i, int i2) {
        if (!getVibratorIdList().isEmpty() && i != getVibratorIdList().get(0).intValue()) {
            HiLog.error(LABEL, "startOnce with a given duration, vibratorId is invalid", new Object[0]);
            return false;
        } else if (i2 <= 0) {
            ...
            this.vibratorIdToMode.put(Integer.valueOf(i), "time");
    ...
    public boolean startOnce(int i, String str) {
        ...
        HiLog.error(LABEL, "startOnce with a preset effect, vibratorId is invalid", new Object[0]);
        return false;
    }
    ...
    public boolean start(int i, VibrationPattern vibrationPattern) {
        ...
        if (!getVibratorIdList().isEmpty() && i != getVibratorIdList().get(0).intValue()) {
            HiLog.error(LABEL, "start with a custom effect, vibratorId is invalid", new Object[0]);
            return false;
    ...
    public boolean startOnce(int i) {
        ...
        return startOnce(getVibratorIdList().get(0).intValue(), i);
    }
    ...
    public boolean startOnce(String str) {
        ...
        return startOnce(getVibratorIdList().get(0).intValue(), str);
    }
    ...
    public boolean start(VibrationPattern vibrationPattern) {
        ...
        return start(getVibratorIdList().get(0).intValue(), vibrationPattern);
    }
    ...
    public boolean stop(int i, String str) {
        ...
        if (!"time".equals(str) && !VIBRATOR_STOP_MODE_PRESET.equals(str) && !VIBRATOR_STOP_MODE_CUSTOMIZED.equals(str)) {
            return false;
        }
