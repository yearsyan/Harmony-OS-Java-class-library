...
public class AppAccountManagerAdapter {
        ...
        synchronized (this.remoteLock) {
            if (this.service == null) {
                try {
                    ...
                    HiLog.error(LABEL, "get account service failed, %{public}s", e.getMessage());
                    return this.service;
                }
            }
            return this.service;
    ...
    public List<AppAccount> getAllAccounts(String str, String str2) {
        ...
        try {
            ...
            HiLog.error(LABEL, "get accounts failed, %{public}s", e.getMessage());
            return FAIL_APP_ACCOUNTS_LIST;
        }
    }
    ...
    public boolean subscribeAccountEvent(List<String> list, String str) {
        ...
        if (accountService == null) {
            ...
            try {
                ...
                HiLog.error(LABEL, "register account listener failed, %{public}s", e.getMessage());
                return false;
            }
        }
    }
    ...
    public boolean unsubscribeAccountEvent(Set<String> set, String str) {
        if (set == null || set.isEmpty()) {
            HiLog.error(LABEL, "invalid types", new Object[0]);
            return false;
        }
        IAccountManager accountService = getAccountService();
        if (accountService == null) {
        ...
        try {
            accountService.unregisterAccountListener((String[]) set.toArray(new String[set.size()]), str);
            return true;
        } catch (RemoteException e) {
            HiLog.error(LABEL, "unregister account listener failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public boolean addAccount(String str, String str2, String str3) {
        ...
        try {
            ...
            HiLog.error(LABEL, "add account failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public boolean deleteAccount(String str, String str2) {
        ...
        try {
            ...
            HiLog.error(LABEL, "delete account failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public boolean setAccountAccess(String str, String str2, String str3, boolean z) {
        ...
        try {
            ...
            HiLog.error(LABEL, "set account accessed failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public boolean setAccountExtraInfo(String str, String str2, String str3) {
        ...
        try {
            ...
            HiLog.error(LABEL, "set account extraInfo failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public String getAccountExtraInfo(String str, String str2) {
        ...
        try {
            ...
            HiLog.error(LABEL, "get account extraInfo failed, %{public}s", e.getMessage());
            return AppAccountConst.INVALID_ACCOUNT_INFO;
        }
    }
    ...
    public boolean setAccountCredential(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            HiLog.error(LABEL, "set credential failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public String getAccountCredential(String str, String str2, String str3) {
        ...
        try {
            ...
            HiLog.error(LABEL, "get credential failed, %{public}s", e.getMessage());
            return AppAccountConst.INVALID_ACCOUNT_INFO;
        }
    }
    ...
    public boolean setAssociatedData(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            HiLog.error(LABEL, "set associated failed, %{public}s", e.getMessage());
            return false;
        }
    }
    ...
    public String getAssociatedData(String str, String str2, String str3) {
        ...
        try {
            ...
            HiLog.error(LABEL, "get associated failed, %{public}s", e.getMessage());
            return AppAccountConst.INVALID_ACCOUNT_INFO;
        }
    }
}
