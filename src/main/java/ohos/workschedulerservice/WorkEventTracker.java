...
public final class WorkEventTracker {
    ...
    private static final int ON_START_WORK_EVENT = 1;
    ...
    private String getEventCmdLabel(int i) {
        return i != 1 ? i != 2 ? "INCORRECT_LABEL" : "WORK_CONNECTION_END_EVENT" : "ON_START_WORK_EVENT";
    }
    ...
    public void noteOnWorkStartEvent(WorkStatus workStatus) {
        ...
        HiLog.info(LOG_LABEL, "noteOnWorkStartEvent %{private}d success", Integer.valueOf(workStatus.getWorkId()));
    }
    ...
    public void noteWorkConnectionEndEvent(WorkStatus workStatus) {
        ...
        HiLog.info(LOG_LABEL, "noteWorkConnectionEndEvent %{private}d success", Integer.valueOf(workStatus.getWorkId()));
    }
