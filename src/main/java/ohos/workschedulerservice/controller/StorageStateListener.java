...
public final class StorageStateListener extends StateListener {
    ...
    private CommonEventSubscribeInfo getInfo() {
        ...
        matchingSkills.addEvent(CommonEventSupport.COMMON_EVENT_DEVICE_STORAGE_LOW);
        matchingSkills.addEvent(CommonEventSupport.COMMON_EVENT_DEVICE_STORAGE_OK);
    ...
    public final class StorageCommonEventSubscriber extends CommonEventSubscriber {
        ...
        public void onReceiveEvent(CommonEventData commonEventData) {
            ...
            if (CommonEventSupport.COMMON_EVENT_DEVICE_STORAGE_LOW.equals(action)) {
            ...
            } else if (CommonEventSupport.COMMON_EVENT_DEVICE_STORAGE_OK.equals(action)) {
