...
public final class DeviceIdleListener extends StateListener {
    ...
    public final class IdleCommonEventSubscriber extends CommonEventSubscriber {
        ...
        public void onReceiveEvent(CommonEventData commonEventData) {
            ...
            if (CommonEventSupport.COMMON_EVENT_SCREEN_ON.equals(action) || DeviceIdleListener.STOP_DREAM.equals(action)) {
            ...
            } else if (CommonEventSupport.COMMON_EVENT_SCREEN_OFF.equals(action) || DeviceIdleListener.START_DREAM.equals(action)) {
