...
public final class AppChangedListener extends StateListener {
    ...
    public final class AppCommonEventSubscriber extends CommonEventSubscriber {
        ...
        public void onReceiveEvent(CommonEventData commonEventData) {
            ...
            if (CommonEventSupport.COMMON_EVENT_PACKAGE_REMOVED.equals(action) || CommonEventSupport.COMMON_EVENT_PACKAGE_REPLACED.equals(action)) {
            ...
            } else if (CommonEventSupport.COMMON_EVENT_PACKAGE_RESTARTED.equals(action)) {
                ...
                AppChangedListener.this.receivedFlag.set(true);
            } else if (CommonEventSupport.COMMON_EVENT_PACKAGE_ADDED.equals(action)) {
