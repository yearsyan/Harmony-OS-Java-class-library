    ...
    public final class HapCommonEventSubscriber extends CommonEventSubscriber {
        ...
        public void onReceiveEvent(CommonEventData commonEventData) {
            ...
            synchronized (HapChangedListener.this.lock) {
                ...
                if (CommonEventSupport.COMMON_EVENT_ABILITY_ADDED.equals(HapChangedListener.this.action)) {
                ...
                } else if (CommonEventSupport.COMMON_EVENT_ABILITY_REMOVED.equals(HapChangedListener.this.action)) {
                ...
                } else if (CommonEventSupport.COMMON_EVENT_ABILITY_UPDATED.equals(HapChangedListener.this.action)) {
