...
public final class TimerStateListener extends StateListener {
    ...
    private void useAlarmTimer(long j) {
        if (this.alarmTimer == null) {
            if (this.context.getSystemService(NotificationRequest.CLASSIFICATION_ALARM) instanceof AlarmManager) {
                this.alarmTimer = (AlarmManager) this.context.getSystemService(NotificationRequest.CLASSIFICATION_ALARM);
            } else {
                return;
            }
        }
