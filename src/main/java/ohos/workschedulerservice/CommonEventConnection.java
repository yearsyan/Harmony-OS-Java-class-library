...
import ohos.abilityshell.support.AbilityUtilsHelper;
...
public class CommonEventConnection {
    ...
    public class EventServiceConnection implements ServiceConnection {
        ...
        public boolean onStartServiceConnect() {
            ...
            Optional<android.content.Intent> checkIntentIsValid = checkIntentIsValid(intent, AbilityUtilsHelper.getAbilityShellInfo(intent.getElement().getBundleName(), intent.getElement().getAbilityName()));
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void onCommonEventCompleted() {
            try {
                CommonEventConnection.this.context.unbindService(this);
            } catch (SecurityException unused) {
                HiLog.error(CommonEventConnection.LOG_LABEL, "onCommonEventCompleted unbindService SecurityException!", new Object[0]);
            }
        }
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            ...
            HiLog.debug(CommonEventConnection.LOG_LABEL, "onServiceDisconnected ComponentName package:%{public}s, class name:%{public}s", componentName.getPackageName(), componentName.getClassName());
            ...
            if (innerEvent != null) {
                ...
                if (i == 1) {
                    ...
                    if (innerEvent.object instanceof ElementName) {
                        ...
                        synchronized (CommonEventConnection.this.eventServiceConnections) {
                            ...
                            if (eventServiceConnection2 != null) {
                                eventServiceConnection2.onCommonEventCompleted();
                    ...
                    if (innerEvent.object instanceof CommonEventStatus) {
                        ...
                        synchronized (CommonEventConnection.this.eventServiceConnections) {
                            EventServiceConnection eventServiceConnection3 = (EventServiceConnection) CommonEventConnection.this.eventServiceConnections.get(commonEventStatus2.getElementName());
                            if (eventServiceConnection3 != null) {
                                eventServiceConnection3.onCommonEventCompleted();
