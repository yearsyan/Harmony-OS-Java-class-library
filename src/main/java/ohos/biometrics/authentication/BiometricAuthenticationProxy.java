...
class BiometricAuthenticationProxy {
    ...
    private static final HiLogLabel LABEL = new HiLogLabel(3, BIOMETRIC_DOMAIN, "BiometricAuthenticationProxy");
    ...
    BiometricAuthenticationProxy(Context context) {
        ...
        AnonymousClass3 r0 = new DefaultFaceRecognizeManagerImpl.FaceRecognizeCallback() {
            ...
            public void onCallbackEvent(int i, int i2, int i3, int i4) {
                HiLog.info(BiometricAuthenticationProxy.LABEL, "onCallbackEvent is called type = %{public}d", Integer.valueOf(i2));
                if (((long) i) == BiometricAuthenticationProxy.this.mReqId && i2 == 2) {
                    ...
                    if (i3 == 1 && BiometricAuthenticationProxy.this.mSignal != null) {
                        HiLog.info(BiometricAuthenticationProxy.LABEL, "get authentication result from callback event! errorCode = %{public}d", Integer.valueOf(i4));
                    ...
                    if (i3 == 6) {
                        HiLog.info(BiometricAuthenticationProxy.LABEL, "get authentication face id from callback event! faceid = ****%{public}04x", Integer.valueOf(65535 & i4));
                        BiometricAuthenticationProxy.this.setAuthedFaceId(i4);
                        return;
                    }
                    return;
                }
                HiLog.error(BiometricAuthenticationProxy.LABEL, "authentication callback event error: reqId = %{public}d, type = %{public}d", Integer.valueOf(i), Integer.valueOf(i2));
            }
        };
    ...
    static /* synthetic */ class AnonymousClass4 {
        ...
        static {
            /*
                ohos.biometrics.authentication.BiometricAuthentication$AuthType[] r0 = ohos.biometrics.authentication.BiometricAuthentication.AuthType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ohos.biometrics.authentication.BiometricAuthenticationProxy.AnonymousClass4.$SwitchMap$ohos$biometrics$authentication$BiometricAuthentication$AuthType = r0
                int[] r0 = ohos.biometrics.authentication.BiometricAuthenticationProxy.AnonymousClass4.$SwitchMap$ohos$biometrics$authentication$BiometricAuthentication$AuthType     // Catch:{ NoSuchFieldError -> 0x0014 }
                ohos.biometrics.authentication.BiometricAuthentication$AuthType r1 = ohos.biometrics.authentication.BiometricAuthentication.AuthType.AUTH_TYPE_BIOMETRIC_ALL     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = ohos.biometrics.authentication.BiometricAuthenticationProxy.AnonymousClass4.$SwitchMap$ohos$biometrics$authentication$BiometricAuthentication$AuthType     // Catch:{ NoSuchFieldError -> 0x001f }
                ohos.biometrics.authentication.BiometricAuthentication$AuthType r1 = ohos.biometrics.authentication.BiometricAuthentication.AuthType.AUTH_TYPE_BIOMETRIC_FACE_ONLY     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = ohos.biometrics.authentication.BiometricAuthenticationProxy.AnonymousClass4.$SwitchMap$ohos$biometrics$authentication$BiometricAuthentication$AuthType     // Catch:{ NoSuchFieldError -> 0x002a }
                ohos.biometrics.authentication.BiometricAuthentication$AuthType r1 = ohos.biometrics.authentication.BiometricAuthentication.AuthType.AUTH_TYPE_BIOMETRIC_FINGERPRINT_ONLY     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ohos.biometrics.authentication.BiometricAuthenticationProxy.AnonymousClass4.<clinit>():void");
        }
    }
    ...
    public int checkAuthenticationAvailability(BiometricAuthentication.AuthType authType, BiometricAuthentication.SecureLevel secureLevel, boolean z) {
        ...
        if (i == 1) {
            ...
            if (i != 3) {
                HiLog.error(LABEL, "check auth ability type error, type = %{public}d", authType);
                return 1;
            }
    ...
    public int execAuthenticationAction(BiometricAuthentication.AuthType authType, BiometricAuthentication.SecureLevel secureLevel, boolean z, boolean z2, BiometricAuthentication.SystemAuthDialogInfo systemAuthDialogInfo) {
        ...
        if (i == 1) {
            ...
            HiView.report(HiView.byVariadic(940101021, HiView.PayloadMode.KVPairs, new Object[]{"call_pkg", this.mPkgName, "biometric_type", Integer.valueOf(BiometricAuthentication.AuthType.AUTH_TYPE_BIOMETRIC_FACE_ONLY.ordinal()), "sdk_version", "1.0", "auth_result", Integer.valueOf(execFaceAuthentication), "run_time", Long.valueOf(currentTimeMillis2), "secure_level", Integer.valueOf(secureLevel.ordinal() + 1), "is_local_auth", Integer.valueOf(z ? 1 : 0), "is_app_auth_dialog", Integer.valueOf(z2 ? 1 : 0)}));
            return execFaceAuthentication;
        } else if (i != 3) {
            HiLog.error(LABEL, "execute auth type error, type = %{public}d", authType);
            return -1;
        } else {
    ...
    public int cancelAuthenticationAction(BiometricAuthentication.AuthType authType) {
        ...
        if (i == 1) {
            ...
            HiLog.error(LABEL, "cancel auth type error, type = %{public}d", authType);
            return -1;
        } else {
