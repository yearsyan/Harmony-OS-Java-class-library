...
public class BiometricAuthentication {
    ...
    private static final HiLogLabel LABEL = new HiLogLabel(3, BIOMETRIC_DOMAIN, "BiometricAuthentication");
    ...
    public int checkAuthenticationAvailability(AuthType authType, SecureLevel secureLevel, boolean z) {
        ...
        if (context == null || context.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") != 0) {
    ...
    public AuthenticationTips getAuthenticationTips() {
        ...
        if (context == null || context.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") != 0) {
            ...
            HiLog.error(LABEL, "Authentication type error! type = %{public}d", this.mAuthType);
            return authenticationTips;
        }
    }
