...
public class BiometricEnroll {
    ...
    private static final HiLogLabel LABEL = new HiLogLabel(3, LOG_DOMAIN_ID, "BiometricEnroll");
    ...
    public static BiometricEnroll getInstance(Ability ability) throws IllegalAccessException {
        if (ability != null) {
            ...
            } else if (applicationContext.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") != 0) {
                throw new IllegalAccessException("No permission to access biometric");
            } else if (applicationContext.verifySelfPermission("ohos.permission.ENROLL_BIOMETRIC") == 0) {
                if (sInstance == null) {
    ...
    public synchronized EnrollInitResult initEnroll(BiometricType biometricType) {
        ...
        if (this.mContext.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") == 0) {
            if (this.mContext.verifySelfPermission("ohos.permission.ENROLL_BIOMETRIC") == 0) {
                ...
                if (this.mBiometricType == BiometricType.BIOMETRICTYPE_NONE || this.mBiometricType == biometricType) {
                    if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                        HiLog.error(LABEL, "this BiometricType is currently not supported: %{public}d", biometricType);
                    } else {
                    ...
                    HiLog.error(LABEL, "last enoll is not finished: BiometricType = %{public}d", this.mBiometricType);
                }
                return enrollInitResult;
            }
        }
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ohos.biometrics.enrollment.BiometricEnroll$BiometricType[] r0 = ohos.biometrics.enrollment.BiometricEnroll.BiometricType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ohos.biometrics.enrollment.BiometricEnroll.AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType = r0
                int[] r0 = ohos.biometrics.enrollment.BiometricEnroll.AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType     // Catch:{ NoSuchFieldError -> 0x0014 }
                ohos.biometrics.enrollment.BiometricEnroll$BiometricType r1 = ohos.biometrics.enrollment.BiometricEnroll.BiometricType.BIOMETRICTYPE_FACE     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = ohos.biometrics.enrollment.BiometricEnroll.AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType     // Catch:{ NoSuchFieldError -> 0x001f }
                ohos.biometrics.enrollment.BiometricEnroll$BiometricType r1 = ohos.biometrics.enrollment.BiometricEnroll.BiometricType.BIOMETRICTYPE_NONE     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ohos.biometrics.enrollment.BiometricEnroll.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public synchronized int execEnroll(byte[] bArr, long j, int i, Surface surface) {
        ...
        if (this.mContext.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") == 0) {
            if (this.mContext.verifySelfPermission("ohos.permission.ENROLL_BIOMETRIC") == 0) {
                ...
                if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] != 1) {
                    HiLog.error(LABEL, "BiometricType status error, please initEnroll first! BiometricType = %{public}d", biometricType);
                } else {
        ...
        if (this.mContext.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") == 0) {
            if (this.mContext.verifySelfPermission("ohos.permission.ENROLL_BIOMETRIC") == 0) {
                ...
                if (i2 == 1) {
                    ...
                    HiLog.error(LABEL, "this BiometricType is currently not supported: %{public}d", this.mBiometricType);
                } else {
    ...
    public int cancelEnroll() {
        if (this.mContext.verifySelfPermission("ohos.permission.ACCESS_BIOMETRIC") == 0 && this.mContext.verifySelfPermission("ohos.permission.ENROLL_BIOMETRIC") == 0) {
            BiometricType biometricType = this.mBiometricType;
            if (AnonymousClass1.$SwitchMap$ohos$biometrics$enrollment$BiometricEnroll$BiometricType[biometricType.ordinal()] == 1) {
                return FaceEnroll.getInstance(this.mContext).cancelEnroll();
            }
            HiLog.error(LABEL, "BiometricType status error! please check initEnroll: BiometricType = %{public}d", biometricType);
            return -1;
        }
