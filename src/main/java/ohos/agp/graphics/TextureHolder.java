...
public class TextureHolder {
    private static final HiLogLabel LOG_TAG = new HiLogLabel(3, LogDomain.END, "TextureHolder");
    ...
    public boolean isAbandoned() {
        return this.mTextureHolderAdapter.isAbandoned();
    }

    public long getLastRefreshTextureImageTime() {
        return this.mTextureHolderAdapter.getLastRefreshTextureImageTime();
    }
}
