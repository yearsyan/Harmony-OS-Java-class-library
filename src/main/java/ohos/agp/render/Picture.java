...
public class Picture {
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "AGP_RenderPicture");
    private int mHeight;
    ...
    public void draw(Canvas canvas) {
        if (canvas == null) {
            throw new IllegalArgumentException("Canvas is illegal");
        } else if (this.mNativePictureHandle != 0) {
            if (this.mRecordingCanvas != null) {
                endRecording();
            }
