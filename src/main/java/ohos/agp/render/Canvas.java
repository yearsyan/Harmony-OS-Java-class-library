...
public class Canvas {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "AGP_RENDER_CANVAS");
    ...
    private native void nativeDrawRegion(long j, long j2, long j3);
    ...
    private native Rect nativeGetDeviceClipBounds(long j);
    ...
    private native boolean nativeQuickReject(long j, long j2);

    private native void nativeResetMatrix(long j);
    ...
    public void drawRect(RectFloat rectFloat, Paint paint, Color color) {
        ...
        drawRect(rectFloat, paint);
    }

    public void drawRect(float f, float f2, float f3, float f4, Paint paint) {
        drawRect(new RectFloat(f, f2, f3, f4), paint);
    }

    public void drawRect(float f, float f2, float f3, float f4, Paint paint, Color color) {
        paint.setColor(color);
        drawRect(f, f2, f3, f4, paint);
    }

    public void drawRect(Rect rect, Paint paint) {
        drawRect(new RectFloat((float) rect.left, (float) rect.top, (float) rect.right, (float) rect.bottom), paint);
    }
    ...
    public void drawCircle(Point point, float f, Paint paint) {
        drawCircle(point.getPointX(), point.getPointY(), f, paint);
    }

    public void drawCircle(float f, float f2, float f3, Paint paint, Color color) {
        paint.setColor(color);
        drawCircle(f, f2, f3, paint);
    }

    public void drawCircle(Circle circle, Paint paint) {
        drawCircle(circle.getCenterX(), circle.getCenterY(), circle.getRadius(), paint);
    }
    ...
    public void drawCircle(Point point, float f, Paint paint, Color color) {
        paint.setColor(color);
        drawCircle(point.getPointX(), point.getPointY(), f, paint);
    }
    ...
    public void drawRoundRect(RectFloat rectFloat, float f, float f2, Paint paint, Color color) {
        paint.setColor(color);
        drawRoundRect(rectFloat, f, f2, paint);
    }
    ...
    public void drawLine(float f, float f2, float f3, float f4, Paint paint) {
        drawLine(new Point(f, f2), new Point(f3, f4), paint);
    }

    public void drawLine(float f, float f2, float f3, float f4, Paint paint, Color color) {
        paint.setColor(color);
        drawLine(new Point(f, f2), new Point(f3, f4), paint);
    }
    ...
    public void drawLine(Line line, Paint paint) {
        if (line != null) {
            drawLine(line.getStartPoint(), line.getEndPoint(), paint);
        }
    }
    ...
    public void drawRegion(Region region, Paint paint) {
        nativeDrawRegion(this.mNativeCanvasHandle, region.getNativeHandle(), paint.getNativeHandle());
    }

    public void drawOval(RectFloat rectFloat, Paint paint, Color color) {
        paint.setColor(color);
        drawOval(rectFloat, paint);
    }
    ...
    public void drawArc(RectFloat rectFloat, Arc arc, Paint paint, Color color) {
        paint.setColor(color);
        drawArc(rectFloat, arc, paint);
    }
    ...
    public void resetMatrix() {
        nativeResetMatrix(this.mNativeCanvasHandle);
    }

    public void clipRect(Rect rect) {
        clipRect(new RectFloat(rect), ClipOp.INTERSECT);
    }
    ...
    public void clipRect(float f, float f2, float f3, float f4) {
        clipRect(new RectFloat(f, f2, f3, f4));
    }

    public void clipRect(int i, int i2, int i3, float f) {
        clipRect(new RectFloat((float) i, (float) i2, (float) i3, f));
    }

    public void rotate(float f) {
        nativeRotate(this.mNativeCanvasHandle, f, 0.0f, 0.0f);
    }
    ...
    public void drawPoint(Point point, Paint paint, Color color) {
        paint.setColor(color);
        drawPoint(point.getPointX(), point.getPointY(), paint);
    }

    public void drawPoint(Point point, Paint paint) {
        drawPoint(point.getPointX(), point.getPointY(), paint);
    }
    ...
    public void drawColor(int i, BlendMode blendMode) {
        nativeDrawColor(this.mNativeCanvasHandle, i, blendMode.value());
    }
    ...
    public boolean getLocalClipBounds(Rect rect) {
        Rect localClipBounds;
        if (rect == null || (localClipBounds = getLocalClipBounds()) == null) {
            return false;
        }
        rect.set(localClipBounds.left, localClipBounds.top, localClipBounds.right, localClipBounds.bottom);
        return true;
    }

    public Rect getDeviceClipBounds() {
        return nativeGetDeviceClipBounds(this.mNativeCanvasHandle);
    }

    public boolean getDeviceClipBounds(Rect rect) {
        Rect deviceClipBounds;
        if (rect == null || (deviceClipBounds = getDeviceClipBounds()) == null) {
            return false;
        }
        rect.set(deviceClipBounds.left, deviceClipBounds.top, deviceClipBounds.right, deviceClipBounds.bottom);
        return true;
    }
    ...
    public boolean quickRejectRect(RectFloat rectFloat) {
        ...
        return quickReject(rectFloat.left, rectFloat.top, rectFloat.right, rectFloat.bottom);
    }
    ...
    public boolean quickRejectPath(Path path) {
        ...
        return nativeQuickReject(this.mNativeCanvasHandle, path.getNativeHandle());
    }
