...
public final class EngineImpl implements Engine {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "core: EngineImpl");
    ...
    public boolean init(Context context, Engine.RenderBackend renderBackend, Map<String, Object> map, String str) {
        ...
        if (renderBackend == Engine.RenderBackend.OPEN_GL_ES) {
            ...
            HiLog.error(LABEL, "Unsupported backed type: %{public}s.", renderBackend.name());
            release();
            return false;
        }
        ...
        if (!load.getSuccess()) {
            HiLog.error(LABEL, "Loading system graph failed: %{public}s.", load.getError());
            release();
            return false;
        }
    ...
    public Engine.RenderNodeGraph loadRenderNodeGraph(String str) {
        ...
        if (coreRenderHandle == null) {
            ...
            if (!load.getSuccess()) {
                HiLog.error(LABEL, "Loading render node graph failed: %{public}s.", load.getError());
                return new RenderNodeGraphImpl(this, null);
            }
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ohos.agp.render.render3d.Engine$RenderNodeGraphType[] r0 = ohos.agp.render.render3d.Engine.RenderNodeGraphType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderNodeGraphType = r0
                r0 = 1
                int[] r1 = ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderNodeGraphType     // Catch:{ NoSuchFieldError -> 0x0014 }
                ohos.agp.render.render3d.Engine$RenderNodeGraphType r2 = ohos.agp.render.render3d.Engine.RenderNodeGraphType.LIGHT_WEIGHT_RENDERING_PIPELINE     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r1[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                r1 = 2
                int[] r2 = ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderNodeGraphType     // Catch:{ NoSuchFieldError -> 0x001f }
                ohos.agp.render.render3d.Engine$RenderNodeGraphType r3 = ohos.agp.render.render3d.Engine.RenderNodeGraphType.LIGHT_WEIGHT_RENDERING_PIPELINE_MSAA     // Catch:{ NoSuchFieldError -> 0x001f }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2[r3] = r1     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r2 = ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderNodeGraphType     // Catch:{ NoSuchFieldError -> 0x002a }
                ohos.agp.render.render3d.Engine$RenderNodeGraphType r3 = ohos.agp.render.render3d.Engine.RenderNodeGraphType.HIGH_DEFINITION_RENDERING_PIPELINE     // Catch:{ NoSuchFieldError -> 0x002a }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r4 = 3
                r2[r3] = r4     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                ohos.agp.render.render3d.Engine$RenderMode[] r2 = ohos.agp.render.render3d.Engine.RenderMode.values()
                int r2 = r2.length
                int[] r2 = new int[r2]
                ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderMode = r2
                int[] r2 = ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderMode     // Catch:{ NoSuchFieldError -> 0x003d }
                ohos.agp.render.render3d.Engine$RenderMode r3 = ohos.agp.render.render3d.Engine.RenderMode.RENDER_IF_DIRTY     // Catch:{ NoSuchFieldError -> 0x003d }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x003d }
                r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x003d }
            L_0x003d:
                int[] r0 = ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.$SwitchMap$ohos$agp$render$render3d$Engine$RenderMode     // Catch:{ NoSuchFieldError -> 0x0047 }
                ohos.agp.render.render3d.Engine$RenderMode r2 = ohos.agp.render.render3d.Engine.RenderMode.ALWAYS     // Catch:{ NoSuchFieldError -> 0x0047 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0047 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0047 }
            L_0x0047:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ohos.agp.render.render3d.impl.EngineImpl.AnonymousClass1.<clinit>():void");
        }
    }
