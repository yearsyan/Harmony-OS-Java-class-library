...
public final class AgpEngineFactory {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "core: AgpEngineFactory");
    ...
    public static Optional<Engine> createEngine() {
        try {
            ...
            HiLog.error(LABEL, "Loading native AGPEngine failed: %{public}s.", e.getMessage());
