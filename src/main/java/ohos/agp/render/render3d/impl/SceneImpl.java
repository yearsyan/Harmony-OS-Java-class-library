...
public final class SceneImpl implements Scene {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "core: SceneImpl");
    ...
    public ComponentManager<?, ? extends CoreComponentManager> getComponentManager(Class<?> cls) {
        ...
        HiLog.warn(LABEL, "class: %{public}s = %{public}s", cls.getSimpleName(), cls.getName());
        HiLog.warn(LABEL, "componentManagers: %{public}s.", String.join(",", this.mComponentManagerMap.keySet()));
        throw new IllegalStateException();
    }
