...
public final class SurfaceTargetBufferImpl implements TargetBuffer {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "core: SurfaceTargetBufferImpl");
    ...
    public void init(AgpContextImpl agpContextImpl, Surface surface) {
        ...
        try {
            ...
            HiLog.error(LABEL, "Init has exception: %{public}s.", e.getMessage());
        }
    }
