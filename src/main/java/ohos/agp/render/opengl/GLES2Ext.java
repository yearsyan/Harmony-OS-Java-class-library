...
public class GLES2Ext {
    ...
    private static native void nativeGlBlendBarrierKHR();

    private static native void nativeGlBlendEquationSeparateiEXT(int i, int i2, int i3);

    private static native void nativeGlBlendEquationiEXT(int i, int i2);

    private static native void nativeGlBlendFuncSeparateiEXT(int i, int i2, int i3, int i4, int i5);

    private static native void nativeGlBlendFunciEXT(int i, int i2, int i3);

    private static native void nativeGlColorMaskiEXT(int i, boolean z, boolean z2, boolean z3, boolean z4);

    private static native void nativeGlCopyImageSubDataEXT(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15);

    private static native void nativeGlDebugMessageControlKHR(int i, int i2, int i3, int i4, int[] iArr, boolean z);

    private static native void nativeGlDebugMessageInsertKHR(int i, int i2, int i3, int i4, int i5, String str);

    private static native void nativeGlDisableiEXT(int i, int i2);

    private static native void nativeGlEnableiEXT(int i, int i2);

    private static native void nativeGlFramebufferTextureEXT(int i, int i2, int i3, int i4);

    private static native void nativeGlGetSamplerParameterIivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlGetSamplerParameterIuivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlGetTexParameterIivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlGetTexParameterIuivEXT(int i, int i2, int[] iArr);

    private static native boolean nativeGlIsEnablediEXT(int i, int i2);

    private static native void nativeGlMinSampleShadingOES(float f);

    private static native void nativeGlObjectLabelKHR(int i, int i2, int i3, String str);

    private static native void nativeGlPatchParameteriEXT(int i, int i2);

    private static native void nativeGlPopDebugGroupKHR();

    private static native void nativeGlPrimitiveBoundingBoxEXT(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8);

    private static native void nativeGlPushDebugGroupKHR(int i, int i2, int i3, String str);

    private static native void nativeGlSamplerParameterIivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlSamplerParameterIuivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlTexBufferEXT(int i, int i2, int i3);

    private static native void nativeGlTexBufferRangeEXT(int i, int i2, int i3, int i4, int i5);

    private static native void nativeGlTexParameterIivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlTexParameterIuivEXT(int i, int i2, int[] iArr);

    private static native void nativeGlTexStorage3DMultisampleOES(int i, int i2, int i3, int i4, int i5, int i6, boolean z);

    public static void glBlendBarrierKHR() {
        nativeGlBlendBarrierKHR();
    }

    public static void glDebugMessageControlKHR(int i, int i2, int i3, int i4, int[] iArr, boolean z) {
        nativeGlDebugMessageControlKHR(i, i2, i3, i4, iArr, z);
    }

    public static void glDebugMessageInsertKHR(int i, int i2, int i3, int i4, int i5, String str) {
        nativeGlDebugMessageInsertKHR(i, i2, i3, i4, i5, str);
    }

    public static void glPushDebugGroupKHR(int i, int i2, int i3, String str) {
        nativeGlPushDebugGroupKHR(i, i2, i3, str);
    }

    public static void glPopDebugGroupKHR() {
        nativeGlPopDebugGroupKHR();
    }

    public static void glObjectLabelKHR(int i, int i2, int i3, String str) {
        nativeGlObjectLabelKHR(i, i2, i3, str);
    }

    public static void glMinSampleShadingOES(float f) {
        nativeGlMinSampleShadingOES(f);
    }

    public static void glTexStorage3DMultisampleOES(int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
        nativeGlTexStorage3DMultisampleOES(i, i2, i3, i4, i5, i6, z);
    }

    public static void glCopyImageSubDataEXT(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15) {
        nativeGlCopyImageSubDataEXT(i, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15);
    }

    public static void glEnableiEXT(int i, int i2) {
        nativeGlEnableiEXT(i, i2);
    }

    public static void glDisableiEXT(int i, int i2) {
        nativeGlDisableiEXT(i, i2);
    }

    public static void glBlendEquationiEXT(int i, int i2) {
        nativeGlBlendEquationiEXT(i, i2);
    }

    public static void glBlendEquationSeparateiEXT(int i, int i2, int i3) {
        nativeGlBlendEquationSeparateiEXT(i, i2, i3);
    }

    public static void glBlendFunciEXT(int i, int i2, int i3) {
        nativeGlBlendFunciEXT(i, i2, i3);
    }

    public static void glBlendFuncSeparateiEXT(int i, int i2, int i3, int i4, int i5) {
        nativeGlBlendFuncSeparateiEXT(i, i2, i3, i4, i5);
    }

    public static void glColorMaskiEXT(int i, boolean z, boolean z2, boolean z3, boolean z4) {
        nativeGlColorMaskiEXT(i, z, z2, z3, z4);
    }

    public static boolean glIsEnablediEXT(int i, int i2) {
        return nativeGlIsEnablediEXT(i, i2);
    }

    public static void glFramebufferTextureEXT(int i, int i2, int i3, int i4) {
        nativeGlFramebufferTextureEXT(i, i2, i3, i4);
    }

    public static void glPrimitiveBoundingBoxEXT(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        nativeGlPrimitiveBoundingBoxEXT(f, f2, f3, f4, f5, f6, f7, f8);
    }

    public static void glPatchParameteriEXT(int i, int i2) {
        nativeGlPatchParameteriEXT(i, i2);
    }

    public static void glTexParameterIivEXT(int i, int i2, int[] iArr) {
        nativeGlTexParameterIivEXT(i, i2, iArr);
    }

    public static void glTexParameterIuivEXT(int i, int i2, int[] iArr) {
        nativeGlTexParameterIuivEXT(i, i2, iArr);
    }

    public static void glGetTexParameterIivEXT(int i, int i2, int[] iArr) {
        nativeGlGetTexParameterIivEXT(i, i2, iArr);
    }

    public static void glGetTexParameterIuivEXT(int i, int i2, int[] iArr) {
        nativeGlGetTexParameterIuivEXT(i, i2, iArr);
    }

    public static void glSamplerParameterIivEXT(int i, int i2, int[] iArr) {
        nativeGlSamplerParameterIivEXT(i, i2, iArr);
    }

    public static void glSamplerParameterIuivEXT(int i, int i2, int[] iArr) {
        nativeGlSamplerParameterIuivEXT(i, i2, iArr);
    }

    public static void glGetSamplerParameterIivEXT(int i, int i2, int[] iArr) {
        nativeGlGetSamplerParameterIivEXT(i, i2, iArr);
    }

    public static void glGetSamplerParameterIuivEXT(int i, int i2, int[] iArr) {
        nativeGlGetSamplerParameterIuivEXT(i, i2, iArr);
    }

    public static void glTexBufferEXT(int i, int i2, int i3) {
        nativeGlTexBufferEXT(i, i2, i3);
    }

    public static void glTexBufferRangeEXT(int i, int i2, int i3, int i4, int i5) {
        nativeGlTexBufferRangeEXT(i, i2, i3, i4, i5);
    }
}
