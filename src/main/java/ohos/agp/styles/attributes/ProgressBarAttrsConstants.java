...
public class ProgressBarAttrsConstants extends ScrollViewAttrsConstants {
    ...
    @Override // ohos.agp.styles.attributes.ViewAttrsConstants, ohos.agp.styles.attributes.ScrollViewAttrsConstants, ohos.agp.styles.attributes.StackLayoutAttrsConstants
