...
public class InputAttribute {
    ...
    public static final int PATTERN_NULL = 1;
    public static final int PATTERN_NUMBER = 3;
    public static final int PATTERN_PASSWORD = 7;
    public static final int PATTERN_TEXT = 2;
    public int inputEnterKeyType = 0;
    public int inputPattern = 1;
}
