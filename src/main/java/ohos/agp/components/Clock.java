...
public class Clock extends Text {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "AGP_Clock");
    ...
    public /* synthetic */ void lambda$new$0$Clock(Clock clock, long j) {
        ...
        if (this.mClockUpateCount >= 60) {
            HiLog.debug(TAG, "Time: %{public}s, Count: %{public}d", charSequence.toString(), Integer.valueOf(this.mClockUpateCount));
            this.mClockUpateCount = 0;
        }
