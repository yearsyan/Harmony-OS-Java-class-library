...
public class ComponentHolder {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "AGP_ComponentHolder");
    ...
    public Component show() {
        ...
        HiLog.debug(TAG, "add ComponentHolder: index = %{public}d", Integer.valueOf(this.mIndex));
    ...
    public void hide() {
        if (this.mLayoutScatter != null && this.mSolidXml != null && this.mParent != null) {
            ...
            if (this.isLoaded) {
                this.isLoaded = false;
                try {
                    HiLog.debug(TAG, "remove ComponentHolder: index = %{public}d", Integer.valueOf(this.mIndex));
