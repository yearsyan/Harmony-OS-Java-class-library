...
public class PageFlipper extends StackLayout {
    ...
    private native void nativeShowNext(long j);

    private native void nativeShowPrevious(long j);
    ...
    public void showNext() {
        nativeShowNext(this.mNativeViewPtr);
    }

    public void showPrevious() {
        nativeShowPrevious(this.mNativeViewPtr);
    }
