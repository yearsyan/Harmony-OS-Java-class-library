...
public abstract class ComponentContainer extends Component implements ComponentParent {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "AGP_ComponentContainer");
    ...
    public interface ArrangeListener {
        boolean onArrange(int i, int i2, int i3, int i4);
    }
    ...
    private native void nativeRegisterArrange(long j, ArrangeListener arrangeListener);
    ...
    protected static class ComponentContainerCleaner extends Component.ComponentCleaner {
        ...
        @Override // ohos.agp.utils.MemoryCleaner, ohos.agp.components.Component.ComponentCleaner
        public void run() {
    ...
    /* access modifiers changed from: protected */
    public void setArrangeListener(ArrangeListener arrangeListener) {
        if (this.mArrangeListener != arrangeListener) {
            this.mArrangeListener = arrangeListener;
            nativeRegisterArrange(this.mNativeViewPtr, this.mArrangeListener);
        }
    }
    ...
    public void removeComponent(Component component) {
        if (component.getNativeViewPtr() == 0) {
            throw new IllegalStateException("component in layout has already been released.");
    ...
    @Override // ohos.agp.components.ComponentParent, ohos.agp.components.Component
    ...
    public static class LayoutConfig implements Cloneable {
        ...
        public LayoutConfig(Context context, AttrSet attrSet) {
            ...
            attrSet.getAttr("height").ifPresent(new Consumer(context) {
            ...
            attrSet.getAttr("width").ifPresent(new Consumer(context) {
