...
public class SurfaceViewAdapter {
    ...
    private static final HiLogLabel LOG_TAG = new HiLogLabel(3, LogDomain.END, "SurfaceViewAdapter");
    ...
    public SurfaceViewAdapter(ohos.app.Context context) {
        ...
        HiLog.error(LOG_TAG, "SurfaceViewAdapter context is null", new Object[0]);
        throw new IllegalArgumentException("SurfaceViewAdapter context is null");
    }
    ...
    public class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            if (surfaceHolder == null) {
                HiLog.error(SurfaceViewAdapter.LOG_TAG, "SurfaceViewAdapter holder is null", new Object[0]);
                return;
            }
