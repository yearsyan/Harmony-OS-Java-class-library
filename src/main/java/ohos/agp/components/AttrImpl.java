...
public class AttrImpl implements Attr {
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "AGP_AttrImpl");
    Context mContext;
    ...
    private Element parseXmlInGraphic() {
        try {
            ...
            HiLog.debug(TAG, "read graphic element resource id: %{public}d", Integer.valueOf(resId));
    ...
    public int getDimensionValue() {
        ...
        return AttrHelper.convertDimensionToPix(this.mContext, this.getStringValue(), 0);
    }
