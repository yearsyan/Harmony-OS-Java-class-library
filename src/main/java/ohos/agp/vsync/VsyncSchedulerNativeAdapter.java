...
public class VsyncSchedulerNativeAdapter {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(3, LogDomain.END, "VsyncSchedulerNativeAdapter");
    ...
    private static void postRenderThreadInfo(int i, int i2) {
        if (ActivityManager.getService() == null) {
            HiLog.error(TAG, "ActivityManager getService is null", new Object[0]);
            return;
        }
        try {
