...
public class PopupDialog extends BaseDialog {
    ...
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "PopupDialog");
    ...
    public PopupDialog setHasArrow(boolean z) {
        if ((this.mWidth > 0 && this.mHeight > 0) || this.mWidth == -2 || this.mHeight == -2) {
            this.mHasArrow = z;
    ...
    public void setBackColor(Color color) {
        if (color == null) {
            HiLog.error(LABEL, "color of setBackColor is null", new Object[0]);
            return;
        }
    ...
    private static class DrawTaskImpl implements Component.DrawTask {
    ...
    public void onShowing() {
        ...
        if (this.mHasArrow && (directionalLayout = this.mArrowLayout) != null) {
            directionalLayout.setWidth(this.mWidth);
