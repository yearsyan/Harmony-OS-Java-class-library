...
public class ListDialog extends CommonDialog {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "ListDialog");
    ...
    public void destroy() {
        ...
        BaseItemProvider baseItemProvider = this.mProvider;
        if (baseItemProvider != null) {
            baseItemProvider.notifyDataInvalidated();
        }
        super.destroy();
    }

    public void setProvider(BaseItemProvider baseItemProvider) {
    ...
    public class ListDialogProvider extends BaseItemProvider {
