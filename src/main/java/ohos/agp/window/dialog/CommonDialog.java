...
public class CommonDialog extends BaseDialog {
    ...
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "CommonDialog");
    ...
    public CommonDialog setTitleText(String str) {
        HiLog.debug(LABEL, "setTitleText text = %{private}s", str);
    ...
    public CommonDialog setTitleSubText(String str) {
        HiLog.debug(LABEL, "setTitleSubText text = %{private}s", str);
        CommonDialogAttribute commonDialogAttribute = this.mComAttribute;
    ...
    public void onCreate() {
        if (this.mIsUserSetSize || this.mWindow == null || !(this.mWindow instanceof AGPCommonDialogWindow)) {
