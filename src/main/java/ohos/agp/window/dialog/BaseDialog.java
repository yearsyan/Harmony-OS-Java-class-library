...
public class BaseDialog implements IDialog {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "BaseDialog");
    ...
    private boolean mIsTransparentChange;
    protected boolean mIsUserSetSize;
    ...
    public void show() {
        ...
        if (!this.mIsShown) {
            ...
            this.mWindow.setSize(this.mWidth, this.mHeight, this.mIsUserSetSize);
        } else {
            directionalLayout.setVisibility(0);
        }
        try {
            this.mWindow.show();
            callDisplayCallback();
    ...
    public boolean isShowing() {
        ...
        DirectionalLayout directionalLayout = this.mLayout;
        if (directionalLayout == null || directionalLayout.getVisibility() != 0) {
            return false;
        }
        return true;
    }
    ...
    public BaseDialog setTransparent(boolean z) {
        HiLog.debug(LABEL, "setTransparent isEnable = %{private}b", Boolean.valueOf(z));
        if (this.mIsTransparent != z) {
            this.mIsTransparent = z;
            this.mIsTransparentChange = true;
        }
        return this;
    }

    public BaseDialog setCornerRadius(float f) {
        HiLog.debug(LABEL, "setCornerRadius radius = %{private}d", Float.valueOf(f));
        this.mCornerRadius = f;
        return this;
    }

    public BaseDialog setAutoClosable(boolean z) {
        HiLog.debug(LABEL, "setAutoClosable closable = %{private}b", Boolean.valueOf(z));
        this.mAutoClosable = z;
        return this;
    }

    public BaseDialog setDuration(int i) {
        HiLog.debug(LABEL, "setDuration ms = %{private}d", Integer.valueOf(i));
        if (i > 0) {
            this.mDelayTimeMs = i;
        } else {
    ...
    public BaseDialog setSize(int i, int i2) {
        ...
        aGPBaseDialogWindow.setSize(i, i2, this.mIsUserSetSize);
        return this;
    }

    public BaseDialog setAlignment(int i) {
        HiLog.debug(LABEL, "setAlignment value = %{private}d", Integer.valueOf(i));
        this.mAlignment = i;
        return this;
    }

    public BaseDialog setOffset(int i, int i2) {
        HiLog.debug(LABEL, "setOffset offsetX = %{private}d; offsetY = %{private}d", Integer.valueOf(i), Integer.valueOf(i2));
        this.mX = i;
        this.mY = i2;
        return this;
    }
        ...
        if (!this.mCreated) {
            ...
            this.mWindow.setDialogListener(new AGPBaseDialogWindow.DialogListener() {
                ...
                public boolean isTouchOutside() {
                    ...
                    if (!BaseDialog.this.mAutoClosable || !BaseDialog.this.mIsShown) {
                        return false;
                    }
                    BaseDialog.this.destroy();
                    return true;
    ...
    private void setWindowTransparent() {
        if (this.mIsTransparentChange) {
            ...
            this.mIsTransparentChange = false;
            this.mWindow.setTransparent(this.mIsTransparent);
        }
    }

    private void setWindowCornerRadius() {
        if (this.mCornerRadius > 0.0f && !this.mIsTransparent) {
    ...
    private void processLayoutConflicts() {
        ...
        if (component != null) {
            ...
            HiLog.debug(LABEL, "mContentLayout w=%{public}d,h=%{public}d", Integer.valueOf(layoutConfig.width), Integer.valueOf(layoutConfig.height));
    ...
    public void onShowing() {
        ...
        HiLog.debug(LABEL, "onShowing winHeight = %{private}d, winWidth = %{private}d", Integer.valueOf(i3), Integer.valueOf(i4));
