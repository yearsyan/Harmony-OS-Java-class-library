...
public class AGPToastWindow extends AGPBaseDialogWindow {
    ...
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "AGPToastWindow");
    ...
    public void setDuration(int i) {
        HiLog.debug(LABEL, "setDuration duration = %{private}d", Integer.valueOf(i));
    ...
    public void setGravity(int i) {
        HiLog.debug(LABEL, "setGravity value = %{private}d", Integer.valueOf(i));
