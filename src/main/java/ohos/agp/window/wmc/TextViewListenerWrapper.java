...
public class TextViewListenerWrapper implements TextInputConnection.ITextViewListener {
    private static final HiLogLabel LABEL = new HiLogLabel(3, LogDomain.END, "TextViewListenerWrapper");
    ...
    public boolean sendKeyEvent(KeyEvent keyEvent) {
        ...
        if (multimodalEvent instanceof ohos.multimodalinput.event.KeyEvent) {
            return this.listener.sendKeyEvent((ohos.multimodalinput.event.KeyEvent) multimodalEvent);
        }
    ...
    public static int convertToInputType(int i) {
        ...
        HiLog.debug(LABEL, "the inputType is %{public}d", Integer.valueOf(i2));
        return i2;
    }

    public static int convertToEnterKeyType(int i) {
        int i2 = 3;
        if (i == 2) {
            i2 = 2;
        } else if (i == 3) {
        ...
        HiLog.debug(LABEL, "the enterKeyType is %{public}d", Integer.valueOf(i2));
        return i2;
    }
    ...
    public static int convertToImeOption(int i) {
        ...
        HiLog.debug(LABEL, "the imeOption is %{public}d", Integer.valueOf(i2));
        return i2;
    }
}
