...
public class Color {
    ...
    public static int getIntColor(String str) {
        if (str == null || str.equals("")) {
            throw new IllegalArgumentException("colorStr is null or empty!");
            ...
            try {
                ...
                if (str.length() == 7) {
                    ...
                    throw new IllegalArgumentException("length of colorStr is invalid!");
                }
                return (int) parseLong;
            } catch (NumberFormatException unused) {
                throw new IllegalArgumentException("format of colorStr is invalid!");
            }
        } else {
