...
public class Matrix {
    ...
    public boolean equals(Object obj) {
        ...
        return getNativeHandle() == ((Matrix) obj).getNativeHandle();
    }

    public int hashCode() {
        return Objects.hash(Long.valueOf(this.mNativeMatrixHandle));
    }
    ...
    private void getMatrixString(StringBuilder sb) {
        float[] data = getData();
        sb.append('[');
        sb.append(data[0]);
        sb.append(", ");
    ...
    private boolean isPointArrayIllegal(float[] fArr, int i, float[] fArr2, int i2, int i3) {
        if (!(fArr == null || fArr2 == null)) {
            ...
            int i5 = i + i4;
            int i6 = i4 + i2;
            return (((((i | i3) | i2) | i5) | i6) < 0) || i5 > fArr.length || i6 > fArr2.length;
        }
    }
}
