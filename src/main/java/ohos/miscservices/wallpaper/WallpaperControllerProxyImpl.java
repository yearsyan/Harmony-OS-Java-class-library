...
public class WallpaperControllerProxyImpl {
    ...
    public ohos.media.image.PixelMap getPixelmap(int r8) {
        /*
        // Method dump skipped, instructions count: 202
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.miscservices.wallpaper.WallpaperControllerProxyImpl.getPixelmap(int):ohos.media.image.PixelMap");
    }
