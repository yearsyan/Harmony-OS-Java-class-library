...
public class DownloadConfig implements Sequenceable {
    ...
    public static DownloadConfig readFromParcel(Parcel parcel, Context context) {
        ...
        builder.setPath("Download", uri.length() > 0 ? uri.substring(uri.lastIndexOf("/") + 1) : "");
    ...
    public static class Builder {
        ...
        private Uri getDefaultDownloadStoragePath(Uri uri) {
            ...
            return DownloadUtils.createDownloadPathInPrivateDir(this.context, "Download", uri2.length() > 0 ? uri2.substring(uri2.lastIndexOf("/") + 1) : "");
        }
