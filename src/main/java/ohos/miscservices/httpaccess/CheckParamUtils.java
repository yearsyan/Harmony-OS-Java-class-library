...
public class CheckParamUtils {
    ...
    private static boolean isValidUploadFile(java.util.List<ohos.miscservices.httpaccess.data.FormFileData> r3) {
        /*
            r0 = 0
        ...
        L_0x000e:
            ...
            ohos.miscservices.httpaccess.data.FormFileData r1 = (ohos.miscservices.httpaccess.data.FormFileData) r1
        ...
        L_0x002f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.miscservices.httpaccess.CheckParamUtils.isValidUploadFile(java.util.List):boolean");
    }
