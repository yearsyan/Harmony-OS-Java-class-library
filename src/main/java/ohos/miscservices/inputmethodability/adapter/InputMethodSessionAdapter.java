...
public class InputMethodSessionAdapter {
    ...
    public class IInputMethodSessionImpl extends IInputMethodSession.Stub implements Handler.Callback {
        ...
        public void updateCursorAnchorInfo(CursorAnchorInfo cursorAnchorInfo) {
            ...
            handler.sendMessage(handler.obtainMessage(85, cursorAnchorInfo));
        }

        public void updateExtractedText(int i, ExtractedText extractedText) {
            Handler handler = this.mHandler;
            handler.sendMessage(handler.obtainMessage(70, i, 0, extractedText));
        }

        public void viewClicked(boolean z) {
            Handler handler = this.mHandler;
            handler.sendMessage(handler.obtainMessage(105, Integer.valueOf(z ? 1 : 0)));
        }

        public void updateCursor(Rect rect) {
            Handler handler = this.mHandler;
            handler.sendMessage(handler.obtainMessage(80, rect));
        }
        ...
        public void updateSelection(int i, int i2, int i3, int i4, int i5, int i6) {
            ...
            obtain.argi6 = i6;
            Handler handler = this.mHandler;
            handler.sendMessage(handler.obtainMessage(75, obtain));
        }
        ...
        public void displayCompletions(CompletionInfo[] completionInfoArr) {
            Handler handler = this.mHandler;
            handler.sendMessage(handler.obtainMessage(65, completionInfoArr));
        }

        public void toggleSoftInput(int i, int i2) {
            Handler handler = this.mHandler;
            handler.sendMessage(handler.obtainMessage(95, i, i2));
        }
    }
