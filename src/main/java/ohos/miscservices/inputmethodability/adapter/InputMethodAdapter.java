...
public class InputMethodAdapter {
    ...
    public class InputMethodCoreSkeleton extends RemoteObject implements IInputMethodCore {
        ...
        private boolean transactToStartInput(MessageParcel messageParcel, MessageParcel messageParcel2) {
            ...
            HiLog.debug(this.subLabel, "TRANSACTION_START_INPUT flag missMethods=%{public}d", Integer.valueOf(readInt));
        ...
        private Optional<InputChannel> readInputChannel(MessageParcel messageParcel) {
            ...
            obtain.writeFileDescriptor(readFileDescriptor);
            if (readFileDescriptor != null) {
                MessageParcel.closeFileDescriptor(readFileDescriptor);
                HiLog.debug(this.subLabel, "closeFileDescriptor", new Object[0]);
            }
