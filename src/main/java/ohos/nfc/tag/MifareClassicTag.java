...
public class MifareClassicTag extends TagManager {
    ...
    private MifareClassicTag(ohos.nfc.tag.TagInfo r8) {
        /*
        // Method dump skipped, instructions count: 157
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.nfc.tag.MifareClassicTag.<init>(ohos.nfc.tag.TagInfo):void");
    }
