...
public interface INfcController extends IRemoteBroker {
    ...
    void setReaderMode(IRemoteObject iRemoteObject, NfcController.ReaderModeCallback readerModeCallback, int i, PacMapEx pacMapEx, NfcController nfcController) throws RemoteException;
}
