...
public class NotificationActionButton implements Sequenceable {
    ...
    public List<NotificationUserInput> getMimeTypeOnlyUserInputs() {
        ArrayList<Sequenceable> sequenceableList = this.extras.getSequenceableList(ONLY_USER_INPUTS);
        if (sequenceableList == null) {
            return null;
        }
        ArrayList arrayList = new ArrayList();
        Iterator<Sequenceable> it = sequenceableList.iterator();
        while (it.hasNext()) {
            Sequenceable next = it.next();
            if (next instanceof NotificationUserInput) {
                arrayList.add((NotificationUserInput) next);
            }
        }
    ...
    public static final class Builder {
        ...
        public NotificationActionButton build() {
            ...
            ArrayList<Sequenceable> arrayList = new ArrayList<>();
            ArrayList<Sequenceable> sequenceableList = this.extras.getSequenceableList(NotificationActionButton.ONLY_USER_INPUTS);
            if (sequenceableList != null) {
                Iterator<Sequenceable> it = sequenceableList.iterator();
                while (it.hasNext()) {
                    Sequenceable next = it.next();
