...
public class IntentAgentUtil {
    ...
    private static IRemoteObject convertToRemoteObject(Object obj) {
        ...
        Optional<IRemoteObject> translateToIRemoteObject = IPCAdapter.translateToIRemoteObject(target.asBinder());
        if (translateToIRemoteObject.isPresent()) {
            return translateToIRemoteObject.get();
        }
        return null;
    }
    ...
    private static PendingIntent getFromParcel(MessageParcel messageParcel) {
        ...
        Optional<Object> translateToIBinder = IPCAdapter.translateToIBinder(readRemoteObject);
