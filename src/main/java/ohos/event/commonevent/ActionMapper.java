...
public class ActionMapper {
    private static final Map<String, String> ACTION_MAP = Collections.unmodifiableMap(new HashMap<String, String>() {
...

        {
            ...
            put("android.net.wifi.WIFI_STATE_CHANGED", "usual.event.wifi.POWER_STATE");
            put("android.net.wifi.SCAN_RESULTS", "usual.event.wifi.SCAN_FINISHED");
            put("android.net.wifi.RSSI_CHANGED", "usual.event.wifi.RSSI_VALUE");
            put("android.net.wifi.STATE_CHANGE", "usual.event.wifi.CONN_STATE");
            put("android.net.wifi.WIFI_AP_STATE_CHANGED", "usual.event.wifi.HOTSPOT_STATE");
            put(ActionMapper.BROADCAST_KEY, "usual.event.wifi.mplink.STATE_CHANGE");
            put("android.net.wifi.p2p.CONNECTION_STATE_CHANGE", "usual.event.wifi.p2p.CONN_STATE_CHANGE");
            put(ActionMapper.ACTION_WIFI_AP_STA_JOIN, "usual.event.wifi.WIFI_HS_STA_JOIN");
            put(ActionMapper.ACTION_WIFI_AP_STA_LEAVE, "usual.event.wifi.WIFI_HS_STA_LEAVE");
            put("android.net.wifi.p2p.STATE_CHANGED", "usual.event.wifi.p2p.STATE_CHANGE");
            put("android.net.wifi.p2p.PEERS_CHANGED", "usual.event.wifi.p2p.DEVICES_CHANGE");
            put("android.net.wifi.p2p.DISCOVERY_STATE_CHANGE", "usual.event.wifi.p2p.PEER_DISCOVERY_STATE_CHANGE");
            put("android.net.wifi.p2p.THIS_DEVICE_CHANGED", "usual.event.wifi.p2p.CURRENT_DEVICE_CHANGE");
            put("android.net.wifi.p2p.PERSISTENT_GROUPS_CHANGED", "usual.event.wifi.p2p.GROUP_STATE_CHANGED");
            ...
            put("android.nfc.action.ADAPTER_STATE_CHANGED", "usual.event.nfc.action.ADAPTER_STATE_CHANGED");
            put(ActionMapper.ACTION_RF_FIELD_ON_DETECTED, "usual.event.nfc.action.RF_FIELD_ON_DETECTED");
            put(ActionMapper.ACTION_RF_FIELD_OFF_DETECTED, "usual.event.nfc.action.RF_FIELD_OFF_DETECTED");
