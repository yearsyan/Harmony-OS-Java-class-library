...
public class ImageSuperResolution extends VisionBase implements IImageSuperResolution {
    ...
    public int prepare() {
        ...
        if (prepare == 0 && this.ability != null) {
            ...
            if (this.ability.getInt("engine_version") >= 2) {
                this.maxLongEdgeSize1X = this.ability.getInt(SrParamKey.MAX_LONG_EDGE_1X);
                this.maxShortEdgeSize1X = this.ability.getInt(SrParamKey.MAX_SHORT_EDGE_1X);
                this.maxLongEdgeSize3X = this.ability.getInt(SrParamKey.MAX_LONG_EDGE_3X);
                this.maxShortEdgeSize3X = this.ability.getInt(SrParamKey.MAX_SHORT_EDGE_3X);
                ...
                this.maxLongEdgeSize1X = this.ability.getInt(SrParamKey.MAX_LONG_EDGE);
                this.maxShortEdgeSize1X = this.ability.getInt(SrParamKey.MAX_SHORT_EDGE);
    ...
    @Override // ohos.ai.cv.sr.IImageSuperResolution
    ...
    private int checkBitmap(Bitmap bitmap, float f) {
        ...
        if (Math.abs(f - 1.0f) < 1.0E-6f) {
            ...
            return 200;
        } else if (Math.abs(f - 3.0f) >= 1.0E-6f) {
