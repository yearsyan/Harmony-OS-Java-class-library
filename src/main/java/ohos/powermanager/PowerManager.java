...
import ohos.poweradapter.PowerAdapter;
...
public class PowerManager {
    ...
    static {
        try {
            HiLog.info(LOG_LABEL, "load libpowermgr_jni.z.so", new Object[0]);
            System.loadLibrary("powermgr_jni.z");
        } catch (UnsatisfiedLinkError unused) {
            HiLog.error(LOG_LABEL, "Could not load libpowermgr_jni.z.so", new Object[0]);
        }
    }
    ...
    public final class RunningLock {
        ...
        RunningLock(String str, RunningLockType runningLockType) {
            ...
            this.nativeRunningLock = PowerManager.nativeCreateRunningLock(str, runningLockType.value, 0);
        ...
        public void lock(long j) {
            ...
            long nativeLock = PowerManager.nativeLock(this.nativeRunningLock, j);
            HiLog.debug(PowerManager.LOG_LABEL, "lock timeOutMs = %{public}d, ret = %{public}d", Long.valueOf(j), Long.valueOf(nativeLock));
        }
        ...
        public void unLock() {
            ...
            long nativeUnLock = PowerManager.nativeUnLock(this.nativeRunningLock);
            HiLog.debug(PowerManager.LOG_LABEL, "unlock ret = %{public}d", Long.valueOf(nativeUnLock));
        }
    ...
    public boolean isScreenOn() {
        return PowerAdapter.isInteractive();
    }
}
