...
public class MessageParcel extends Parcel {
    ...
    private Exception createException(int i, String str) {
        ...
        switch (i) {
            case EXC_PARCEL_CAPACITY_ERROR /*{ENCODED_INT: -14}*/:
                return new ParcelException(str);
            case EXC_CLASS_CAST /*{ENCODED_INT: -13}*/:
                return new ClassCastException(str);
            case EXC_ARRAY_STORE /*{ENCODED_INT: -12}*/:
                return new ArrayStoreException(str);
            case EXC_NEGATIVE_ARRAY_SIZE /*{ENCODED_INT: -11}*/:
    ...
    public Ashmem readAshmem() {
        return new Ashmem(nativeReadAshmem());
    }
