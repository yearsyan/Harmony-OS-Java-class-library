...
public class RemoteProxy implements IRemoteObject {
    ...
    public void dump(FileDescriptor fileDescriptor, String[] strArr) throws RemoteException {
        dumpFile(fileDescriptor, strArr, false);
    }

    @Override // ohos.rpc.IRemoteObject
    public void slowPathDump(FileDescriptor fileDescriptor, String[] strArr) throws RemoteException {
        dumpFile(fileDescriptor, strArr, true);
    }

    private void dumpFile(FileDescriptor fileDescriptor, String[] strArr, boolean z) throws RemoteException {
