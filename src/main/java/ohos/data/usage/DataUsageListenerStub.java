...
public class DataUsageListenerStub extends RemoteObject implements IDataUsageListener {
    ...
    public boolean onRemoteRequest(int i, MessageParcel messageParcel, MessageParcel messageParcel2, MessageOption messageOption) throws RemoteException {
        HiLog.info(LABEL, "call DataUsageListenerStub, code is %{public}d", Integer.valueOf(i));
        if (i == 1) {
    ...
    public void onStorageStateChanged(String str, String str2, String str3) {
        HiLog.info(LABEL, "path is %s, oldState is %s, newState is %s", str, str2, str3);
    ...
    public void onVolumeStateChanged(VolumeView volumeView, int i, int i2) {
        HiLog.info(LABEL, "volume type is %d, state %d -> %d", Integer.valueOf(volumeView.getType()), Integer.valueOf(i), Integer.valueOf(i2));
