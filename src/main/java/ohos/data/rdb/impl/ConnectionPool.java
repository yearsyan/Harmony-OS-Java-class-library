...
public class ConnectionPool {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0033, code lost:
        if (r4.getConnection() != null) goto L_0x0042;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0035, code lost:
        java.util.concurrent.locks.LockSupport.park(1000);
        java.lang.Thread.interrupted();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0046, code lost:
        return r4.getConnection();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public ohos.data.rdb.impl.Connection acquireConnection(java.lang.String r4, boolean r5) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.connectionLock
            monitor-enter(r0)
            r3.checkIfClosed()     // Catch:{ all -> 0x0047 }
            r1 = 0
            if (r5 == 0) goto L_0x000d
            ohos.data.rdb.impl.Connection r1 = r3.tryAcquireReadConnection(r4)     // Catch:{ all -> 0x0047 }
        L_0x000d:
            if (r1 != 0) goto L_0x0013
            ohos.data.rdb.impl.Connection r1 = r3.tryAcquireWriteConnection()     // Catch:{ all -> 0x0047 }
        L_0x0013:
            if (r1 == 0) goto L_0x0017
            monitor-exit(r0)     // Catch:{ all -> 0x0047 }
            return r1
        L_0x0017:
            ohos.data.rdb.impl.ConnectionPool$Waiter r4 = new ohos.data.rdb.impl.ConnectionPool$Waiter     // Catch:{ all -> 0x0047 }
            java.lang.Thread r1 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x0047 }
            r2 = 1
            r4.<init>(r1, r2)     // Catch:{ all -> 0x0047 }
            if (r5 == 0) goto L_0x0029
            java.util.concurrent.PriorityBlockingQueue<ohos.data.rdb.impl.ConnectionPool$Waiter> r3 = r3.waitReadQueue     // Catch:{ all -> 0x0047 }
            r3.add(r4)     // Catch:{ all -> 0x0047 }
            goto L_0x002e
        L_0x0029:
            java.util.concurrent.PriorityBlockingQueue<ohos.data.rdb.impl.ConnectionPool$Waiter> r3 = r3.waitWriteQueue     // Catch:{ all -> 0x0047 }
            r3.add(r4)     // Catch:{ all -> 0x0047 }
        L_0x002e:
            monitor-exit(r0)     // Catch:{ all -> 0x0047 }
        L_0x002f:
            ohos.data.rdb.impl.Connection r3 = r4.getConnection()
        ...
        L_0x0047:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: ohos.data.rdb.impl.ConnectionPool.acquireConnection(java.lang.String, boolean):ohos.data.rdb.impl.Connection");
    }
    ...
    public void closeConnection(Connection connection) {
        try {
            ...
            HiLog.error(LABEL, "close releaseConnection failed. %{public}s", e.getMessage());
        }
    }
        ...
        synchronized (this.connectionLock) {
            if (this.acquiredConnections.isEmpty()) {
                ...
                if (!SqliteDatabaseUtils.renameFile(str2, str)) {
                    HiLog.info(LABEL, "Rename failed. originalPath = %{private}s, backupPath = %{private}s ", str, str2);
    ...
    public DatabaseFileSecurityLevel getDatabaseFileSecurityLevel() {
        return this.config.getDatabaseFileSecurityLevel();
    }
