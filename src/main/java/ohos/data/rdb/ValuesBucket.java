...
public class ValuesBucket implements Sequenceable {
    ...
    public Long getLong(String str) {
        ...
        if (obj instanceof CharSequence) {
            try {
                ...
                HiLog.info(LABEL, "Cannot parse Long value for %{private}s at column name %{private}s.", obj, str);
                return null;
            }
        } else {
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Long value: %{private}s.", str, obj);
            return null;
        }
    }
    ...
    public Integer getInteger(String str) {
        ...
        if (obj instanceof CharSequence) {
            try {
                ...
                HiLog.info(LABEL, "Cannot parse Integer value for %{private}s at column name %{private}s.", obj, str);
                return null;
            }
        } else {
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Integer value: %{private}s.", str, obj);
            return null;
        }
    }
    ...
    public Short getShort(String str) {
        ...
        if (obj instanceof CharSequence) {
            try {
                ...
                HiLog.info(LABEL, "Cannot parse Short value for %{private}s at column name %{private}s.", obj, str);
                return null;
            }
        } else {
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Short value: %{private}s.", str, obj);
            return null;
        }
    }
    ...
    public Byte getByte(String str) {
        ...
        if (obj instanceof CharSequence) {
            try {
                ...
                HiLog.info(LABEL, "Cannot parse Byte value for %{private}s at column name %{private}s.", obj, str);
                return null;
            }
        } else {
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Byte value: %{private}s.", str, obj);
            return null;
        }
    }
    ...
    public Double getDouble(String str) {
        ...
        if (obj instanceof CharSequence) {
            try {
                ...
                HiLog.info(LABEL, "Cannot parse Double value for %{private}s at column name %{private}s.", obj, str);
                return null;
            }
        } else {
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Double value: %{private}s.", str, obj);
            return null;
        }
    }
    ...
    public Float getFloat(String str) {
        ...
        if (obj instanceof CharSequence) {
            try {
                ...
                HiLog.info(LABEL, "Cannot parse Float value for %{private}s at column name %{private}s.", obj, str);
                return null;
            }
        } else {
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Float value: %{private}s.", str, obj);
            return null;
        }
    }
    ...
    public Boolean getBoolean(String str) {
        ...
        if (obj instanceof CharSequence) {
            ...
            HiLog.info(LABEL, "Cannot cast value for %{private}s to a Boolean value: %{private}s.", str, obj);
            return null;
        }
    }
