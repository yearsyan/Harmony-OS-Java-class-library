...
public class StoreConfig {
    ...
    public static StoreConfig newDefaultConfig(String str) {
        return new Builder().setName(str).setStorageMode(StorageMode.MODE_DISK).setJournalMode(null).setSyncMode(null).setEncryptKey(null).setReadOnly(false).setDatabaseFileType(DatabaseFileType.NORMAL).setDatabaseFileSecurityLevel(null).build();
    }

    public static StoreConfig newMemoryConfig() {
        return new Builder().setName(null).setStorageMode(StorageMode.MODE_MEMORY).setJournalMode(null).setSyncMode(null).setEncryptKey(null).setReadOnly(false).setDatabaseFileType(null).setDatabaseFileSecurityLevel(null).build();
    }

    public static StoreConfig newReadOnlyConfig(String str) {
        return new Builder().setName(str).setStorageMode(StorageMode.MODE_DISK).setJournalMode(null).setSyncMode(null).setEncryptKey(null).setReadOnly(true).setDatabaseFileType(DatabaseFileType.NORMAL).setDatabaseFileSecurityLevel(null).build();
    }
    ...
    public static final class Builder {
        ...
        public Builder(StoreConfig storeConfig) {
            ...
            this.databaseFileSecurityLevel = storeConfig.databaseFileSecurityLevel;
        }
