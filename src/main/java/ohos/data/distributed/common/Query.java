...
public class Query {
    ...
    private static final String SUGGEST_INDEX = "^SUGGEST_INDEX";
    ...
    public Query setSuggestIndex(String str) {
        if (!StringUtils.isEmpty(str)) {
            this.sqlLike.append(" ");
            this.sqlLike.append(SUGGEST_INDEX);
            this.sqlLike.append(" ");
            this.sqlLike.append(escapeSpace(str));
            return this;
        }
        LogPrint.error(LABEL, "setSuggestIndex Invalid index param", new Object[0]);
        throw new IllegalArgumentException("setSuggestIndex Invalid index param");
    }
