...
public class ExecutorUtils {
    ...
    public static ExecutorService getExecutorService(String str, int i, int i2, long j, Integer num) {
        int i3;
        HiLog.debug(LABEL, "start. param task serviceName is %{public}s, corePoolSize is %{public}d, maxPoolSize is %{public}d, keepAliveTime is %{public}d, blockQueueSize is %{public}d", str, Integer.valueOf(i), Integer.valueOf(i2), Long.valueOf(j), num);
        if (num == null) {
