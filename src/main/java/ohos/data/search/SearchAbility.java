...
public class SearchAbility {
    ...
    public SearchAbility(Context context) {
        ...
        HiLog.info(LABEL, "calling bundle name, %{public}s", this.callingBundleName);
    ...
    private void disConnectSearchService() {
        ...
        if (this.service == null) {
            ...
            try {
                ...
                try {
                    ...
                    HiLog.error(LABEL, "Failed to insert index, read reply memory error, errMsg: %s", e.getMessage());
                    ...
                    str = 0;
                    sharedMemory4 = sharedMemory;
                    HiLog.error(LABEL, "Failed to insert index, the data is out of memory, errMsg: %s", e2.getMessage());
                    sharedMemory2 = str;
                    SharedMemoryHelper.releaseMemory(sharedMemory4);
                    SharedMemoryHelper.releaseMemory(sharedMemory2);
                    return list;
        ...
        if (this.service == null) {
            ...
            try {
                ...
                try {
                    ...
                    sharedMemory3 = null;
                    sharedMemory4 = sharedMemory;
                    HiLog.error(LABEL, "Failed to update index, read reply memory error, errMsg: %s", e.getMessage());
                    sharedMemory2 = sharedMemory3;
                    SharedMemoryHelper.releaseMemory(sharedMemory4);
                    SharedMemoryHelper.releaseMemory(sharedMemory2);
                    return list;
                    ...
                    str = 0;
                    sharedMemory4 = sharedMemory;
                    HiLog.error(LABEL, "Failed to update index, the data is out of memory, errMsg: %s", e2.getMessage());
                    sharedMemory2 = str;
                    SharedMemoryHelper.releaseMemory(sharedMemory4);
                    SharedMemoryHelper.releaseMemory(sharedMemory2);
                    return list;
        ...
        if (this.service == null) {
            ...
            try {
                ...
                try {
                    ...
                    sharedMemory3 = null;
                    sharedMemory4 = sharedMemory;
                    HiLog.error(LABEL, "Failed to delete index, read reply memory error, errMsg: %s", e.getMessage());
                    sharedMemory2 = sharedMemory3;
                    SharedMemoryHelper.releaseMemory(sharedMemory4);
                    SharedMemoryHelper.releaseMemory(sharedMemory2);
                    return list;
                    ...
                    str = 0;
                    sharedMemory4 = sharedMemory;
                    HiLog.error(LABEL, "Failed to delete index, the data is out of memory, errMsg: %s", e2.getMessage());
                    sharedMemory2 = str;
                    SharedMemoryHelper.releaseMemory(sharedMemory4);
                    SharedMemoryHelper.releaseMemory(sharedMemory2);
                    return list;
    ...
    public int setIndexForm(String str, int i, List<IndexForm> list, IndexSchemaType indexSchemaType) {
        ...
        return this.service.setIndexFormSchema(str, i, ConvertUtils.indexForms2InnerIndexForms(list), indexSchemaType.getSchemaCode(), this.callingBundleName);
    }
}
