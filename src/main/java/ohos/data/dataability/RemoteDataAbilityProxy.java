...
public class RemoteDataAbilityProxy implements IDataAbility, IRemoteDataAbility {
    ...
    public int batchInsert(Uri uri, ValuesBucket[] valuesBucketArr) throws DataAbilityRemoteException {
        ...
        try {
            C0000Bytrace.startTrace(68719476736L, "remote batchInsert");
            ...
            if (!this.remote.sendRequest(2, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    HiLog.info(LABEL, "batchInsert transact with new server version as %{private}d : %{private}s", Integer.valueOf(obtain2.readInt()), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readInt = obtain2.readInt();
                } catch (OldProxyMainVersionException | OldProxyNotSupportException e2) {
                    HiLog.error(LABEL, "batchInsert transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(obtain2.readInt()), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote batchInsert");
                return readInt;
            }
            obtain2.reclaim();
            obtain.reclaim();
    ...
    public PacMap call(String str, String str2, PacMap pacMap) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote call");
            writeVersionToParcel(obtain, 1);
            ...
            if (!this.remote.sendRequest(3, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    HiLog.info(LABEL, "call transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    ...
                    HiLog.error(LABEL, "call transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote call");
    ...
    public int delete(Uri uri, DataAbilityPredicates dataAbilityPredicates) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote delete");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            ...
            if (!this.remote.sendRequest(4, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.info(LABEL, "delete transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readInt = obtain2.readInt();
                    ...
                    HiLog.error(LABEL, "delete transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt3), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote delete");
                return readInt;
            }
            obtain2.reclaim();
            obtain.reclaim();
    ...
    public DataAbilityResult[] executeBatch(ArrayList<DataAbilityOperation> arrayList) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote executeBatch");
            writeVersionToParcel(obtain, 1);
            ...
            if (!this.remote.sendRequest(5, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    HiLog.info(LABEL, "executeBatch transact with new server version as %{private}d : %{private}s", Integer.valueOf(obtain2.readInt()), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    createAbilityResultFromParcel = this.createAbilityResultFromParcel(obtain2);
                } catch (OldProxyMainVersionException | OldProxyNotSupportException e2) {
                    HiLog.error(LABEL, "executeBatch transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(obtain2.readInt()), e2.getMessage());
                    createAbilityResultFromParcel = new DataAbilityResult[0];
                }
            }
            obtain2.reclaim();
            obtain.reclaim();
            C0000Bytrace.finishTrace(68719476736L, "remote executeBatch");
    ...
    public String[] getFileTypes(Uri uri, String str) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote getFileTypes");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            obtain.writeString(str);
            if (!this.remote.sendRequest(6, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    int readInt = obtain2.readInt();
                    HiLog.info(LABEL, "getFileTypes transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readStringArray = obtain2.readStringArray();
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.error(LABEL, "getFileTypes transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                    readStringArray = new String[0];
                }
            }
            obtain2.reclaim();
            obtain.reclaim();
            C0000Bytrace.finishTrace(68719476736L, "remote getFileTypes");
    ...
    public String getType(Uri uri) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote getType");
            writeVersionToParcel(obtain, 1);
            if (!this.remote.sendRequest(7, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    int readInt = obtain2.readInt();
                    HiLog.info(LABEL, "getType transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readString = obtain2.readString();
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.error(LABEL, "getType transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote getType");
                return readString;
            }
            obtain2.reclaim();
            obtain.reclaim();
    ...
    public int insert(Uri uri, ValuesBucket valuesBucket) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote insert");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            ...
            if (!this.remote.sendRequest(8, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.info(LABEL, "insert transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readInt = obtain2.readInt();
                    ...
                    int readInt3 = obtain2.readInt();
                    HiLog.error(LABEL, "insert transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt3), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote insert");
                return readInt;
            }
            obtain2.reclaim();
            obtain.reclaim();
    ...
    public ResultSet query(Uri uri, String[] strArr, DataAbilityPredicates dataAbilityPredicates) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote query");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            if (strArr == null) {
                obtain.writeInt(0);
            ...
            if (!this.remote.sendRequest(9, obtain, obtain2, new MessageOption())) {
                ...
                try {
                    ...
                    int readInt = obtain2.readInt();
                    HiLog.info(LABEL, "query transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.error(LABEL, "query transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote query");
    ...
    public void registerObserver(Uri uri, Object obj) {
        if (obj instanceof IDataAbilityObserver) {
            HiLog.info(LABEL, "registerObserver start, transaction id = %{public}d", 10);
            MessageParcel obtain = MessageParcel.obtain();
            MessageParcel obtain2 = MessageParcel.obtain();
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            ...
            try {
                ...
                if (sendRequest) {
                    ...
                    HiLog.debug(LABEL, "put observer:%{private}s, stub:%{private}s", iDataAbilityObserver, remoteDataAbilityObserverStub);
                } else {
                    HiLog.error(LABEL, "register transact fail", new Object[0]);
                }
            } catch (OldProxyWithCompatibleResponseException | OldProxyWithDefaultReplyException e) {
                int readInt = obtain2.readInt();
                HiLog.info(LABEL, "registerObserver transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                if (e instanceof OldProxyWithCompatibleResponseException) {
                    SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                }
            } catch (OldProxyMainVersionException | OldProxyNotSupportException e2) {
                int readInt2 = obtain2.readInt();
                HiLog.error(LABEL, "registerObserver transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
            } catch (InterruptedException | RemoteException e3) {
                HiLog.error(LABEL, "registerObserver remote exception: %{private}s", e3.getMessage());
            } catch (Throwable th) {
                this.observerLock.unlock();
                obtain2.reclaim();
                obtain.reclaim();
                ...
                try {
                    ...
                    if (remoteDataAbilityObserverStub == null) {
                        ...
                        if (sendRequest) {
                            ...
                            HiLog.debug(LABEL, "remove observer:%{private}s", obj);
                        } else {
                    ...
                    int readInt = obtain2.readInt();
                    HiLog.info(LABEL, "unregisterObserver transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                } catch (OldProxyMainVersionException | OldProxyNotSupportException e2) {
                    int readInt2 = obtain2.readInt();
                    HiLog.error(LABEL, "unregisterObserver transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                } catch (InterruptedException | RemoteException e3) {
                    HiLog.error(LABEL, "unregisterObserver remote exception: %{private}s", e3.getMessage());
                } catch (Throwable th) {
                    this.observerLock.unlock();
                    obtain2.reclaim();
                    obtain.reclaim();
    ...
    public int update(Uri uri, ValuesBucket valuesBucket, DataAbilityPredicates dataAbilityPredicates) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote update");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            obtain.writeSequenceable(valuesBucket);
            obtain.writeSequenceable(dataAbilityPredicates);
            ...
            if (!sendRequest) {
                ...
                try {
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.info(LABEL, "update transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readInt = obtain2.readInt();
                    ...
                    int readInt3 = obtain2.readInt();
                    HiLog.error(LABEL, "update transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt3), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote update");
                return readInt;
            }
            obtain2.reclaim();
            obtain.reclaim();
    ...
    public Uri normalizeUri(Uri uri) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote normalizeUri");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            ...
            if (!sendRequest) {
                ...
                try {
                    ...
                    int readInt = obtain2.readInt();
                    HiLog.info(LABEL, "normalizeUri transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readFromParcel = Uri.readFromParcel(obtain2);
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.error(LABEL, "normalizeUri transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote normalizeUri");
    ...
    public Uri denormalizeUri(Uri uri) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote denormalizeUri");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            ...
            if (!sendRequest) {
                ...
                try {
                    ...
                    int readInt = obtain2.readInt();
                    HiLog.info(LABEL, "denormalizeUri transact with new server version as %{private}d : %{private}s", Integer.valueOf(readInt), e.getMessage());
                    if (e instanceof OldProxyWithCompatibleResponseException) {
                        SqliteExceptionUtils.readExceptionFromParcel(obtain2);
                    }
                    readFromParcel = Uri.readFromParcel(obtain2);
                    ...
                    int readInt2 = obtain2.readInt();
                    HiLog.error(LABEL, "denormalizeUri transact fail with new server version as %{private}d : %{private}s", Integer.valueOf(readInt2), e2.getMessage());
                }
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote denormalizeUri");
                return readFromParcel;
            }
            obtain2.reclaim();
            obtain.reclaim();
    ...
    public boolean reload(Uri uri, PacMap pacMap) throws DataAbilityRemoteException {
        ...
        MessageParcel obtain2 = MessageParcel.obtain();
        try {
            C0000Bytrace.startTrace(68719476736L, "remote reload");
            writeVersionToParcel(obtain, 1);
            obtain.writeSequenceable(uri);
            obtain.writeSequenceable(pacMap);
            ...
            if (!sendRequest) {
                ...
                obtain2.reclaim();
                obtain.reclaim();
                C0000Bytrace.finishTrace(68719476736L, "remote reload");
                return readBoolean;
            }
            obtain2.reclaim();
            obtain.reclaim();
