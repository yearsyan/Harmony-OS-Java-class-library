...
public interface IHOSPSearchServiceCall extends IInterface {
    ...
    public static final int TRANSACTION_setIndexFormSchema = 23;
    ...
    int setIndexFormSchema(String str, int i, List<InnerIndexForm> list, int i2, String str2);
    ...
    public static class Proxy implements IHOSPSearchServiceCall {
        ...
        public int setIndexForm(String str, int i, List<InnerIndexForm> list, String str2) {
            ...
            try {
                ...
                HiLog.error(LABEL, "set indexForm remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<InnerIndexForm> getIndexForm(String str, String str2) {
            ...
            try {
                ...
                HiLog.error(LABEL, "get indexForm remote exception, %{public}s", e.getMessage());
                arrayList = null;
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        public int getIndexFormVersion(String str, String str2) {
            ...
            try {
                ...
                HiLog.error(LABEL, "get indexForm version remote exception, %{public}s", e.getMessage());
                i = -1;
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        public int clearIndexForm(String str, String str2) {
            ...
            try {
                ...
                HiLog.error(LABEL, "clear indexForm remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<InnerIndexData> insert(String str, String str2, List<InnerIndexData> list, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "insert index remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<InnerIndexData> update(String str, String str2, List<InnerIndexData> list, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "update index remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<InnerIndexData> delete(String str, String str2, List<InnerIndexData> list, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "delete index remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<String> deleteByTerm(String str, String str2, String str3, List<String> list, String str4) {
            ...
            try {
                ...
                HiLog.error(LABEL, "delete index by term remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public int deleteByQuery(String str, String str2, String str3, String str4) {
            ...
            try {
                ...
                HiLog.error(LABEL, "delete index by query remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public int clearIndex(String str, String str2, Map<String, List<String>> map, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "clear index remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public ISearchSession beginSearch(String str, String str2, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "begin search session remote exception, %{public}s", e.getMessage());
                return null;
            } finally {
                obtain2.recycle();
                obtain.recycle();
        ...
        public void endSearch(String str, String str2, ISearchSession iSearchSession, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "end search session remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public void registerIndexChangeListener(String str, String str2, IIndexChangeCallback iIndexChangeCallback, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "register index change listener remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public void unRegisterIndexChangeListener(String str, String str2, IIndexChangeCallback iIndexChangeCallback, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "unregister index change listener remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public void registerClientDeathBinder(IBinder iBinder, String str) {
            ...
            try {
                ...
                HiLog.error(LABEL, "register client death binder remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public void unRegisterClientDeathBinder(IBinder iBinder, String str) {
            ...
            try {
                ...
                HiLog.error(LABEL, "unRegister client death binder remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public int setSearchableEntity(InnerSearchableEntity innerSearchableEntity, String str) {
            ...
            try {
                ...
                HiLog.error(LABEL, "setSearchableEntity remote exception, %{public}s", e.getMessage());
        ...
        public InnerSearchableEntity getSearchableEntity(String str, String str2) {
            ...
            try {
                ...
                HiLog.error(LABEL, "getSearchableEntity remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<InnerSearchableEntity> getSearchableEntityList(String str) {
            ...
            try {
                ...
                HiLog.error(LABEL, "getSearchableEntityList remote exception, %{public}s", e.getMessage());
                arrayList = null;
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        public int insertLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "insert large index remote exception, %{public}s", e.getMessage());
        ...
        public int updateLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "update large index remote exception, %{public}s", e.getMessage());
                i = SearchResult.INNER_ERROR.getRetCode();
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        public int deleteLarge(String str, String str2, SharedMemory sharedMemory, SharedMemory sharedMemory2, String str3) {
            ...
            try {
                ...
                HiLog.error(LABEL, "delete large index remote exception, %{public}s", e.getMessage());
                i = SearchResult.INNER_ERROR.getRetCode();
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        @Override // ohos.data.searchimpl.connect.IHOSPSearchServiceCall
        public int setIndexFormSchema(String str, int i, List<InnerIndexForm> list, int i2, String str2) {
            Parcel obtain = Parcel.obtain();
            Parcel obtain2 = Parcel.obtain();
            int i3 = 0;
            try {
