    ...
    public static class Proxy implements ISearchSession {
        ...
        public int getSearchHitCount(String str) {
            ...
            try {
                ...
                HiLog.error(LABEL, "getSearchHitCount remote exception, %{public}s", e.getMessage());
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
                throw th;
        ...
        public List<InnerIndexData> search(String str, int i, int i2) {
            ...
            try {
                ...
                HiLog.error(LABEL, "search remote exception, %{public}s", e.getMessage());
                arrayList = null;
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        public List<InnerRecommendation> groupSearch(String str, int i) {
            ...
            try {
                ...
                HiLog.error(LABEL, "groupSearch remote exception, %{public}s", e.getMessage());
                arrayList = null;
            } catch (Throwable th) {
                obtain2.recycle();
                obtain.recycle();
        ...
        public List<InnerIndexData> searchLarge(String str, int i, int i2, SharedMemory sharedMemory) {
            ...
            try {
                ...
                HiLog.error(LABEL, "search large remote exception, %{public}s", e.getMessage());
